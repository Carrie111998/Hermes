"""Session title management for SessionDB.
...
Extracted from hermes_state.py slice R3-C9 (window 5291-5463 at pin
01a1037d1e / blob bf9a24d31d35b29cf1eebedf20c5686ea6d64933, epic #78647):
class attr MAX_TITLE_LENGTH + sanitize_title / _is_compression_ancestor /
_set_session_title / set_session_title / set_auto_title_if_empty /
get_session_title, byte-verbatim (golden sha bb7de39c… no-NL /
bdec5623… sed-style).
"""
