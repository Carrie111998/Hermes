...
def run_job(
    ...
    *,
    ...
    # Default (LLM) path only: skipped script-gated ticks must never open a
    # SessionDB. The actual agent run below owns the handle and its established
    # finally block closes it after persisting the cron transcript.
    ...
    try:
        ...
        if _session_db_timeout > 0:
            ...
            try:
                ...
                # A late constructor result would otherwise outlive this tick
                # holding state.db/WAL handles indefinitely.
