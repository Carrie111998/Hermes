"""
Cron job scheduling system for Orion Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    orion gateway install    # Install as a user service
    sudo orion gateway install --system  # Linux servers: boot-time system service
    orion gateway            # Or run in foreground
