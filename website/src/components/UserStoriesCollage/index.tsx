  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Orion Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Orion &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Orion?{' '}
        <a
          href="https://github.com/zacharyjleach-stack/Aries/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://github.com/zacharyjleach-stack/Aries" target="_blank" rel="noopener noreferrer">
          Orion Discord
        </a>{' '}
