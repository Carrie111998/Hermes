...
const config: Config = {
  ...
  url: 'https://your-orion-docs.example',
  baseUrl: '/docs/',

  organizationName: 'Orion',
  projectName: 'orion-agent',
      ...
      '@docusaurus/plugin-client-redirects',
      {
        ...
        redirects: [
          ...
          },
          {
            ...
            from: '/guides/build-a-orion-plugin',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/zacharyjleach-stack/Aries/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/orion-agent-banner.png',
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'Community',
          items: [
            { label: 'Discord', href: 'https://github.com/zacharyjleach-stack/Aries' },
            { label: 'GitHub Issues', href: 'https://github.com/zacharyjleach-stack/Aries/issues' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'Desktop Download', href: 'https://your-orion-docs.example/' },
            { label: 'GitHub', href: 'https://github.com/zacharyjleach-stack/Aries' },
            { label: 'Orion', href: 'https://nousresearch.com' },
          ],
        },
      ],
      copyright: `Built by <a href="https://nousresearch.com">Orion</a> · MIT License · ${new Date().getFullYear()}`,
    },
    prism: {
