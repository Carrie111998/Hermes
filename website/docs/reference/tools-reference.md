...
| Tool | Description | Requires environment |
|------|-------------|----------------------|
| `image_analyze` | Analyze one to sixteen image URLs or local paths together using the configured auxiliary vision model. Returns a textual analysis. | — |
