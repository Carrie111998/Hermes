...
| `/ponytail [lite\|full\|ultra\|off]` | Apply a session-only development-discipline overlay. Bare `/ponytail` enables `full`; `off` restores the prior personality prompt without clearing history. |
