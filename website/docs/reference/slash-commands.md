...
| `/busy [smart\|queue\|steer\|interrupt\|status]` | CLI-only: control what pressing Enter does while Hermes is working — classify and route safely, queue the new message, steer mid-turn, or interrupt immediately. |
