...
| `/refine [focus]` | Run the memory/skill self-improvement review now, optionally with focus instructions. Explicit skill reviews create and report a curator rollback snapshot first. On Slack use `/hermes refine …`. |
