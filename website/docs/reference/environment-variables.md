...
| `FRIENDLI_API_KEY` | Friendli API key ([friendli.ai](https://friendli.ai/suite/~/setting/keys)) |
| `FRIENDLI_BASE_URL` | Override Friendli base URL (default: `https://api.friendli.ai/serverless/v1`) |
