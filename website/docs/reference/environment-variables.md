...
| `NEAR_AI_API_KEY` | NEAR AI Cloud API key — verifiable private inference in TEEs ([cloud.near.ai](https://cloud.near.ai)) |
| `NEAR_AI_BASE_URL` | Override NEAR AI base URL (default: `https://cloud-api.near.ai/v1`) |
