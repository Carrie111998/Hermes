...
| `TERMINAL_LOCAL_MEMORY_MAX_MB` | Internal bridge for `terminal.local_memory_max_mb`; positive MiB limit for foreground local commands on systemd hosts. Prefer `config.yaml`. |
