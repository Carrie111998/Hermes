...
| [`x-research-mcp-api`](/docs/user-guide/skills/bundled/media/media-x-research-mcp-api) | X research via MCP tools and v2 API: search, user tweets, article fetch. | `media/x-research-mcp-api` |
