...
description: "Catalog of bundled skills that ship with Nastech Agent"
---

# Bundled Skills Catalog

Nastech ships with a large built-in skill library copied into `~/.nastech/skills/` on install. Each skill below links to a dedicated page with its full definition, setup, and usage.

Nastech also syncs bundled skills on `nastech update`, but the sync manifest respects local deletions and user edits. If a skill listed here is missing from your profile's `~/.nastech/skills/` tree, it is still shipped with Nastech; restore it with `nastech skills reset <name> --restore`.
...
| [`nastech-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-nastech-agent) | Use, configure, theme, extend, and orchestrate Nastech Agent. | `autonomous-ai-agents/nastech-agent` |
...
| [`nastech-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-nastech-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development/nastech-agent-skill-authoring` |
| [`inspecting-nastech-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-nastech-desktop-dom) | Read the live Nastech desktop DOM/CSS over CDP. | `software-development/inspecting-nastech-desktop-dom` |
...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Write a markdown plan to .nastech/plans/; no execution. | `software-development/plan` |
