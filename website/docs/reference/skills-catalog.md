...
description: "Catalog of bundled skills that ship with Orion Agent"
---

# Bundled Skills Catalog

Orion ships with a large built-in skill library copied into `~/.orion/skills/` on install. Each skill below links to a dedicated page with its full definition, setup, and usage.

Orion also syncs bundled skills on `orion update`, but the sync manifest respects local deletions and user edits. If a skill listed here is missing from your profile's `~/.orion/skills/` tree, it is still shipped with Orion; restore it with `orion skills reset <name> --restore`.
...
| [`orion-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-orion-agent) | Use, configure, theme, extend, and orchestrate Orion Agent. | `autonomous-ai-agents/orion-agent` |
...
| [`orion-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-orion-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development/orion-agent-skill-authoring` |
| [`inspecting-orion-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-orion-desktop-dom) | Read the live Orion desktop DOM/CSS over CDP. | `software-development/inspecting-orion-desktop-dom` |
...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Write a markdown plan to .orion/plans/; no execution. | `software-development/plan` |
