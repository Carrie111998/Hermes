...
| [`instagram-art-direction-premium`](/docs/user-guide/skills/bundled/creative/creative-instagram-art-direction-premium) | Use when creating or improving premium Instagram static creatives: feed posts, stories, carousel cards, event flyers, promotional posts, social ads, launch graphics, and local-business campaigns. Forces a senior art-direction pass before production so the result has concept, hierarchy, taste, thumb-stopping impact, mobile legibility, and avoids generic Canva/AI-template aesthetics. | `creative/instagram-art-direction-premium` |
| [`local-event-creative-system`](/docs/user-guide/skills/bundled/creative/creative-local-event-creative-system) | Use when turning a local business flyer, event announcement, venue Instagram, restaurant/camping/hospitality promotion, workshop, retreat, or community activation into a professional social-media creative system. Converts one cluttered flyer or rough brief into a campaign set with hero post, story, offer/logistics card, experience card, and booking CTA. | `creative/local-event-creative-system` |
