...
| [`live-dashboard`](/docs/user-guide/skills/bundled/productivity/productivity-live-dashboard) | Build self-updating dashboards from live sources. | `productivity/live-dashboard` |
