...
| [`skill-behavior-validation`](/docs/user-guide/skills/bundled/software-development/software-development-skill-behavior-validation) | Replay a prior case to validate a skill's behavior change. | `software-development/skill-behavior-validation` |
