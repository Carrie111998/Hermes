...
| [`requesting-code-review`](/docs/user-guide/skills/bundled/software-development/software-development-requesting-code-review) | Review code changes with risk-proportional verification. | `software-development/requesting-code-review` |
| [`simplify-code`](/docs/user-guide/skills/bundled/software-development/software-development-simplify-code) | Simplify recent code with bounded independent review. | `software-development/simplify-code` |
...
| [`systematic-debugging`](/docs/user-guide/skills/bundled/software-development/software-development-systematic-debugging) | Find root causes with reproducible evidence before fixing. | `software-development/systematic-debugging` |
| [`test-driven-development`](/docs/user-guide/skills/bundled/software-development/software-development-test-driven-development) | Use RED-GREEN-REFACTOR for behavior-changing code. | `software-development/test-driven-development` |
