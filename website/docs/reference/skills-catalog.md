...
| [`skill-curator`](/docs/user-guide/skills/bundled/software-development/software-development-skill-curator) | Curate and distill session workflows into tested skills. | `software-development/skill-curator` |
