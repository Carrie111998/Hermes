...
| [`kilo`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-kilo) | Delegate coding to Kilo CLI (features, PR review). | `autonomous-ai-agents/kilo` |
