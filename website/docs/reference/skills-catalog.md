...
| [`trajectory-debugger`](/docs/user-guide/skills/bundled/software-development/software-development-trajectory-debugger) | Analyze session trajectories, cache hit rates, and tokens. | `software-development/trajectory-debugger` |
