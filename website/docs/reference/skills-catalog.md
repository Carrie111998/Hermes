...
| [`graph-gated-engineering`](/docs/user-guide/skills/bundled/software-development/software-development-graph-gated-engineering) | Graph-gated engineering: model the whole system, agree on the graph, gate with real tests, slice at seams, verify with receipts. Resolves the memory-system question structurally. | `software-development/graph-gated-engineering` |
