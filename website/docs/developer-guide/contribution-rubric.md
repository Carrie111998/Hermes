...
description: "Architecture and review rubric for Hermes Agent contributions"
---

# Contribution Rubric

This is the project's detailed intent layer for contributors, maintainers, and automated triage. The repository root `AGENTS.md` carries the compact global rules; this guide preserves the review rationale and examples.
