...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `orion_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `orion_cli/` | [Extending the CLI](extending-the-cli.md) |
| Plugins system | `plugins/` | [Build a Orion Plugin](plugins/index.md) |
...
| Session storage | `orion_state.py` | [Session Storage](session-storage.md) |
