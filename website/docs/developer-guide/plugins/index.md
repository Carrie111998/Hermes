...
| [`pre_memory_write`](/user-guide/features/hooks#built-in-memory-governance) | Before a native durable memory mutation | proposed write fields + advisory entries | block/skip/transform/allow dict; missing/malformed decisions fail closed |
