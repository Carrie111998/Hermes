...
slug: /
sidebar_position: 0
title: "Charterforge Documentation"
description: "Documentation for the independently developed Charterforge governed autonomous-company runtime."
...
Charterforge is an independently developed governed autonomous-company runtime derived from the Hermes Agent foundation. Its Founder/CEO manages objectives, authorized work, evidence, workers, finances, compliance, and escalation.
...
This independent fork does not yet publish an installer, desktop artifact, or
container image. Install from the repository while the project is in active
development:
...
After installation, run `charterforge --help` and configure the model and
standing business charter before unattended operation.
:::

## What is Charterforge?

Charterforge is a governed autonomous-company runtime. Its Founder/CEO owns
mission interpretation, objectives, delegation, evidence review, adaptation,
and escalation; the human is an advisor by default.
