...
- **Runs anywhere, not just your laptop** — 7 terminal backends: local, Docker, SSH, Daytona, Tenki, Singularity, Modal. Cloud backends let your agent run isolated compute away from your host
