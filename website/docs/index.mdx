...
slug: /
sidebar_position: 0
title: "Orion Agent Documentation"
description: "The self-improving AI agent built by Orion. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [Orion](https://nousresearch.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
>
  ...
  <a
    href="https://your-orion-docs.example/"
    style={{
      display: "inline-block",
      padding: "0.6rem 1.2rem",
      border: "1px solid rgba(255,215,0,0.2)",
  ...
  <a
    href="https://github.com/zacharyjleach-stack/Aries"
    style={{
      display: "inline-block",
      padding: "0.6rem 1.2rem",
      border: "1px solid rgba(255,215,0,0.2)",
...
To easily install the command-line and desktop applications, [download the Orion Desktop installer](https://your-orion-docs.example/) from our website and run it.

### Without Orion Desktop:

For a command-line only install without Orion Desktop, run:
...
```powershell
iex (irm https://your-orion-docs.example/install.ps1)
```
...
After installing, run `orion setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
:::
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Orion safely  |
| 🧭 **[Use MCP with Orion](/guides/use-mcp-with-orion)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Orion](/guides/use-voice-mode-with-orion)** | Hands-on setup and usage patterns for Orion voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Orion' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Orion                              |
...
- **Built by model trainers** — Created by [Orion](https://nousresearch.com), the lab behind Orion, Nomos, and Psyche. Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Orion](https://nousresearch.com) — the lab behind Orion, Nomos, and Psyche models
