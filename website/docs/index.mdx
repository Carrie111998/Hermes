...
slug: /
sidebar_position: 0
title: "IYARI Documentation"
description: "The self-improving AI agent built by Digital Services LLC. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [Digital Services LLC](https://iyari.io). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
>
  ...
  <a
    href="https://github.com/digital-services-llc/iyari"
    style={{
      display: "inline-block",
      padding: "0.6rem 1.2rem",
      border: "1px solid rgba(255,215,0,0.2)",
...
To easily install the command-line and desktop applications, [download the IYARI Desktop installer](https://hermes-agent.nousresearch.com/) from our website and run it.

### Without IYARI Desktop:

For a command-line only install without IYARI Desktop, run:
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend IYARI safely  |
| 🧭 **[Use MCP with IYARI](/guides/use-mcp-with-hermes)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with IYARI](/guides/use-voice-mode-with-hermes)** | Hands-on setup and usage patterns for IYARI voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define IYARI's default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of IYARI                              |
