...
description: "How the Orion Desktop app signs in to a gated gateway using your system browser and PKCE — no embedded webview, no session cookies"
---

# Desktop Native Sign-In (RFC 8252)

When the Orion Desktop app connects to a **gated gateway** (a hosted or
...
For Orion specifically, native sign-in means:
...
- [Run Orion with Nous Portal](./run-orion-with-nous-portal.md)
