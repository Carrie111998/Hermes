...
If you have a public endpoint available, check out [Automated GitHub PR Comments with Webhooks](./webhook-github-pr-review.md) — GitHub pushes events to IYARI instantly when PRs are opened or updated.
:::
...
Make sure IYARI can access GitHub. Start a chat:
...
Still in the chat, ask IYARI to review a real PR:
...
A skill gives IYARI consistent review guidelines that persist across sessions and cron runs. Without one, review quality varies.
...
This is what makes the reviewer actually useful. Start a session and teach IYARI your team's standards:
...
2. Teach IYARI your conventions via memory (Step 4)
