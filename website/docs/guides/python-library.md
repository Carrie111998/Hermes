...
Install IYARI directly from the repository:

```bash
pip install git+https://github.com/digital-services-llc/iyari.git
```

Or with [uv](https://docs.astral.sh/uv/):

```bash
uv pip install git+https://github.com/digital-services-llc/iyari.git
```

You can also pin it in your `requirements.txt`:

```text
hermes-agent @ git+https://github.com/digital-services-llc/iyari.git
```
