...
Each conversation is appended as a single gzip-compressed JSONL line, making it easy to collect datasets from automated runs. Pass an explicit `.jsonl` filename to retain the legacy plain-text format.
