...
| File | Purpose | Scope |
|------|---------|-------|
| `SOUL.md` | **Primary agent identity** — defines who the agent is (slot #1 in the system prompt) | Trusted cwd-local candidate, then `~/.hermes/SOUL.md` or `$HERMES_HOME/SOUL.md` fallback |
