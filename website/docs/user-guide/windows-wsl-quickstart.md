...
- **[MCP guide → WSL → Windows Chrome](/guides/use-mcp-with-hermes#wsl2-bridge-iyari-in-wsl-to-windows-chrome)** — controlling your signed-in Windows Chrome from Hermes in WSL.
