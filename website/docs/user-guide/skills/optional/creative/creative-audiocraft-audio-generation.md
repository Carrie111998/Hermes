...
| | |
|---|---|
| Source | Optional — install with `orion skills install official/creative/audiocraft-audio-generation` |
...
- **[Advanced Usage](https://github.com/zacharyjleach-stack/Aries/blob/main/optional-skills/creative/audiocraft-audio-generation/references/advanced-usage.md)** - Training, fine-tuning, deployment
- **[Troubleshooting](https://github.com/zacharyjleach-stack/Aries/blob/main/optional-skills/creative/audiocraft-audio-generation/references/troubleshooting.md)** - Common issues and solutions
