...
| | |
|---|---|
| Source | Optional — install with `orion skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.orion/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.orion/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Orion installs package this)
