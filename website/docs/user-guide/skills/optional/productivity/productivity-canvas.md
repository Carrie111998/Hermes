...
| | |
|---|---|
| Source | Optional — install with `orion skills install official/productivity/canvas` |
...
4. Name the token (e.g., "Orion Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${ORION_HOME:-~/.orion}/.env`:
