...
| | |
|---|---|
| Source | Optional — install with `orion skills install official/research/gitnexus-explorer` |
...
| Related skills | [`orion-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-orion-agent), [`codebase-inspection`](/docs/user-guide/skills/bundled/github/github-codebase-inspection) |
