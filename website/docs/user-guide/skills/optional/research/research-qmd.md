...
| | |
|---|---|
| Source | Optional — install with `orion skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`orion-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-orion-agent), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
