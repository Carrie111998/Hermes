...
| | |
|---|---|
| Source | Optional — install with `orion skills install official/health/neuroskill-bci` |
| Path | `optional-skills/health/neuroskill-bci` |
| Version | `1.0.0` |
| Author | Orion Agent + Orion |
| License | MIT |
...
Connect Orion to a running [NeuroSkill](https://neuroskill.com/) instance to read
