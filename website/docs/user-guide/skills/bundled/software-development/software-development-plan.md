---
title: "Plan — Write a markdown plan to .orion/plans/; no execution"
sidebar_label: "Plan"
description: "Write a markdown plan to .orion/plans/; no execution"
---
...
Write a markdown plan to .orion/plans/; no execution.
...
| Version | `2.0.0` |
| Author | Orion Agent (writing-craft adapted from obra/superpowers) |
| License | MIT |
...
- Your deliverable is a markdown plan saved inside the active workspace under `.orion/plans/`.
...
- `.orion/plans/YYYY-MM-DD_HHMMSS-<slug>.md`

Treat that as relative to the active working directory / backend workspace. Orion file tools are backend-aware, so using this relative path keeps the plan with the workspace on local, docker, ssh, modal, and daytona backends.

If the runtime provides a specific target path, use that exact path.
If not, create a sensible timestamped filename yourself under `.orion/plans/`.
...
> **For Orion:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use Orion tools to understand the project:
