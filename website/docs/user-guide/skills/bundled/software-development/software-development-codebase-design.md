---
title: "Codebase Design — Orient bounded code areas before designing changes"
...
Orient bounded code areas before designing changes.
...
| Path | `skills/software-development/codebase-design` |
| Version | `0.1.0` |
| Author | Lucas Veber (vegapunkpa-hue), Hermes Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `codebase`, `architecture`, `design`, `modules`, `interfaces`, `orientation` |
| Related skills | [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan), [`systematic-debugging`](/docs/user-guide/skills/bundled/software-development/software-development-systematic-debugging) |
