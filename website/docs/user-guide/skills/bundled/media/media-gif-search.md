...
Set your Tenor API key in your environment (add to `${ORION_HOME:-~/.orion}/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/zacharyjleach-stack/Aries/blob/main/skills/media/gif-search/url)`
