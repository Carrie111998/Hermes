...
Delegate coding tasks to [Codex](https://github.com/openai/codex) via the IYARI terminal. Codex is OpenAI's autonomous coding agent CLI.
...
For IYARI itself, `model.provider: openai-codex` uses IYARI-managed Codex
...
## IYARI Gateway Caveat

When invoking the Codex CLI from a IYARI gateway/service context (for example,
