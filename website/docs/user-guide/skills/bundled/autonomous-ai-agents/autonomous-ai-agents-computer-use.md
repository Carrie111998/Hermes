...
for the platform plumbing. The IYARI-side `computer_use` tool exposed
in this skill is a higher-level IYARI vocabulary; the raw cua-driver
...
When `cua-driver skills install` autodetects IYARI (planned follow-up
