---
title: "Bitwarden Secrets — Authoritative Bitwarden Secrets Manager (bws) protocol for Hermes — encrypted-only cache, no plaintext at rest, masked output, child-process env hygiene."
...
{/* This page mirrors the bundled skill's SKILL.md. Edit the source at skills/security/bitwarden-secrets/SKILL.md, not this page. */}
...
| Path | `skills/security/bitwarden-secrets` |
| Version | `1.0.0` |
| Author | Axl Ibiza |
| License | MIT |
...
6. **The gate is tested.** The end-to-end no-exfiltration test (#77039) pins invariants 3+4: a loaded secret's name and value never surface in stdout, stderr, or formatted output. Run it as part of any change to this integration.
