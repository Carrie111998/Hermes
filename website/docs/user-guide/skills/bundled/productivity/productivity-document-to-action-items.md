...
| Related skills | [`ocr-and-documents`](/user-guide/skills/bundled/productivity/productivity-ocr-and-documents), [`pdf`](/user-guide/skills/bundled/productivity/productivity-pdf), [`docx`](/user-guide/skills/bundled/productivity/productivity-docx), [`notion`](/user-guide/skills/bundled/productivity/productivity-notion) |
