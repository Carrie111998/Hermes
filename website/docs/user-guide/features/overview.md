...
- **[Incognito Mode](incognito.md)** — Run a temporary session without Hermes-managed memory or session persistence. Incognito does not sandbox terminal, browser, filesystem, or external services.
