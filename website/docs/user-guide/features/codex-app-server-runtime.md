...
Examples (the ones the upstream thread highlighted as "YouTube-video-worthy"):
...
This matches the boundary upstream arrived at after some early experimentation: isolate Codex's state, leave the user's home alone. (Cf. third-party reference #81562.)
