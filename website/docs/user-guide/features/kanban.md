...
- a **deliberate continuation** supersedes the PR link — an explicit `hermes kanban unguard` (below), or an `unblock` recorded after it. Intentional follow-up / rework is exactly what the guard should allow; and
