...
> **Operating the exact-head human-review workflow?** Use the [Kanban review runner operations runbook](./kanban-review-runner) for fail-closed MCP preflight, shadow validation, rollout, and rollback.
