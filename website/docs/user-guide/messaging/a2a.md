...
- **Untrusted-input framing** — inbound text is preserved verbatim behind a
  model-visible untrusted-peer boundary. Remote peers cannot invoke operator
  slash commands, and the primary model remains the sole semantic authority.
