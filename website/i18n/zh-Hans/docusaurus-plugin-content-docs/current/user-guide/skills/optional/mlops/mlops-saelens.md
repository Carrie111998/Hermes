...
| | |
|---|---|
| 来源 | 可选 — 通过 `orion skills install official/mlops/saelens` 安装 |
...
:::info
以下是 Orion 在触发该 skill 时加载的完整 skill 定义。这是 agent 在 skill 激活时所看到的指令内容。
:::
...
| 文件 | 内容 |
|------|----------|
| [references/README.md](https://github.com/zacharyjleach-stack/Aries/blob/main/optional-skills/mlops/saelens/references/README.md) | 概述与快速入门指南 |
| [references/api.md](https://github.com/zacharyjleach-stack/Aries/blob/main/optional-skills/mlops/saelens/references/api.md) | SAE、TrainingSAE、配置的完整 API 参考 |
| [references/tutorials.md](https://github.com/zacharyjleach-stack/Aries/blob/main/optional-skills/mlops/saelens/references/tutorials.md) | 训练、分析、引导的分步教程 |
