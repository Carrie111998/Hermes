...
| | |
|---|---|
| 来源 | 可选 — 通过 `orion skills install official/mlops/segment-anything` 安装 |
...
:::info
以下是 Orion 在触发此 skill 时加载的完整 skill 定义。这是 skill 激活时 agent 所看到的指令内容。
:::
...
# 加载模型
sam = sam_model_registry["vit_h"](https://github.com/zacharyjleach-stack/Aries/blob/main/optional-skills/mlops/models/segment-anything-model/checkpoint="sam_vit_h_4b8939.pth")
sam.to(device="cuda")
...
```python
# 在 VRAM 有限时使用较小模型
sam = sam_model_registry["vit_b"](https://github.com/zacharyjleach-stack/Aries/blob/main/optional-skills/mlops/models/segment-anything-model/checkpoint="sam_vit_b_01ec64.pth")
...
- **[高级用法](https://github.com/zacharyjleach-stack/Aries/blob/main/optional-skills/mlops/models/segment-anything-model/references/advanced-usage.md)** - 批处理、微调、集成
- **[故障排查](https://github.com/zacharyjleach-stack/Aries/blob/main/optional-skills/mlops/models/segment-anything-model/references/troubleshooting.md)** - 常见问题与解决方案
