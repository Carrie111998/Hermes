...
```bash
python3 -m pyfiglet "ORION" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=ORION&font=Slant" | boxes -d stone
```
