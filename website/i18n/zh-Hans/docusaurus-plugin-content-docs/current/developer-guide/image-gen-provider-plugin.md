...
description: "如何为 IYARI 构建图像生成后端插件"
---
...
:::tip
图像生成是 IYARI 支持的多种**后端插件**之一。其他插件（各有更专用的 ABC）包括：[Memory Provider 插件](/developer-guide/memory-provider-plugin)、[Context Engine 插件](/developer-guide/context-engine-plugin) 和 [Model Provider 插件](/developer-guide/model-provider-plugin)。通用工具/hook/CLI 插件请参阅 [构建 IYARI 插件](/developer-guide/plugins)。
:::
...
- [构建 IYARI 插件](/developer-guide/plugins) — 通用工具/hook/斜杠命令指南