...
sidebar_position: 3
title: 'Путь обучения'
description: 'Выберите свой путь изучения документации Hermes Agent в зависимости от уровня и целей.'
---

# Путь обучения

Hermes Agent умеет многое — CLI-ассистент, Telegram/Discord bot, task automation, RL training, and more. This page helps you figure out where to start and what to read based on your experience level and what you're trying to accomplish.
...
- **Just browsing?** Check the [Ключевые возможности](#key-features-at-a-glance) table for a quick overview of everything Hermes Agent can do.
