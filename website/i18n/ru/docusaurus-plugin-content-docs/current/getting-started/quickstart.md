---
sidebar_position: 1
title: "Быстрый старт Hermes Agent"
description: "Ваш первый разговор с Hermes Agent — от установки до чата за 5 минут"
---

# Быстрый старт Hermes Agent

Это руководство проведёт вас от нуля до рабочего Hermes that survives real use. Install, choose a provider, verify a working chat, and know exactly what to do when something breaks.
...
Подробные опции установки, требования и устранение неполадок — см. [Руководство по установке](./installation.md).
