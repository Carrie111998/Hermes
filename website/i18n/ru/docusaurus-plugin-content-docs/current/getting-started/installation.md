...
sidebar_position: 2
title: "Установка"
description: "Установка Hermes Agent на Linux, macOS, WSL2, нативный Windows или Android через Termux"
---

# Установка

Запустите Hermes Agent менее чем за две минуты!

:::tip Поддержка платформ
For the full platform support matrix (which OSes, distribution methods, and
platform-gated features are supported), see **[Поддержка платформ](./platform-support.md)**.
:::
...
## Установка без sudo / для системного пользователя
