...
_CRON_AUTO_DELIVER_USER_ID: ContextVar = ContextVar("HERMES_CRON_AUTO_DELIVER_USER_ID", default=_UNSET)
...
_VAR_MAP = {
    ...
    "HERMES_CRON_AUTO_DELIVER_USER_ID": _CRON_AUTO_DELIVER_USER_ID,
}
