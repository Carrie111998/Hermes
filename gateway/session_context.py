...
# Cron execution lineage — set only while one claimed scheduler execution is
# running. The local subprocess bridge exports these task-local values to
# terminal/script children without using process-global os.environ.
...
_CRON_DELIVERY_TARGETS_JSON: ContextVar = ContextVar(
    "HERMES_CRON_DELIVERY_TARGETS_JSON", default=_UNSET,
)
