...
_PLATFORM_DEFAULTS: dict[str, dict[str, Any]] = {
    ...
    # BlueBubbles is a permanent-message iMessage inbox with no message-edit
    # support, so it stays TIER_LOW. This keeps tool progress, interim scratch
    # commentary, heartbeats, and busy-ack detail out of the user's thread.
