...
from environment variables:
  ...
  - ``ORION_MEDIA_DELIVERY_STRICT``    <- gateway.strict
  - ``ORION_MEDIA_ALLOW_DIRS``         <- gateway.media_delivery_allow_dirs
  - ``ORION_MEDIA_TRUST_RECENT_FILES`` <- gateway.trust_recent_files
...
gateway — a manual ``orion cron run`` in the CLI, ``orion send``, a
...
_STRICT_ENV = "ORION_MEDIA_DELIVERY_STRICT"
_ALLOW_DIRS_ENV = "ORION_MEDIA_ALLOW_DIRS"
_TRUST_RECENT_ENV = "ORION_MEDIA_TRUST_RECENT_FILES"
