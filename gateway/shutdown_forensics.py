...
def spawn_async_diagnostic(
    ...
    *,
    ...
    try:
        ...
        # before it can flush.
        # Use the current Python runtime for the timeout wrapper. GNU
        # ``timeout`` is not installed on stock macOS, where the previous
        # command failed before diagnostics could start.
        helper = (
            "import subprocess\n"
            "try:\n"
