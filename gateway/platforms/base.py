...
class BasePlatformAdapter(ABC):
    ...
    def extract_local_files(content: str) -> Tuple[List[str], str]:
        ...
        # (?:~[/\\]|/|[A-Za-z]:[/\\]) anchors to absolute or home-relative
        #             paths in both POSIX and Windows forms. Fork keeps the
        #             Windows home-relative backslash form (~\) on top of
        #             upstream's drive-letter support (#34632).
        path_re = re.compile(
