...
class GatewaySlashCommandsMixin:
    ...
    async def _handle_status_command(self, event: MessageEvent) -> str:
        ...
        # override, prefer the latter over current config.
        ...
        # An explicit session /model override beats a channel override, which
        # beats current global config.  Only fill fields absent from a more
        # authoritative live or persisted runtime route.
        if not model_name:
            try:
                from hermes_cli.model_switch import resolve_effective_model
