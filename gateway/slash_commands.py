...
class GatewaySlashCommandsMixin:
    ...
    async def _handle_restart_command_serialized(
        ...
        # Marker publication and the restart transition are one obligation.
        # Only propagate cancellation after the restart has been requested, so
        # a completed worker write cannot leave a false success marker behind.
