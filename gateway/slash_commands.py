...
Module-level run.py helpers a handler needs (``_resolve_hermes_home()``,
...
class GatewaySlashCommandsMixin:
    ...
    async def _handle_restart_command(self, event: MessageEvent) -> Union[str, EphemeralReply]:
        ...
        from gateway.run import _resolve_hermes_home
        ...
        try:
            ...
            atomic_json_write(
                _resolve_hermes_home() / ".restart_notify.json",
                notify_data,
                indent=None,
            )
        ...
        try:
            ...
            atomic_json_write(
                _resolve_hermes_home() / ".restart_last_processed.json",
                dedup_data,
                indent=None,
            )
        except Exception as e:
    ...
    async def _handle_model_command(self, event: MessageEvent) -> Optional[str]:
        ...
        """
        from gateway.run import _resolve_hermes_home, _load_gateway_config
        import yaml
        ...
        custom_provs = None
        excluded_provs = []
        config_path = (_command_profile_home or _resolve_hermes_home()) / "config.yaml"
        try:
    ...
    async def _handle_rollback_command(self, event: MessageEvent) -> str:
        ...
        try:
            import yaml as _y
            _cfg_path = _resolve_hermes_home() / "config.yaml"
            if _cfg_path.exists():
    ...
    async def _handle_verbose_command(self, event: MessageEvent) -> str:
        ...
        """
        from gateway.run import _resolve_hermes_home, _load_gateway_config, _platform_config_key
    ...
    async def _handle_footer_command(self, event: MessageEvent) -> str:
        ...
        """
        from gateway.run import _resolve_hermes_home, _load_gateway_config, _platform_config_key, _resolve_gateway_model
    ...
    async def _handle_update_command(self, event: MessageEvent) -> str:
        ...
        """
        from gateway.run import _resolve_hermes_home, _resolve_hermes_bin
        import json
        import shutil
        import subprocess
        from datetime import datetime
