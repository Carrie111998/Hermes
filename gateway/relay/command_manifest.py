...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Orion session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Orion session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Orion agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Orion Agent to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Orion gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Orion session in it",
