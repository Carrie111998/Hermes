"""/agents, /background, /btw, /review, /stop, /restart, /status, /context slash-command handlers for GatewayRunner.
...
class AgentsOpsCommandsMixin:
    """/agents, /background, /btw, /review, /stop, /restart, /status, /context handlers."""
