...
Hooks are discovered from ~/.orion/hooks/ directories, each containing:
...
HOOKS_DIR = get_orion_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"orion_hook_{hook_name}"
