...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$ORION_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_orion_dir("platforms/whatsapp/session", "whatsapp/session")
