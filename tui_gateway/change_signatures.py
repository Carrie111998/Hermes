...
def sessions_signature(home: Path, served_homes: Iterable[Path] = ()) -> int | None:
    """Return the newest SQLite database or WAL mtime across served profiles."""
    signature = None
    for root in (home, *served_homes):
