...
# ── Wave-1 split modules (see method_ctx.py) ─────────────────────────
# Imported at the end of this module so every global the moved functions
# close over already exists; register() rebinds them onto this namespace.
from . import (  # noqa: E402
    agent_config_loaders as _agent_config_loaders,
    change_watcher_mixin as _change_watcher_mixin,
)

for _m in (_agent_config_loaders, _change_watcher_mixin):
    _m.register(sys.modules[__name__])
del _m
