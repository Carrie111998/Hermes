...
del _m
# ── Split helper modules (wave-1 godfile extraction; see shard-plan.json) ──
# Imported at the end of this module, mirroring the methods_* split above:
# message_projection binds _tool_ctx (defined at 5140) from this module, so
# it must be imported only after that global exists. Names are re-exported
# here so in-file callers (the s2 pet watcher, _auto_continue_note, busy
# submit policy, live-view reconciliation, s4 billing rows) and external
# consumers (`from tui_gateway.server import _history_to_messages`, and the
# HandlerRegistry rebinding for methods_*) keep resolving them.
from .message_projection import (  # noqa: E402
...
from .pet_payload_mixin import (  # noqa: E402
    _PET_REFERENCE_MAX_BYTES,
    _PET_REFERENCE_MIME_EXT,
    _clone_pet_payload,
    _pet_active_selection,
    _pet_cancel_arm,
    _pet_cancel_lock,
    _pet_cancel_release,
    _pet_cancel_request,
    ...
    _pet_payload_cache_lock,
    _pet_png_data_uri,
    _pet_reference_images_from_data_url,
