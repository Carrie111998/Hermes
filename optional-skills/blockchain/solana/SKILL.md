...
python ~/.orion/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python ~/.orion/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python ~/.orion/skills/blockchain/solana/scripts/solana_client.py price BONK
python ~/.orion/skills/blockchain/solana/scripts/solana_client.py price JUP
python ~/.orion/skills/blockchain/solana/scripts/solana_client.py price SOL
python ~/.orion/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
