...
version: 1.0.0
author: Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Orion Agent
license: MIT
...
Helper script path: `~/.orion/skills/blockchain/evm/scripts/evm_client.py`
...
python ~/.orion/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python ~/.orion/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
