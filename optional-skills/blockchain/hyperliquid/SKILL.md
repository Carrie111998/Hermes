...
```bash
python ~/.orion/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
```bash
python ~/.orion/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ~/.orion/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
