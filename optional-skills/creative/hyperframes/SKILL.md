---
name: hyperframes
description: Render MP4/WebM video from HTML compositions with HyperFrames — animated title cards, social overlays, captioned talking-head clips, audio-reactive visuals, shader transitions, TTS narration. HTML is the source of truth; also converts a website into a video.
version: 1.0.0
author: heygen-com
license: Apache-2.0
