...
metadata:
  hermes:
    ...
    related_skills: [ascii-video, manim-video, p5js, comfyui, touchdesigner-mcp, pixel-art, songwriting-and-ai-music, heartmula, youtube-content, claude-design, excalidraw, architecture-diagram, concept-diagrams, baoyu-comic, humanizer, gif-search, meme-generation]
    credits: |
