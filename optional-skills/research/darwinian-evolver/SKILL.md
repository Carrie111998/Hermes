...
version: 0.1.0
author: Bihruze (Asahi0x), Orion Agent
license: MIT
...
import upstream classes into Orion itself.
...
Open `~/.orion/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Orion core.
   Custom driver scripts under `~/.orion/skills/...` are user-side and fine.
