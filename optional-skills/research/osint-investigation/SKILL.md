...
author: Orion Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT)
license: MIT
metadata:
  orion:
...
# $ORION_OSINT_CACHE/icij/ (default: ~/.cache/orion-osint/icij/).
...
# Set ORION_OSINT_UA=your-app/1.0 (your@email) to identify yourself
