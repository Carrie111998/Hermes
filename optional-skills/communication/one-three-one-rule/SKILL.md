...
description: >-
  The 1-3-1 decision format — frame any choice as 1 problem, 3 options with
  pros/cons, and 1 recommendation with a definition of done and implementation
  plan. Use when the user asks for a "1-3-1", says "give me options", or must
  choose between competing approaches (architecture, tooling, refactoring,
  migration paths).
