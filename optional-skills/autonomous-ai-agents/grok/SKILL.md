...
| To do X | Read |
|:--------|:-----|
| Full headless flag table, output formats, background mode, session continuation | `references/orchestration-patterns.md` |
| Read-only audit → markdown note pattern | `references/orchestration-patterns.md` |
| PR review patterns (quick, clone-to-temp, post) | `references/orchestration-patterns.md` |
| Parallel issue fixing with git worktrees | `references/orchestration-patterns.md` |
| Useful subcommands, TUI slash commands, `~/.grok/config.toml` | `references/orchestration-patterns.md` |
| Pitfalls & gotchas (auth gating, `--no-auto-update`, `--always-approve`) | `references/orchestration-patterns.md` |
