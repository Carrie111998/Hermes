...
def _state_dir() -> Path:
    ...
    # Default: $ORION_HOME/watcher-state/, falling back to ~/.orion/watcher-state/.
    orion_home = os.environ.get("ORION_HOME") or str(Path.home() / ".orion")
    return Path(orion_home) / "watcher-state"
