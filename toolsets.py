...
_HERMES_CORE_TOOLS = [
    ...
    # Cronjob management
    "cronjob",
    # Memory-kernel approval requests — proposing and requesting operator
    # approval for it are the same workflow step (outbound platform messaging,
    # which upstream now handles outside the agent loop). Belongs alongside
    # the messaging surface, not a toolset you'd need to separately enable.
