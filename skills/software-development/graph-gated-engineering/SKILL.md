---
name: graph-gated-engineering
description: "Graph-gated engineering: model the whole system, agree on the graph, gate with real tests, slice at seams, verify with receipts. Resolves the memory-system question structurally."
version: 1.0.0
...
metadata:
  hermes:
    ...
    related_skills: [systematic-debugging, test-driven-development, plan, worktree-hive, god-file-decomposition, codebase-inspection]
---
