...
How Hermes discovers and injects `.hermes.md` / `AGENTS.md` / `CLAUDE.md` / `.cursorrules`, which one to pick, size caps, injection security, and how to disable per session.
