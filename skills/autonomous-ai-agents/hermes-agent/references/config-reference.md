# Hermes Paths, Config, Providers & Toolsets

Filesystem layout under `~/.hermes`, the config sections you can set, the 20+ supported providers with their env vars, and the full toolset table.
