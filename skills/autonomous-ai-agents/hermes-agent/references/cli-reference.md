...
Global flags and every `hermes` subcommand group: chat, config, tools/skills, MCP, gateway, sessions, cron, webhooks, profiles, credentials. Run `hermes --help` for the authoritative list.
