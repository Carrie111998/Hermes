...
Registry of record: `orion_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore Orion config+state snapshots (CLI)
