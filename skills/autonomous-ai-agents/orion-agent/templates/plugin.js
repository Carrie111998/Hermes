/**
 * Orion desktop plugin template. Save as:
 *   <orion home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <orion home> is ~/.orion by default, or ~/.orion/profiles/<name>
 * when running a named profile (`orion -p <name>`). Run `orion doctor` (or
 ...
 * Only these imports resolve: @orion/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@orion/plugin-sdk'
