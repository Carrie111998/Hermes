# Print Mode (`-p`) Deep Dive

Structured and streaming JSON output, bidirectional streaming, piped input, `--json-schema` extraction, session continuation/forking, `--bare` for CI, and fallback models.
