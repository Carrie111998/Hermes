# PR Review Patterns & Parallel Instances

Quick print-mode review, deep interactive review in a worktree, review-by-PR-number, `claude worktree` with tmux, and running several Claude instances at once.
