# `ntn` CLI Command Reference (preferred path, macOS / Linux)
...
Compare to the 3-step HTTP flow (create upload → PUT bytes → reference) documented in `references/http-api.md`.
