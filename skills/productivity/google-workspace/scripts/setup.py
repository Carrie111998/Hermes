...
from _hermes_home import atomic_write_json, display_hermes_home, get_hermes_home  # type: ignore[attr-defined]
...
def store_client_secret(path: str):
    ...
    atomic_write_json(CLIENT_SECRET_PATH, data)
...
def exchange_auth_code(code: str):
    ...
    atomic_write_json(TOKEN_PATH, token_payload)
