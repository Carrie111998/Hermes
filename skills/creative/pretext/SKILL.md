---
name: pretext
description: "Creative browser demos with @chenglou/pretext: DOM-free text layout for ASCII art, typographic flow around obstacles, text-as-geometry games, kinetic typography. Emits single-file HTML."
version: 1.0.0
author: Hermes Agent
license: MIT
