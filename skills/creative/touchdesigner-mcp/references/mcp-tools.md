...
The tables above cover the 32 tools used in typical creative workflows. The
remaining 4 (`td_project_quit`, `td_test_session`, `td_dev_log`,
`td_clear_dev_log`) are admin/dev-mode utilities, documented below with the rest.
