# Visual craft: typography, color, layout, motion, imagery

Concrete guidance for choosing type, building a small color system, composing with rhythm, using motion, and handling images and icons.
