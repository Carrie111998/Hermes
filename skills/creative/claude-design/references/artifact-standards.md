# Artifact, HTML/CSS/JS, and React standards

File and naming rules for standalone artifacts, modern CSS/HTML practice, accessibility minimums, and when to reach for React.
