...
Built for [Orion Agent](https://github.com/zacharyjleach-stack/Aries). Usable in any coding agent. Canonical source lives here; synced to [`Orion/orion-agent/skills/creative/ascii-video`](https://github.com/zacharyjleach-stack/Aries/tree/main/skills/creative/ascii-video) via PR.
