...
Aesthetic decision-making for p5.js work: the creative standard, the vocabulary
of aesthetic dimensions, per-project variation rules, parameter design, and
divergence strategies for experimental briefs.
...
## Quality Verification (final gate)

- **Does it match the vision?** Compare output to the creative concept. If it looks generic, go back to the creative vision step
...
Use only when the user requests experimental, creative, surprising, or
unconventional output. Select the strategy that best fits and reason through its
steps BEFORE generating code.
