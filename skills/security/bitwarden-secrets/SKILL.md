...
6. **The gate is tested.** The end-to-end no-exfiltration test (`tests/test_secrets_exfiltration.py`) pins invariants 3+4: a loaded secret's name and value never surface in stdout, stderr, or formatted output. Run it as part of any change to this integration.
