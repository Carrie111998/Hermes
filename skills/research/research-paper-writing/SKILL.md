...
| **`delegate_task`** | Phase 5 (Drafting): optional parallel section work with distinct, non-overlapping scopes | Native Hermes tool; verify returned claims in the parent context |
