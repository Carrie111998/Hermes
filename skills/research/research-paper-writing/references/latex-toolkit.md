...
Template setup and pitfalls, per-venue quick reference, tables and figures, professional preamble, siunitx alignment, subfigures, algorithm2e pseudocode, TikZ diagram patterns, latexdiff, and SciencePlots. Loaded from the `research-paper-writing` skill.
...
For converting between venues, see [references/submission-prep.md](references/submission-prep.md) — it covers the full conversion workflow, page-change table, and post-rejection guidance.
