...
Which refinement strategy to use for a given model tier and task type. For the full loop, prompts, Borda scoring, and compute budgets see [references/autoreason-methodology.md](references/autoreason-methodology.md).
