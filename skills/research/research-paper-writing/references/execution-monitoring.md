...
Launching long runs, cron monitoring, failure recovery table, result commits, and the experiment journal format. Loaded from the `research-paper-writing` skill.
