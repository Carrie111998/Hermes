...
Anonymization, formatting verification, pre-compilation validation scripts, final compilation, venue-specific requirements, resubmission/format conversion, camera-ready, arXiv strategy, and research code packaging. Loaded from the `research-paper-writing` skill.
