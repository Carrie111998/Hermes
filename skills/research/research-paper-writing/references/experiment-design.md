...
Claim-to-experiment mapping, baseline categories, evaluation protocol, experiment script patterns, and human-evaluation design decisions. Loaded from the `research-paper-writing` skill.
