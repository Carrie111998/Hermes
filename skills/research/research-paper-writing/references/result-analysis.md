...
Aggregation scripts, statistical significance, story identification, negative results, figures/tables, and the `experiment_log.md` bridge format. Loaded from the `research-paper-writing` skill.
