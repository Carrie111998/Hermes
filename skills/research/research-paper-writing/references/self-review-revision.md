...
Ensemble review simulation with meta-review, visual (VLM) review pass, claim verification, feedback prioritization, revision cycle, rebuttal writing, and paper evolution tracking. Loaded from the `research-paper-writing` skill.
