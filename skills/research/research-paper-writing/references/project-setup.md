...
Workspace layout, git discipline, contribution framing, TODO scaffolding, compute budgeting, and multi-author coordination. Loaded from the `research-paper-writing` skill.
