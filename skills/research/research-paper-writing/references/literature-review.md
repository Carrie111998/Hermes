...
Seed-paper discovery, iterative breadth-then-depth search, mandatory citation verification, and related-work organization. Loaded from the `research-paper-writing` skill.
