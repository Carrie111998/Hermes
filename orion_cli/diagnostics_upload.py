"""Client for uploading ``orion debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``orion debug share``.
...
NAS_BASE = os.environ.get(
    "ORION_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "orion-agent/debug-share"
