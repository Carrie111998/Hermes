"""
Skills configuration for Orion Agent.
`orion skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.orion/config.yaml under:
...
from orion_cli.config import cfg_get, load_config, save_config
from orion_cli.colors import Colors, color
from orion_cli.platforms import PLATFORMS as _PLATFORMS
