...
from orion_cli.proxy.adapters.base import UpstreamAdapter
from orion_cli.proxy.adapters.nous_portal import NousPortalAdapter
from orion_cli.proxy.adapters.xai import XAIGrokAdapter

# Registry of available adapter classes keyed by provider name as used on
# the ``orion proxy start --provider <name>`` CLI flag.
