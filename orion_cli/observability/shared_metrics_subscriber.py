"""Relay subscriber for the persisted Orion shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Orion counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Orion shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
