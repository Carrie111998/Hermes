...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'orion tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # orion tools disable <name...> [--platform cli]
    ...
    # orion tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `orion tools` runs after you pick a provider that\n"
