...
Entry point: ``orion whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``orion_cli/main.py``).
...
Orion gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Orion to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Orion needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Orion gateway in another terminal:")
    print("         orion gateway")
    print()
    ...
    print()
    print("  Docs: https://your-orion-docs.example/docs/user-guide/")
