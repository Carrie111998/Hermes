...
Invoked by ``orion kanban decompose [task_id | --all]`` and the
...
* Mirrors the shape of ``orion_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Orion Agent board.
...
def _profile_author() -> str:
    """Mirror of ``orion_cli.kanban._profile_author``."""
    return (
        os.environ.get("ORION_PROFILE")
