...
Used by ``orion profile describe <name> --auto`` and the dashboard's
...
_SYSTEM_PROMPT = """You are a profile-describer for the Orion Agent kanban board.
...
Rules:
  ...
  - Never write "Orion Agent profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_orion_home())
        else:
