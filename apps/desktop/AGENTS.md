...
even as files move. Read it with [`../../AGENTS.md`](../../AGENTS.md) — Hermes
does not automatically merge parent and child context files — and
[`DESIGN.md`](./DESIGN.md) for the visual and interaction contract.
...
## Backend and slash-command integration
