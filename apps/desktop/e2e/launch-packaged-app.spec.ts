...
/**
 * E2E smoke tests for the packaged Charterforge desktop app.
 *
 ...
 * (credential stripping, isolated CHARTERFORGE_HOME + userData, unique app name).
 *
...
test('window opens with the Charterforge title', async () => {
  const title = await fixture!.page.title()
  expect(title).toContain('Charterforge')
})
