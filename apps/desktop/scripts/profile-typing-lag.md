...
cd apps/desktop
XCURSOR_SIZE=24 ORION_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/orion-typing
# → /tmp/orion-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/orion-typing.before.heapsnapshot
# → /tmp/orion-typing.after.heapsnapshot
```
