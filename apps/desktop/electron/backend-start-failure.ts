 ...
 * startOrion() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startOrion() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startOrion`, re-emits
