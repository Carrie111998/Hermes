...
// even though a fresh shell — and the Charterforge CLI — sees it immediately. The
// desktop's CHARTERFORGE_HOME resolution relies on process.env, so that stale-snapshot
