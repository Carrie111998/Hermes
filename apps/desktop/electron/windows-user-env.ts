...
// even though a fresh shell — and the Orion CLI — sees it immediately. The
// desktop's ORION_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\orion. Reading
...
//       ORION_HOME    REG_SZ    F:\Orion\data
//
