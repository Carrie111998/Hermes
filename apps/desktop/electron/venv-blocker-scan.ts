...
export function formatBlockerMessage(result: VenvBlockerScanResult): string {
  const lines = [
    'Update aborted: another Douglas Agent process is using this installation.',
    '',
...
export function formatProbeFailedMessage(): string {
  return (
    'Update aborted: Desktop could not verify the Douglas Agent installation is free.\n' +
    '\n' +
    'Close other Douglas Agent windows and terminals, then retry.  If the problem\n' +
