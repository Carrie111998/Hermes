 ...
 *
 * A public install can end up with `origin=git@github.com:Orion/orion-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/zacharyjleach-stack/Aries.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/nousresearch/orion-agent'
