...
export const ZOOM_STORAGE_KEY = 'orion:desktop:zoomLevel'
 ...
 * but forgot to emit 'orion:zoom:changed', leaving the control stuck at 100%.
...
export function applyZoomLevel(webContents, level) {
  ...
  webContents.send('orion:zoom:changed', { level: clamped, percent: zoomLevelToPercent(clamped) })
