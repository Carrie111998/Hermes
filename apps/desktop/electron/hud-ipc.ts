...
export function registerHudIpc({
  ...
  ipcMain.handle('orion:hud:open', async (_event, request) => {
    openHudWindow(
  ...
  ipcMain.handle('orion:hud:frost', (_event, showing) => {
  ...
  // reaches the bar.
  ipcMain.on('orion:hud:ignore-mouse', (_event, ignore) => {
    const hudWindow = getHudWindow()
  ...
  ipcMain.on('orion:hud:move-by', (event, delta) => {
    const hudWindow = getHudWindow()
  ...
  ipcMain.on('orion:hud:set-bounds', (event, bounds) => {
    const hudWindow = getHudWindow()
  ...
  ipcMain.on('orion:hud:session', (event, sessionId) => {
    const hudWindow = getHudWindow()
  ...
  ipcMain.handle('orion:hud:close', async () => {
    closeHudWindow()
