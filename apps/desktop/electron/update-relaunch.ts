...
// backend/profile/root it talks to). Anything CHARTERFORGE_DESKTOP_* is preserved
// plus CHARTERFORGE_HOME. We snapshot the values, not the live env, so the new
...
const PRESERVED_ENV_KEYS = ['CHARTERFORGE_HOME', 'ELECTRON_DISABLE_SANDBOX']
const PRESERVED_ENV_PREFIXES = ['CHARTERFORGE_DESKTOP_']
