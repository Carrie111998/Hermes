...
// by main.ts (`setBackgroundThrottling` driven by the merged `orion:active-work`
...
// (the "Orion idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Orion" wake word has NO preceding click,
