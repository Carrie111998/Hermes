...
import type * as OrionModule from '@/orion'
...
vi.mock('@/orion', async importActual => ({
  ...(await importActual<typeof OrionModule>()),
...
const { getLatestSessionMessages } = await import('@/orion')
