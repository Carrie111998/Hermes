...
import { getLatestSessionMessages, triggerCronJob } from '@/nastech'
...
export function ContribWiring({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    window.addEventListener('nastech:open-keybinds', onOpenKeybinds)

    return () => window.removeEventListener('nastech:open-keybinds', onOpenKeybinds)
  }, [navigate])
  ...
  useEffect(() => {
    ...
    void refreshNastechConfig(true)
    void refreshActiveProfile()
  }, [activeGatewayProfile, refreshCurrentModel, refreshNastechConfig])
