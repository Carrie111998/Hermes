...
export function OverlayView({
  ...
  return (
    ...
    >
      <div
        className={cn(
          'overlay-surface-enter relative flex h-full min-h-0 flex-col overflow-hidden rounded-[var(--radius-2xl)] border border-(--ui-stroke-secondary) bg-(--ui-chat-surface-background) shadow-md',
          rootClassName
        )}
      >
