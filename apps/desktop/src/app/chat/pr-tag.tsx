...
import type { OrionBranchPullRequest } from '@/global'
...
export function openPullRequest(pr: OrionBranchPullRequest): void {
  if (pr.url) {
    void window.orionDesktop?.openExternal?.(pr.url)
  }
}
