...
const FOCUS_EVENT = 'orion:composer-focus'
const INSERT_EVENT = 'orion:composer-insert'
const ATTACH_IMAGES_EVENT = 'orion:composer-attach-images'
const INSERT_REFS_EVENT = 'orion:composer-insert-refs'
const SUBMIT_EVENT = 'orion:composer-submit'
const VOICE_TOGGLE_EVENT = 'orion:composer-voice-toggle'
const MODEL_MENU_EVENT = 'orion:composer-model-menu'
