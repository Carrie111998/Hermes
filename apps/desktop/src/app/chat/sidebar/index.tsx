...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/orion'
...
// highlight markers (sqlite snippet() delimiters — see orion_state_search.py).
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('orion:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('orion:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Orion to
