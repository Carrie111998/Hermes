...
const branchActionLabel = (branch: OrionGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<OrionGitBranch[]>([])
  ...
  const convert = async (branch: OrionGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
