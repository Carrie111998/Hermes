...
/** Keep the resume publication signal in lockstep with the visible transcript.
 * Hidden keep-alive panes catch up when revealed instead of consuming it early. */
