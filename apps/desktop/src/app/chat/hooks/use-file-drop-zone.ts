...
import { type DroppedFile, extractDroppedFiles, ORION_PATHS_MIME } from './use-composer-actions'
...
const dragKindOf = (event: ReactDragEvent): DragKind =>
  dragHasAttachments(event.dataTransfer, ORION_PATHS_MIME) ? 'files' : null
