...
function buildTileView(storedSessionId: string): SessionView {
  ...
  return {
    ...
    $fleetAdapterKind: computed($state, state => state?.fleetAdapterKind ?? ''),
    $fleetLaneId: computed($state, state => state?.fleetLaneId ?? ''),
    ...
    $modelDisplayLabel: computed($state, state => state?.modelDisplayLabel ?? ''),
    $modelSource: computed($state, state => state?.modelSource ?? ''),
