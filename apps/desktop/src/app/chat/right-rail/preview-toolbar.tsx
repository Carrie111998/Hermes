 ...
 *
 * Replaces the old `<a>` label that opened the URL in the user's external
 * browser (see preview-pane.tsx history). Now navigation happens IN the
 * preview: back / forward / address / submit / reload, with HTTP-only
 * validation so the address bar can't be tricked into opening `file://` or
 * `data:` URLs in the embedded `<webview>`.
 *
