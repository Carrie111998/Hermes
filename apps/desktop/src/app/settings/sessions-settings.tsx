...
import type { OrionConfigRecord, SessionInfo } from '@/types/orion'
...
// / Program Files), which buried any files Orion wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.orionDesktop` is
    ...
    const settings = window.orionDesktop?.settings
