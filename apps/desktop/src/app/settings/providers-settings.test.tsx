...
import type { EnvVarInfo, OAuthProvider } from '@/types/orion'
    ...
    listOAuthProviders.mockResolvedValue({
      providers: [
        provider('qwen-oauth', true, {
          ...
          disconnect_hint: "Use `orion auth add qwen-oauth` or that provider's CLI to remove it.",
