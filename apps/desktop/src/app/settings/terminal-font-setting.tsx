...
import { saveOrionConfig } from '@/orion'
...
function fontFamilyFromConfig(config: OrionConfigRecord): string {
...
export function TerminalFontSetting() {
  ...
  const [staleConfig, setStaleConfig] = useState<OrionConfigRecord | null>(null)
  ...
  useEffect(() => {
    ...
    // holds — successful saves write it back via setOrionConfigCache, so
        ...
        <div className="mt-3 space-y-2">
          <div className="flex items-center gap-3">
            <Input
              ...
              className="flex-1"
              disabled={draft === null}
              list="orion-terminal-font-families"
          ...
          <datalist id="orion-terminal-font-families">
