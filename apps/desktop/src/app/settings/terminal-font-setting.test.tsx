...
vi.mock('@/orion', () => ({
  saveOrionConfig: (config: Record<string, unknown>) => mocks.save(config)
}))
...
vi.mock('../hooks/use-config-record', () => ({
  setOrionConfigCache: (config: Record<string, unknown>) => mocks.cache(config),
  useOrionConfigRecord: () => ({ data: mocks.loadedConfig })
}))
