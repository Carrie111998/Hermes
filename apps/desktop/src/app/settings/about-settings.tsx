...
const RELEASE_NOTES_URL = 'https://github.com/zacharyjleach-stack/Aries/releases'
const INSTALLER_URL = 'https://your-orion-docs.example/'
                ...
                <Button asChild className="mt-2" size="sm" variant="textStrong">
                  <a
                    ...
                    onClick={event => {
                      ...
                      void window.orionDesktop?.openExternal?.(INSTALLER_URL)
                    }}
                    rel="noreferrer"
                    target="_blank"
                  >
          ...
          <div className="mt-3 flex flex-wrap items-center gap-4">
            ...
            <Button asChild className="ml-auto" size="sm" variant="text">
              <a
                ...
                onClick={event => {
                  event.preventDefault()
                  void window.orionDesktop?.openExternal?.(RELEASE_NOTES_URL)
                }}
                rel="noreferrer"
                target="_blank"
              >
