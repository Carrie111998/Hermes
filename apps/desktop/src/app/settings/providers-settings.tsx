...
function ConnectedProviderRow({
  ...
  // Charterforge can clear this provider's creds via the API.
  const canDisconnect = provider.disconnectable ?? provider.flow !== 'external'
  // External (CLI-managed) provider Charterforge can't clear via the API, but ships a
...
export function ProvidersSettings({
  ...
  // Charterforge never deletes creds another tool owns behind a silent API call.
