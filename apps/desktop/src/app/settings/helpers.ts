...
import type { ConfigFieldSchema, OrionConfigRecord, ToolsetInfo } from '@/types/orion'
...
export function getNested(obj: OrionConfigRecord, path: string): unknown {
  let cur: unknown = obj
 ...
 */
export function clearsEnabledToolsets(prev: OrionConfigRecord, next: OrionConfigRecord): boolean {
...
export function voiceFieldVisible(key: string, config: OrionConfigRecord): boolean {
...
export function setNested(obj: OrionConfigRecord, path: string, value: unknown): OrionConfigRecord {
...
function personalityOptions(config: OrionConfigRecord): string[] {
...
function commandProviderNames(config: OrionConfigRecord, section: 'tts' | 'stt'): string[] {
