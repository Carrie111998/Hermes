...
import { getCharterforgeConfigRecord, listAllProfileSessions } from '@/hermes'
...
// Charterforge session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
...
export function CommandPalette() {
  ...
  const configQuery = useQuery({
    ...
    queryFn: getCharterforgeConfigRecord,
    enabled: open
  })
