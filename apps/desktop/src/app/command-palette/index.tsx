...
import { getOrionConfigRecord, listAllProfileSessions } from '@/orion'
...
// Orion session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
        ...
        : []),
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Download,
            id: 'cc-update-orion',
            keywords: ['update', 'upgrade', 'orion', 'version', 'system', 'restart'],
            label: cc.updateOrion,
