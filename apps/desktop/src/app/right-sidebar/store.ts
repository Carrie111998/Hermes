...
const TAKEOVER_KEY = 'orion.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Orion can't clear via the API — the user
 *  sees exactly what runs instead of Orion silently deleting their creds. */
