...
import type { OrionReadDirEntry, OrionReadDirResult } from '@/global'
...
function ok(entries: OrionReadDirEntry[]): OrionReadDirResult {
  return { entries }
}
...
function installBridge() {
  ...
  ).orionDesktop = { gitRoot, readDir, readFileDataUrl }
}
