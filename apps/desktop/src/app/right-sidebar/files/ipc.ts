...
export type ProjectTreeEntry = CharterforgeReadDirEntry
...
function ignoredBy(rules: GitignoreRule[], entry: CharterforgeReadDirEntry) {
...
async function filterIgnored(entries: CharterforgeReadDirEntry[], rootPath: string, dirPath: string) {
...
export async function readProjectDir(dirPath: string, rootPath = dirPath): Promise<CharterforgeReadDirResult> {
