...
// While a section has never loaded anything yet, a loading flag with no data
// means the first fetch is in flight — show the skeleton instead of the empty
// copy so the pane does not flash "No branches" before data arrives.
function skeleton(loading: boolean, isEmpty: boolean): ReactNode {
  return loading && isEmpty ? <TreeSkeleton /> : null
}
