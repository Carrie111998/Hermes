...
export function buildReviewFlatList(files: OrionReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: OrionReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
