...
export function buildReviewFlatList(files: CharterforgeReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: CharterforgeReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
