...
export function useGatewayRequest() {
  ...
  const gatewayRef = useRef<CharterforgeGateway | null>(null)
  ...
  const reconnectingRef = useRef<Promise<CharterforgeGateway | null> | null>(null)
  ...
  useEffect(
    () =>
      $gateway.subscribe(gateway => {
        gatewayRef.current = gateway as CharterforgeGateway | null
      }),
    []
  )
