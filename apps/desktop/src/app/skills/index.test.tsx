...
import type * as OrionApi from '@/orion'
...
vi.mock('@/orion', async importOriginal => ({
  ...(await importOriginal<typeof OrionApi>()),
...
describe('SkillsView toolset management', () => {
    ...
    await act(async () => {
      window.dispatchEvent(
        new MessageEvent('message', {
          data: { type: 'orion-skill-pick', name: 'web-research', identifier: 'web-research' },
          origin: 'https://your-orion-docs.example'
        })
      )
    })
  ...
  it('offers (connection, profile) scope rows on multi-connection desktops', async () => {
    ...
    ;(window as { orionDesktop?: unknown }).orionDesktop = { connections, getAgentRoster }
