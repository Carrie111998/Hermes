/**
 * Charterforge skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$CHARTERFORGE_HOME/skins/` (or a
 ...
 * skin Charterforge authors from a prompt lights up all three surfaces from one file.
 *
...
import type { CharterforgeSkin, SkinColors } from '@charterforge/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: CharterforgeSkin): DesktopTheme | null {
