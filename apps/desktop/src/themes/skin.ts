/**
 * Orion skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$ORION_HOME/skins/` (or a
 * built-in) resolved by `orion_cli/skin_engine.py` and pushed to every surface
 ...
 * skin Orion authors from a prompt lights up all three surfaces from one file.
 *
...
import type { OrionSkin, SkinColors } from '@orion/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: OrionSkin): DesktopTheme | null {
