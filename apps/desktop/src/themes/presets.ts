...
/**
 * Nous — the canonical Orion desktop identity, forked from the GitHub VS Code
 ...
 * extension yourself.
 *
 * Typography stays Orion's own: a VS Code theme carries no font opinion, and
...
/**
 * Nous — the canonical Orion desktop identity: GitHub's chrome carrying Nous
