...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|orion):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.orionDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.orionDesktop?.openExternal?.(href)
  }
}
 ...
 * doesn't cost a context switch out of Orion, and it is the surface the agent
