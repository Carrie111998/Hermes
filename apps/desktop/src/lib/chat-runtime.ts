...
import type { ModelOptionsResponse, SessionInfo } from '@/types/orion'
 ...
 *
 * Only the leading status prefix (e.g. "Orion is thinking...") and the
 ...
 *  resolved comment as JSON (OrionPrComment shape); a malformed payload falls
