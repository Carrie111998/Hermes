...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/orion-agent')).toBe('~/www/orion-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/orion-agent')).toBe('orion-agent')
    expect(pathLeaf('~/www/orion-agent')).toBe('orion-agent')
