...
export interface PetInfo {
  ...
  // the Orion "run" activity state uses the in-place running row).
 ...
 * ORION_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'orion.desktop.pet-roam.v1'
