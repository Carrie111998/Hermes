...
const SIDEBAR_MESSAGING_OPEN_STORAGE_KEY = 'nastech.desktop.sidebarMessagingOpen'
const SIDEBAR_SESSION_ORDER_STORAGE_KEY = 'nastech.desktop.sessionOrder'
const SIDEBAR_SESSION_ORDER_MANUAL_STORAGE_KEY = 'nastech.desktop.sessionOrder.manual'
const SIDEBAR_GROUPING_STORAGE_KEY = 'nastech.desktop.sidebarGrouping'
const SIDEBAR_ALL_PROFILES_GROUPING_STORAGE_KEY = 'nastech.desktop.sidebarGrouping.allProfiles'
const SIDEBAR_SORT_KEY_STORAGE_KEY = 'nastech.desktop.sidebarSortKey'
const SIDEBAR_ROW_META_STORAGE_KEY = 'nastech.desktop.sidebarRowMeta'
const SIDEBAR_STATUS_FILTER_STORAGE_KEY = 'nastech.desktop.sidebarStatusFilter'
const SIDEBAR_SHOW_ARCHIVED_STORAGE_KEY = 'nastech.desktop.sidebarShowArchived'
const SIDEBAR_PROJECT_FILTER_STORAGE_KEY = 'nastech.desktop.sidebarProjectFilter'
const SIDEBAR_PROFILE_FILTER_STORAGE_KEY = 'nastech.desktop.sidebarProfileFilter'
const SIDEBAR_PR_FILTER_STORAGE_KEY = 'nastech.desktop.sidebarPrFilter'
const SIDEBAR_WORKSPACE_ORDER_STORAGE_KEY = 'nastech.desktop.workspaceOrder'
const SIDEBAR_WORKSPACE_PARENT_ORDER_STORAGE_KEY = 'nastech.desktop.workspaceParentOrder'
const SIDEBAR_PROJECT_ORDER_STORAGE_KEY = 'nastech.desktop.projectOrder'
const SIDEBAR_WORKSPACE_COLLAPSED_STORAGE_KEY = 'nastech.desktop.workspaceCollapsed'
const SIDEBAR_WORKSPACE_NODE_OPEN_STORAGE_KEY = 'nastech.desktop.workspaceNodeOpen'
const SIDEBAR_DISMISSED_AUTO_PROJECTS_STORAGE_KEY = 'nastech.desktop.dismissedAutoProjects'
const SIDEBAR_DISMISSED_WORKTREES_STORAGE_KEY = 'nastech.desktop.dismissedWorktrees'
const PANES_FLIPPED_STORAGE_KEY = 'nastech.desktop.panesFlipped'
const RIGHT_RAIL_ACTIVE_TAB_STORAGE_KEY = 'nastech.desktop.rightRailActiveTab'
