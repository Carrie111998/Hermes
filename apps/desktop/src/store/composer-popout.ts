...
const POPOUT_STORAGE_KEY = 'orion.desktop.composerPopout.zones.v1'
const POPOUT_GESTURES_ENABLED_STORAGE_KEY = 'orion.desktop.composerPopout.gesturesEnabled'
...
const LEGACY_ENABLED_KEY = 'orion.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'orion.desktop.composerPopout.position'
