...
import type { CharterforgeGitWorktree, CharterforgeRepoStatus } from '@/global'
...
export const $repoStatus = atom<CharterforgeRepoStatus | null>(null)
...
export const $repoWorktrees = atom<CharterforgeGitWorktree[]>([])
...
interface RepoStatusRefreshRequest {
  probe: (cwd: string) => Promise<CharterforgeRepoStatus | null>
  seq: number
  target: string
}
