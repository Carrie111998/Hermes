...
// session uses the configured default project dir (or stays detached). It does
// NOT inherit the workspace of the chat you were looking at: after a restart the
// focused session is usually the just-resumed one, whose stored cwd can be a
// stale fallback (e.g. the user's home dir on Windows) — inheriting it makes
// every "New session" land there instead of the configured default (#71873,
// #80213, #77496).
