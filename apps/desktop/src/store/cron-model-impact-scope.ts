...
function identityForConnection(connection: OrionConnection | null): string {
  if (!connection) {
    return ''
  }
...
export function syncCronModelImpactConnection(connection: OrionConnection | null): void {
