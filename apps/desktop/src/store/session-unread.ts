...
function rehydrateFromDiskOnce(): void {
  ...
  try {
    const rawSeen = readKey('orion.desktop.sessionSeenCounts')
    ...
    const rawMarkers = readKey('orion.desktop.unreadFinishedSessions')
