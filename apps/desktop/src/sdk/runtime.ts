 ...
 * plugins resolve `@orion/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __ORION_PLUGIN_SDK__: sdk,
  __ORION_REACT__: React,
  __ORION_REACT_JSX__: jsxRuntime,
  __ORION_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@orion/plugin-sdk': shimUrl('__ORION_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__ORION_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__ORION_REACT_JSX__'),
    react: shimUrl('__ORION_REACT__')
  }
