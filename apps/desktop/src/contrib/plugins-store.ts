 ...
 * `<orion home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'orion.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'orion.desktop.disabledPlugins.v1'
