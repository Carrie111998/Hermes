...
test('generated protocol uses orion profile list, not the invalid profiles plural', () => {
  assert.match(source, /run `orion profile list` for the LIVE/)
  assert.doesNotMatch(source, /run `orion profiles list` for the LIVE/)
})
