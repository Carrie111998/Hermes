...
export interface OAuthProvider {
   ...
   *  embedded terminal. Null when Charterforge doesn't know how to remove it. */
...
export interface CharterforgeConfig {
  agent?: {
...
export type CharterforgeConfigRecord = Record<string, unknown>
...
export interface SkillInfo {
  ...
  usage?: number
  /** 'agent' = learned/local (editable), 'bundled' = ships with Charterforge, 'hub' = installed. */
 ...
 *  not Charterforge); elsewhere, driver health from `cua-driver doctor`. `null`
