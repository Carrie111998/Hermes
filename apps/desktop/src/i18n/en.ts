...
export const en: Translations = {
  ...
  composer: {
    ...
    rewriteBasic: 'Basic rewrite',
    rewriteBasicDesc: 'Improve clarity and grammar without adding scope.',
    rewriteBrief: 'Expand briefly',
    rewriteBriefDesc: 'Add only the essentials needed to make the task actionable.',
    rewriteDetailed: 'Expand with details',
    rewriteDetailedDesc: 'Create an implementation-ready spec with tests and acceptance criteria.',
    rewriteEnhance: 'Enhance',
    rewriteEnhanceDesc: 'Add relevant engineering considerations, using detected project context when available.',
    rewriteFailed: 'Could not rewrite prompt',
    rewriteDraftChanged: 'Your draft changed while the rewrite was running, so it was left untouched.',
    tipPre: 'Tip: type ',
