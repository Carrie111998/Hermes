...
export const en: Translations = {
  ...
  cron: {
    ...
    scriptTimeoutLabel: 'Script timeout (seconds)',
    scriptTimeoutPlaceholder: 'Global default',
    scriptTimeoutHint: 'Leave blank for the global timeout. Enter 0 for no wall-clock limit.',
    scriptTimeoutInvalid: 'Script timeout must be zero or a positive finite number.',
    scriptTimeoutUnlimited: 'Unlimited',
