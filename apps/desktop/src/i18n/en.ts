...
export const en: Translations = {
  common: {
    ...
    autoRefillAmount: 'Auto-refill reload-to amount',
    customCreditAmount: 'Custom credit amount',
    customEndpoints: 'Custom Endpoints',
    deleteEndpoint: 'Delete endpoint',
    noCustomEndpoints: 'No custom endpoints',
    addEndpointDesc: 'Add an OpenAI-compatible endpoint below.',
    ...
    loadingMemoryProviderSettings: 'Loading memory provider settings...',
    askHermes: 'Ask Hermes…',
    notConnectedReconnect: 'Not connected — open Hermes to reconnect',
    sendTo: 'Send to',
