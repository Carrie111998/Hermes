...
export const en: Translations = {
  ...
  settings: {
    ...
    billing: {
      ...
      disable: 'Disable',
      turnOffPrompt: 'Turn off auto-refill?',
      turnOff: 'Turn off',
      customCreditAmount: 'Custom credit amount',
      buy: 'Buy',
      processingSettlement: 'Processing… checking settlement',
      addedBalanceRefreshing: amount => `${amount} added. Balance is refreshing.`,
      ...
      updatedAgo: time => `Updated ${time}`,
      billingFixture: 'Billing fixture',
      live: 'live',
      openPortalExternal: 'Open portal ↗',
      connectAccountMessage: 'Run /portal in the TUI or open the Nous portal to connect your account.',
      connectAccountTitle: 'Connect your Nous account',
      balance: 'Balance',
      plan: 'Plan',
      ...
      paymentMethodMissingDescription: 'Add a payment method on the portal before buying top-up credits.',
      paymentMethod: 'Payment method',
      noCard: 'No card on file',
      paymentMethodDescription: 'Manage the card used for top-ups and subscription renewals.',
      adjustPlanExternal: 'Adjust plan ↗',
      ...
      subscriptionDescription: 'Review your plan and change it from the billing portal.',
      opensPortal: 'opens portal',
      subscription: 'Subscription',
      buyCredits: 'Buy credits',
      buyCreditsDescription: 'Add top-up credits for agent runs outside your plan.',
      manage: 'Manage',
      manageAutoRefillPortal: 'Manage auto-refill from the portal.',
      autoRefillDescription: 'Keep your balance topped up when it drops below your threshold.',
      turnOnAutoRefillPortal: 'Turn on auto-refill from the portal',
      differentCard: 'a different card',
      reconcileExternal: 'Reconcile ↗',
      autoRefillCharges: card => `Auto-refill charges ${card} — reconcile on the portal`,
      refillWhen: (amount, threshold) => `Refill ${amount} when balance falls below ${threshold}`,
      subscriptionRemainingOver: (remaining, monthly, over) => `${remaining} of ${monthly} left · ${over} over`,
      subscriptionRemaining: (remaining, monthly) => `${remaining} of ${monthly} left`,
      ...
      topUpCreditsRemaining: 'Top-up credits remaining',
      doesNotExpire: 'Does not expire',
      topUpCredits: 'Top-up credits',
      amountOfLimitUsed: (amount, limit) => `${amount} of ${limit} used`,
      monthlySpendCapUsed: 'Monthly spend cap used',
      defaultCeiling: 'Default ceiling',
      monthlyTerminalBillingSpend: 'Monthly terminal billing spend',
      monthlySpendCap: 'Monthly spend cap',
      planMonthly: (tier, price) => `${tier} · ${price}/mo`,
      autoRefillCard: 'auto-refill card',
      customerDefault: 'customer default',
      subscriptionCard: 'subscription card',
      creditsAdded: amount => `${amount} added.`,
      creditsAddedGeneric: 'Credits added.',
      ...
      chargeOutcomeUnconfirmedTitle: 'Charge outcome unconfirmed',
      couldNotCheckCharge: 'Could not check the charge.',
      couldNotCheckChargeTitle: 'Could not check charge',
      acceptedNoChargeId: 'The billing service accepted the request but did not return a charge id.',
      chargeCouldNotBeTracked: 'Charge could not be tracked',
      chargeMayStillSettle: 'Charge may still settle. Check the portal before retrying.',
      stillProcessing: 'Still processing after 5 minutes',
      ...
      chargeProcessingError: reason => `The charge didn't go through (${reason}).`,
      verificationNotGrantedMessage: 'Verification finished without granting billing management access.',
      verificationNotGrantedTitle: 'Verification was not approved',
      billingAccessVerifiedMessage: 'Billing management access was verified.',
      billingAccessVerifiedTitle: 'Verification complete',
      reloadGreaterThanThreshold: 'Reload-to amount must be greater than the threshold.',
      invalidAmount: label => `${label}: enter a dollar amount with at most 2 decimal places.`,
      amountGreaterThanZero: label => `${label}: amount must be greater than $0.`,
      minimumAmount: (label, minimum) => `${label}: minimum is ${minimum}.`,
      maximumAmount: (label, maximum) => `${label}: maximum is ${maximum}.`,
      errors: {
        tooManyChargesRetry: minutes =>
          `🟡 Too many charges right now (try again in ~${minutes} min). This isn't a payment failure.`,
        tooManyCharges: "🟡 Too many charges right now. This isn't a payment failure.",
        stripeRetry: minutes => `Stripe is having trouble — try again in ~${minutes} min`,
        ...
        orgAccessMessage: "This token isn't bound to an org you can manage",
        orgAccessTitle: 'Org access denied',
        monthlyCapRemaining: remaining => `🔴 Monthly spend cap reached — $${remaining} headroom left.`,
        monthlyCapMessage: '🔴 Monthly spend cap reached.',
        monthlyCapTitle: 'Monthly spend cap reached',
        tooManyChargesTitle: 'Too many charges right now',
        stripeTroubleTitle: 'Stripe is having trouble',
        planLimitMessage: 'Daily plan-change limit reached — try again tomorrow',
        planLimitTitle: 'Daily plan-change limit reached',
        ...
        defaultMessage: 'Billing request failed.',
        defaultTitle: 'Billing request failed'
      }
    },
    plugins: {
    ...
    model: {
      ...
      setupProviderGeneric: 'Set up provider',
    ...
    memoryProvider: {
      ...
      loadFailedDetail: message => `Memory provider settings failed to load: ${message}`,
      ...
      saveFieldFailed: field => `Failed to save ${field}`,
      ...
      fieldAbout: field => `About ${field}`,
      fullConfig: 'Full config…',
      fullConfigurationTitle: provider => `${provider} — full configuration`,
      fullConfigurationDescription: (provider, profile) =>
        `Every ${provider} option for the ${profile} profile. Blank fields fall back to the resolved host or built-in default.`,
      configReference: provider => `${provider} configuration reference`,
      otherGroup: 'Other',
