...
export const en: Translations = {
  ...
  skills: {
    ...
    filesLoadFailed: 'Skill files failed to load.',
    binary: 'binary',
    binaryUnsupported: path => `${path} is binary and cannot be opened in the text editor.`,
    discardUnsaved: 'Discard unsaved changes and switch files?',
    deleteFile: path => `Delete ${path}`,
    deleteFileConfirm: path => `Delete ${path} from this skill? This cannot be undone.`,
    fileDeleted: 'Skill file deleted',
    edit: 'Edit',
    archive: 'Archive',
