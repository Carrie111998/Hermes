...
export const en: Translations = {
  ...
  settings: {
    ...
    moa: {
      title: 'MoA Studio',
      description:
        'Build named Mixture of Agents presets, tune every advisory seat, and switch the active chat without leaving settings.',
      preset: 'Preset',
      ...
      deleteConfirm: name => `Remove the “${name}” MoA preset from this draft? Click Save changes to apply.`,
      setDefault: 'Set default',
      defaultBadge: 'Default',
      activeBadge: 'Active',
      useInThisChat: 'Use in this chat',
      presetEnabled: 'Preset enabled',
      enabledDescription: 'Disabled presets remain configured but are unavailable for MoA execution.',
      referencesTitle: 'Reference seats',
      reference: index => `Reference ${index}`,
      referenceProvider: index => `Reference ${index} provider`,
      referenceModel: index => `Reference ${index} model`,
      referenceEffort: index => `Reference ${index} effort`,
      referenceEnabled: (n: number) => `Enable reference ${n}`,
      aggregator: 'Aggregator',
      aggregatorProvider: 'Aggregator provider',
      aggregatorModel: 'Aggregator model',
      aggregatorEffort: 'Aggregator effort',
      providerDefault: 'Provider default',
      addReference: 'Add reference',
      removeReference: index => `Remove Reference ${index}`,
      moveReferenceUp: index => `Move Reference ${index} up`,
      moveReferenceDown: index => `Move Reference ${index} down`,
      moveUp: 'Move up',
      moveDown: 'Move down',
      remove: 'Remove',
      executionTitle: 'Execution & output',
      cadence: 'Advisor cadence',
      cadenceDescription: 'Choose whether advisors run once per user turn, after every tool iteration, or every N tool iterations.',
      oncePerUserTurn: 'Once per user turn',
      everyNIterations: 'Every N tool iterations',
      everyNCount: 'N (iterations)',
      everyToolIteration: 'After every tool iteration',
      advisorOutputCap: 'Advisor output cap',
      advisorOutputCapDescription: 'Maximum tokens returned by each reference seat.',
      uncappedAdvisorOutput: 'Uncapped advisor output',
      aggregatorOutputLimit: 'Aggregator output limit',
      aggregatorOutputLimitDescription: 'Maximum tokens returned by the acting aggregator.',
      advisorTemperature: 'Advisor temperature',
      advisorTemperatureDescription: 'Leave blank to use each reference provider default.',
      aggregatorTemperature: 'Aggregator temperature',
      aggregatorTemperatureDescription: 'Leave blank to use the aggregator provider default.',
      saveChanges: 'Save changes',
      unsaved: 'Unsaved changes — click Save changes when this setup is complete.',
      saving: 'Saving…',
      saved: 'Saved',
      saveFailedRetained: 'Save failed — changes remain unsaved.',
      incomplete: 'Finish the incomplete provider, model, or numeric value before saving.',
      nameBlank: 'Enter a preset name.',
      nameDuplicate: 'A preset with this name already exists.',
      unavailable: 'MoA presets are unavailable from this backend.'
    },
    providers: {
  ...
  shell: {
    ...
    modelMenu: {
      ...
      manageMoaPresets: 'Manage MoA presets…',
      fast: 'Fast'
    },
    modelOptions: {
