...
export const en: Translations = {
  ...
  notifications: {
    ...
    releaseReadyTitle: 'New Hermes release',
    releaseReadyMessage: tag => `${tag || 'A new official release'} is ready to install.`,
  ...
  settings: {
    ...
    about: {
      ...
      releaseUpdateReady: tag => `${tag || 'A new Hermes release'} is ready to install.`,
      ...
      fastTrackDesc: 'Get every change from main as soon as it lands. Intended for advanced users who accept more frequent updates.',
      releaseTrackHint: version => `Release track · ${version}`,
  ...
  updates: {
    ...
    releaseReadyTitle: 'New Hermes release',
    releaseReadyBody: tag => `${tag || 'The latest official release'} is ready, with release notes below.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      releasesBehind: count => `${count} release${count === 1 ? '' : 's'} behind`,
