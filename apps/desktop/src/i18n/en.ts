...
export const en: Translations = {
  ...
  composer: {
    ...
    annotateImage: label => `Annotate ${label}`,
    annotateTitle: 'Annotate image',
    annotateDesc: label => `Draw over ${label} — the markup is composited into the image and a legend is added to your message before send.`,
