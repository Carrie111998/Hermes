...
export const en: Translations = {
  ...
  sidebar: {
    ...
    row: {
      ...
      cleanupAllowedDesc: (branch, path) =>
        `Remove the exact worktree for ${branch} at ${path}? The conversation and branch remain available for audit.`,
      ...
      cleanupReasons: {
        active: 'A session is still active in this worktree.',
