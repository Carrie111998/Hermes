...
export const en: Translations = {
  ...
  settings: {
    ...
    model: {
      ...
      routingDesc: 'See the provider and model that handle each Hermes lane. Automatic lanes resolve to main.',
      routingLaneCount: count => `${count} lanes`,
      mainLane: 'Main chat',
      mainLaneHint: 'Conversation turns',
      primary: 'Primary',
      usesMain: 'Uses main',
      dedicated: 'Dedicated',
      ...
      tasks: {
        ...
        triage_specifier: { label: 'Triage specifier', hint: 'Kanban spec detail' },
        kanban_decomposer: { label: 'Kanban decomposer', hint: 'Task decomposition' },
        profile_describer: { label: 'Profile describer', hint: 'Profile summaries' },
