...
export const en: Translations = {
  ...
  settings: {
    ...
    appearance: {
      ...
      contentWidthDesc: 'Centered max-width for the chat thread + composer and for Settings / overlay pages. Narrow (48rem) keeps text centered and readable; Wide restores the full-bleed layout (chat 100%, overlays 75rem).',
      contentWidthNarrow: 'Narrow',
      contentWidthComfortable: 'Centered',
