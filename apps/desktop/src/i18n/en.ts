...
export const en: Translations = {
  ...
  settings: {
    ...
    model: {
      ...
      openrouterModelShapeHint: 'Use an OpenRouter model ID in author/slug form; an optional :suffix is allowed.',
      applying: 'Applying...',
