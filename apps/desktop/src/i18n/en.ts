...
export const en: Translations = {
  ...
  boot: {
    ready: 'Douglas Agent is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Douglas Agent settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Douglas Agent…'
    },
    errors: {
      backgroundExited: 'Douglas Agent background process exited.',
      backgroundExitedDuringStartup: 'Douglas Agent background process exited during startup.',
    ...
    failure: {
      title: "Douglas Agent couldn't start",
      description:
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Douglas Agent backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update Douglas Agent',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Douglas Agent.',
    ...
    native: {
      ...
      inputBody: 'Douglas Agent is waiting for your response.',
      turnDoneTitle: 'Douglas Agent finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Douglas Agent defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Douglas Agent is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Douglas Agent asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Douglas Agent was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Douglas Agent follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Douglas Agent can react to yours.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Douglas Agent is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Douglas Agent, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Douglas Agent checks for updates automatically in the background and lets you know when one is ready.',
      branchCommit: (branch, commit) => `Branch ${branch} · Commit ${commit}`,
      attribution: 'Douglas Agent is built on Hermes Agent by Nous Research, used under the MIT License.',
      attributionLink: 'View Hermes Agent on GitHub',
      never: 'never',
      justNow: 'just now',
    ...
    config: {
      ...
      loading: 'Loading Douglas Agent configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Douglas Agent.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Douglas Agent backend elsewhere. Per-profile overrides below.',
      ...
      envOverrideDesc:
        'Unset DOUGLAS_DESKTOP_REMOTE_URL (or HERMES_DESKTOP_REMOTE_URL) and the matching _TOKEN var to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Douglas Agent backend on localhost. This is the default and works offline.',
      inheritTitle: 'Use default gateway',
      inheritDesc: "Remove this profile's override and use the default connection.",
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Douglas Agent backend.',
      ...
      restartingMessage: 'Douglas Agent will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Douglas Agent ${version}` : ''}`,
      ...
      sshDesc:
        'Douglas Agent is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshHermesPathTitle: 'Douglas Agent path (optional)',
      sshHermesPathDesc: 'Full path to the remote Douglas Agent binary. Blank = auto-detect.',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Douglas Agent found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Douglas Agent runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Douglas Agent is not installed on the remote host. Install it there (curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh) or set the Douglas Agent path.',
      sshErrPlatform:
        'Unsupported remote platform. Douglas Agent SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Douglas Agent on the remote host before connecting with Desktop SSH.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Douglas Agent runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Douglas Agent at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via douglas curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Douglas Agent builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Douglas Agent to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Douglas Agent to generate pets.',
      backgroundHint: 'You can close this — Douglas Agent will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Douglas Agent desktop' },
    ...
    hermesActiveSessions: (version, count) => `Douglas Agent ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@douglas:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Douglas Agent environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    scheduleHints: {
      ...
      'every-15-minutes': 'Every 15 minutes',
      custom: 'BPA syntax or natural language'
    },
    days: {
      '0': 'Sunday',
      '1': 'Monday',
    ...
    newCron: 'New BPA',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Douglas Agent will run it and deliver results to the destination you pick.',
    ...
    customHint: 'BPA expression, or phrases like "every hour" or "weekdays at 9am".',
    optional: 'Optional',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Douglas Agent backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Douglas Agent. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Douglas Agent...',
    placeholderReconnecting: 'Reconnecting to Douglas Agent…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give Douglas Agent a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'Douglas Agent will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Douglas Agent to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Douglas Agent…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Douglas Agent…',
    ...
    unsupportedMessage: 'This version of Douglas Agent can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of Douglas Agent is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Douglas Agent backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed Douglas Agent from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Douglas Agent will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Douglas Agent desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Douglas Agent updater takes over in its own window and reopens Douglas Agent automatically when it’s done. Please don’t reopen Douglas Agent yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Douglas Agent reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Douglas Agent reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Douglas Agent needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Douglas Agent',
    setupChoiceDesc:
      'Connect this app to a Douglas Agent gateway you already run, or install Douglas Agent locally on this computer.',
    connectExistingTitle: 'Connect to existing Douglas Agent',
    ...
    installLocalTitle: 'Install Douglas Agent locally',
    installLocalDesc: 'Download Douglas Agent, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Douglas Agent and try again.',
    remoteSetupTitle: 'Connect to existing Douglas Agent',
    remoteSetupDesc: 'Enter your gateway URL. Douglas Agent will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Douglas Agent gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/hermes',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Douglas Agent gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Douglas Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Douglas Agent CLI or desktop instance is running. Stop any running Douglas Agent instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Douglas Agent installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Douglas Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Douglas Agent is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Douglas Agent…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Douglas Agent',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Douglas Agent at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Douglas Agent connects automatically',
    ...
    authorizeThere: 'Authorize Douglas Agent there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Douglas Agent there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      cron: 'BPA (Business Process Automation)',
      openCron: 'Open BPA jobs',
      webhooks: 'Webhooks',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Douglas Agent will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Douglas Agent is restarting...',
      askRestart: 'Ask Douglas Agent to restart the server',
      lookingRestart: taskId => `Douglas Agent is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Douglas Agent is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Douglas Agent finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Douglas Agent could not restart the server.',
      stillWorking:
        'Douglas Agent is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Douglas Agent is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Douglas Agent gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.douglas/config.yaml). Douglas Agent won’t ask again for commands like this — in this session or any future one.`,
    ...
    tool: {
      ...
      titles: {
        ...
        cronjob: { done: 'BPA job', pending: 'Scheduling BPA job', pendingAction: 'Scheduling' },
  ...
  prompts: {
    ...
    sudoDesc: 'Douglas Agent needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Douglas Agent needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Douglas Agent to use Save Image.',
    restartToSaveImages: 'Restart Douglas Agent to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `douglas gateway` running?'
    }
  },
