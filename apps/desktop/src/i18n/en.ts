...
export const en: Translations = {
  ...
  settings: {
    ...
    appearance: {
      ...
      projectPreviewTitle: 'Sessions Shown per Project',
      projectPreviewDesc: 'How many recent sessions each project shows in the sidebar before the rest.',
      projectPreviewAll: 'All',
