...
export const en: Translations = {
  ...
  agents: {
    ...
    localBoardSubtitle: 'Local profiles, cron jobs, and live delegated work.',
    liveSubagentsTitle: 'Live subagents',
    localAgentsTitle: 'Local agents',
    localAgentsDesc: 'Auto-discovered Hermes profiles',
    loadingLocalAgents: 'Loading local agents',
    defaultBadge: 'default',
    modelInheritsDefault: 'model inherits default',
    skillsAndPath: (count, path) => `${count} ${count === 1 ? 'skill' : 'skills'} · ${path}`,
    noLocalProfiles: 'No local profiles found.',
    selectAgent: 'Select a local agent to inspect its detected jobs.',
    agentDetail: 'Agent detail',
    loadingAgentJobs: 'Loading agent jobs',
    statModel: 'Model',
    statSkills: 'Skills',
    statJobs: 'Jobs',
