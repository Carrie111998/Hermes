...
export const en: Translations = {
  ...
  boot: {
    ready: 'Orion Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Orion settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Orion backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingOrionDesktop: 'Starting Orion Desktop…'
    },
    errors: {
      backgroundExited: 'Orion background process exited.',
      backgroundExitedDuringStartup: 'Orion background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Orion backend is older than this desktop build and may not work correctly. Update to align them.',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Orion Desktop.',
    ...
    native: {
      ...
      inputBody: 'Orion is waiting for your response.',
      turnDoneTitle: 'Orion finished',
      turnDoneBody: '',
  ...
  sendDiagnostics: {
    ...
    failedHint:
      'You can also run `orion debug share --nous` from a terminal, or `orion debug share --local` to print the report without uploading.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Orion defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the Orion backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the Orion backend to manage this plugin from Desktop.',
      ...
      installModal: {
        ...
        agentTargetLocal: profile => `Installs into the ${profile} backend (~/.orion/plugins/)`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Orion is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Orion asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Orion was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Orion was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Orion follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Orion can react to yours.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Orion is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Orion, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      bundleOutOfSyncDesc:
        'The Orion runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      ...
      automaticUpdatesDesc:
        'Orion checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Orion configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Orion.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Orion gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Orion Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Orion Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Orion runtime managed by this app.',
      kindRemoteDesc: 'A Orion gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Orion Cloud account.',
      kindSshDesc: 'A Orion install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Orion manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under Orion Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Orion backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'Environment variables are controlling this desktop session.',
      envOverrideDesc:
        'Unset ORION_DESKTOP_REMOTE_URL and ORION_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Orion backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Orion backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Orion Cloud',
      cloudDesc: 'Sign in once to Orion Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Orion Cloud',
      cloudSignIn: 'Sign in to Orion Cloud',
      cloudSignedIn: 'Signed in to Orion Cloud',
      cloudNeedsSignIn: 'Sign in to Orion Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Orion Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Orion Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Orion Cloud',
      cloudSignedOutMessage: 'Cleared the Orion Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /orion.',
      ...
      restartingMessage: 'Orion Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Orion ${version}` : ''}`,
      ...
      sshDesc:
        'Orion is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshOrionPathTitle: 'Orion path (optional)',
      sshOrionPathDesc: 'Full path to the remote orion binary. Blank = auto-detect.',
      sshOrionPathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Orion found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Orion runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Orion is not installed on the remote host. Install it there (curl -fsSL https://your-orion-docs.example/install.sh | sh) or set the Orion path.',
      sshErrPlatform:
        'Unsupported remote platform. Orion Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Orion on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Orion. Review the exact configuration below — it comes from the link, not from Orion.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Orion runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Orion at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via orion curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Orion builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Orion to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Orion to generate pets.',
      backgroundHint: 'You can close this — Orion will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Orion desktop' },
    ...
    orionActiveSessions: (version, count) => `Orion ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@orion:example.org' },
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote Orion you point it at, instead of this computer.',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Orion environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Orion did not save that model change.'
    },
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Orion will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Orion backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Orion. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Orion backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Orion...',
    placeholderReconnecting: 'Reconnecting to Orion…',
    ...
    attachUrlDesc: 'Orion will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Orion to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Orion…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Orion…',
    ...
    unsupportedMessage: 'This version of Orion can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of Orion is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Orion backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed Orion from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Orion will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Orion desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Orion updater takes over in its own window and reopens Orion automatically when it’s done. Please don’t reopen Orion yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Orion reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Orion reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Orion?',
    blockerBody:
      'Orion needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Orion',
    foreignBlockerBody:
      'Orion can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Orion can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'Orion needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Orion Desktop',
    setupChoiceDesc:
      'Connect this app to a Orion gateway you already run, or install Orion locally on this computer.',
    connectExistingTitle: 'Connect to existing Orion',
    ...
    installLocalTitle: 'Install Orion locally',
    installLocalDesc: 'Download Orion, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Orion Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Orion',
    remoteSetupDesc: 'Enter your gateway URL. Orion Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Orion gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/orion',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Orion gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Orion Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Orion CLI or desktop instance is running. Stop any running Orion instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Orion installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Orion Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Orion is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Orion…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Orion',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Orion at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Orion connects automatically',
    ...
    authorizeThere: 'Authorize Orion there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Orion there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Orion will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Orion is restarting...',
      askRestart: 'Ask Orion to restart the server',
      lookingRestart: taskId => `Orion is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Orion is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Orion to open a page.',
      finishedRestarting: message => `Orion finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Orion could not restart the server.',
      stillWorking:
        'Orion is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Orion is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Orion gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.orion/config.yaml). Orion won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Orion needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Orion needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Orion Desktop to use Save Image.',
    restartToSaveImages: 'Restart Orion Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `orion gateway` running?'
    }
  },
