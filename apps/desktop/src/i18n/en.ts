...
export const en: Translations = {
  ...
  settings: {
    ...
    model: {
      ...
      delegateTitle: 'Subagent model',
      delegateReset: 'Inherit parent',
      delegateDesc: 'Choose the model used by delegated tasks. Inherit parent follows the current chat model.',
      delegateInheritsParent: 'Inherit parent model',
