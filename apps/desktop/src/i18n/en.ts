...
export const en: Translations = {
  ...
  learningInbox: {
    ...
    subtitle: 'Review proposed memories, skills, and automations before they become part of Hermes.',
    loading: 'Loading learning candidates…',
    refresh: 'Refresh inbox',
    emptyTitle: 'Nothing waiting for review',
    emptyDesc: 'Turn on memory and skill approval to review future learning here.',
    approvalOff: 'Approval is off',
    approvalHint: 'Future memory and skill writes are currently saved immediately.',
    enableApprovals: 'Enable approvals',
    approvalsEnabled: 'Approval gates enabled',
    memory: 'Memory',
    skill: 'Skill',
    ...
    source: 'Source',
    origin: 'Origin',
    noSessionEvidence: 'No session reference was recorded for this candidate.',
    loadFailed: 'Could not load learning inbox',
    actionFailed: 'Learning action failed',
    approved: 'Learning candidate approved',
    dismissed: 'Learning candidate dismissed',
    openGraph: 'Open memory graph',
    openSkills: 'Open skills',
    candidateCount: count => `${count} candidate${count === 1 ? '' : 's'} waiting`
  },
