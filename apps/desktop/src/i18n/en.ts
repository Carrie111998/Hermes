...
export const en: Translations = {
  ...
  skills: {
    ...
    channels: {
      search: 'Search channels, abilities, or tools...',
      loadFailed: 'Channel abilities failed to load.',
      description: 'Choose the exact toolsets and MCP servers available to new agent sessions from this channel.',
      customBoundary: 'Custom boundary',
      inheritedDefaults: 'Inherited defaults',
      toolsets: 'Agent abilities',
      toggleToolset: label => `Toggle ${label} for this channel`,
      highImpact: 'High impact',
      required: 'Required channel abilities',
      mcpAccess: 'MCP access',
      mcpAll: 'All enabled',
      mcpNone: 'None',
      mcpSelected: 'Selected only',
      noMcp: 'No enabled MCP servers are available.',
      save: 'Save abilities',
      savedTitle: 'Channel abilities saved',
      savedMessage: channel => `${channel} will use this boundary for new sessions.`,
      saveFailed: channel => `Failed to save abilities for ${channel}`
    },
    hub: {
