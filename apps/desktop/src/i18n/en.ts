...
export const en: Translations = {
  ...
  rightSidebar: {
    ...
    collapseBackgroundWork: 'Collapse background work',
    expandBackgroundWork: 'Expand background work',
    runningWork: 'Running',
    finishedWork: 'Finished',
    noBackgroundWork: 'No background work',
    workRunning: 'Running',
    workCompleted: 'Completed',
    workFailed: 'Failed',
    openBackgroundSession: title => `Open ${title}`,
    files: 'File system',
    terminal: 'Terminal',
