...
export const en: Translations = {
  ...
  statusStack: {
    ...
    coding: {
      ...
      createBranchDesc: 'Create a new branch from the current HEAD.',
      renameBranch: 'Rename branch',
      renameBranchDesc: (name: string) => `Rename ${name}.`,
      deleteBranch: 'Delete branch',
      deleteBranchConfirm: (name: string) => `Delete branch ${name}? This cannot be undone.`,
      createTag: 'New tag',
      createTagDesc: 'Create a new tag at the current HEAD.',
      deleteTag: 'Delete tag',
      deleteTagConfirm: (name: string) => `Delete tag ${name}? This cannot be undone.`,
      stashChanges: 'Stash changes',
      stashChangesDesc: 'Stash all uncommitted changes.',
      stashMessage: 'Message',
      stashMessagePlaceholder: 'Optional stash message',
      applyStash: 'Apply stash',
      dropStash: 'Drop stash',
      dropStashConfirm: (id: string) => `Drop ${id}? This cannot be undone.`,
