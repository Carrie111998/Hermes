...
export const en: Translations = {
  ...
  settings: {
    ...
    appearance: {
      ...
      backdropDesc: 'The faint built-in statue shown when no custom wallpaper is displayed.',
      introSplashTitle: 'Intro Splash',
      introSplashDesc: 'The wordmark and prompt shown on an empty chat.',
      wallpaper: {
        title: 'Custom Wallpaper',
        description: 'Stored on this device per profile. Images are optimized once when imported.',
        choose: 'Choose image',
        replace: 'Replace',
        remove: 'Remove',
        reset: 'Reset adjustments',
        error: 'Could not load that image. Verify it is a valid JPEG, PNG, or WebP file no larger than 32 MB.',
        unsupported: 'Restart Hermes once to enable the wallpaper picker.',
        profileNote: profile => `Saved locally for the ${profile} profile.`,
        preview: 'Preview',
        previewEffect: 'Chat effect',
        previewFull: 'Full image',
        visibility: 'Display',
        displayMode: 'Display mode',
        adaptiveTheme: 'Wallpaper palette',
        adaptiveThemeDesc: 'Tint accents and surfaces from the image while preserving text contrast.',
        adaptiveThemeAnalyzing: 'Analyzing image colors…',
        adaptiveThemeError: 'Could not extract colors from this image.',
        paletteMode: 'Palette source',
        paletteModes: { auto: 'Auto', manual: 'Manual' },
        paletteManualDesc: 'Accent is applied exactly. Tint is blended gently into surfaces to preserve readability.',
        paletteDominant: 'Tint',
        paletteAccent: 'Accent',
        modes: { fill: 'Fill', fit: 'Fit', tile: 'Tile', center: 'Center' },
        opacity: 'Image strength',
        blur: 'Blur',
        overlay: 'Readability mask',
        overlayShape: 'Mask shape',
