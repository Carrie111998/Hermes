  ...
  settings: {
    ...
    appearance: {
      ...
      pet: {
        ...
        bubbleTitle: 'Speech bubble',
        bubbleDesc: 'Show a speech bubble with the pet\'s current activity status.',
        controlsTitle: 'Pet controls',
        controlsDesc: 'Show hover controls to hide or pop out the pet.',
