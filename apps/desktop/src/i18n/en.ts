...
export const en: Translations = {
  ...
  profiles: {
    ...
    avatarUploadBatch: 'Upload avatars',
    avatarUploadBatchProgress: (done, total) => `Uploading ${done}/${total}…`,
    avatarClickToEnlarge: 'Click to enlarge',
    avatarClosePreview: 'Close',
    avatarInvalidType: 'Use a PNG, JPG, WEBP, or GIF image.',
