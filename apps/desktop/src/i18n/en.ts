...
export const en: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      restartCurrent: 'Restart current backend',
      restartCurrentTitle: 'Restart current backend',
      restartCurrentDesc: 'Restart the Desktop-owned local or SSH backend. Active turns may be interrupted.',
      restartingCurrent: 'Restarting backend…',
      restartCurrentSuccess: 'Backend restarted. Desktop reconnected.',
      restartCurrentCancelled: 'Restart cancelled. Backend kept running.',
      restartCurrentRemote: 'Remote backend is not owned by Desktop. Reconnect only.',
      restartCurrentOwnershipFailed:
        'Restart stopped: Desktop could not prove backend ownership. No process was terminated.',
      restartCurrentFailed: 'Backend restart failed. Connection remains recoverable.',
