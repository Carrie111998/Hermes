...
export const en: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      linkedDevicesLoading: 'Loading linked devices…',
      linkedDevicesError: 'Could not load linked devices.',
      linkedDevicesEmpty: 'No linked devices',
      linkedDevicesEmptyDesc: 'Link a phone from a chat session to see it here.',
      linkedDevicesDates: (linked, used) => `Linked ${linked} · Last used ${used}`,
      linkedDevicesRevoke: 'Revoke',
      linkedDevicesRevoking: 'Revoking…',
      linkedDevicesRevoked: 'Linked device revoked.',
      linkedDevicesRevokeFailed: 'Could not revoke linked device.'
    },
    keys: {
  ...
  sidebar: {
    ...
    row: {
      ...
      continueOnPhoneAvailabilityHint: 'Keep Hermes Desktop open and your computer awake.',
      continueOnPhoneExpiredTitle: 'This code has expired',
      continueOnPhoneExpiredDesc: 'Create a new one when you are ready to scan it.',
      continueOnPhoneNewCode: 'Create new code',
      continueOnPhoneNotConfiguredTitle: 'Remote access is not configured',
      continueOnPhoneNotConfiguredDesc: 'Set an HTTPS dashboard public URL with browser sign-in, then try again.',
      continueOnPhoneInsecureUrlTitle: 'Remote access URL is not secure',
      continueOnPhoneInsecureUrlDesc: 'Use an HTTPS dashboard public URL without embedded credentials.',
