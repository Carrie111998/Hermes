...
export const en: Translations = {
  ...
  settings: {
    ...
    nav: {
      ...
      providersManager: 'Provider Manager',
      plugins: 'Plugins'
    },
    plugins: {
  ...
  providerManager: {
    ...
    description: 'Enable providers, add custom endpoints, and manage which models appear in the picker.',
    filters: 'Filters',
    providerListHeading: 'Providers',
    modelsHeading: 'Models',
    searchPlaceholder: 'Search models',
    noProviders: 'No providers with models available.',
    noModels: 'No models found.',
    activeCount: (n: number) => `${n} active`,
    allHidden: 'All models hidden — none will appear in the picker.',
    addProvider: 'Add provider…',
    ...
    apiKey: 'API key',
    apiKeyPlaceholder: 'Optional — leave blank to keep the saved key',
    editProviderCredentials: 'Edit credentials',
    baseUrlOverride: 'Base URL override',
    baseUrlOverridePlaceholder: 'Leave empty to use the default endpoint',
    apiKeyDescription: 'Stored in your profile’s .env file',
    configureProvider: 'Configure provider',
    configureDescription: 'Enter your API key to enable this provider and discover its models.',
    saveAndDiscover: 'Save & discover models',
    apiKeyRequired: 'API key is required.',
    configuring: 'Saving…',
    apiMode: 'API mode',
    apiModeChat: 'Chat completions (OpenAI-compatible)',
    apiModeAnthropic: 'Anthropic messages',
    models: 'Models',
    modelsPlaceholder: 'One model id per line, e.g.\ngpt-4o\nclaude-sonnet-4',
    confirmDelete: 'Delete this provider? This cannot be undone.',
    nameExists: 'A provider with this name already exists.',
    invalidUrl: 'Base URL must be a valid http(s) URL.',
    ...
    discoveryEmpty: 'No new models found',
    listRefreshed: 'Model list refreshed',
    discoverySuccess: (n: number) => `${n} model${n === 1 ? '' : 's'} added`,
    manualModelTitle: 'Add model',
    manualModelDescription: 'Register a single model exposed by this provider.',
    modelId: 'Model ID',
    modelIdPlaceholder: 'e.g. gpt-4o',
    modelName: 'Display name',
    modelNamePlaceholder: 'Optional name shown in the app',
    advancedParameters: 'Advanced parameters',
    advancedParametersEmpty: 'No advanced parameters yet.',
    modelIdRequired: 'Model ID is required',
    modelExists: 'A model with this ID already exists',
    groupLocal: 'Local',
    ...
    sortAz: 'A → Z',
    sortZa: 'Z → A',
    groupByLetter: 'Group by letter',
    activeOnly: 'Active only',
    activateAll: 'Activate all',
    deactivateAll: 'Deactivate all',
    testConnection: 'Test connection',
    testOk: (ms: number) => `Connected in ${ms} ms`,
    testFailed: 'Connection failed',
    unavailable: 'Unavailable',
