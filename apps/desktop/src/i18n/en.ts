...
export const en: Translations = {
  ...
  assistant: {
    thread: {
      ...
      errorRetryLater: 'Retry in…',
      errorRetryLaterMenu: 'Retry later',
      errorRetryIn1h: 'In 1 hour',
      errorRetryIn3h: 'In 3 hours',
      errorRetryIn6h: 'In 6 hours',
      errorRetryAt: 'Retry at',
      errorRetryAtInvalid: 'Enter a time like 14:30',
      errorRetryScheduled: when => `Auto-retry at ${when}`,
      errorRetryCancelScheduled: 'Cancel auto-retry',
