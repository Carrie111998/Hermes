...
export const en: Translations = {
  ...
  settings: {
    ...
    config: {
      ...
      memoryProvidersEmpty: 'Built-in memory only. Add a provider to layer an external store on top.',
      memoryProvidersPlaceholder: 'Select provider',
      memoryProvidersAdd: 'Add provider',
      memoryProviderNotInstalled: 'Not currently installed',
      notSet: 'Not set',
