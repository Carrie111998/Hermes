...
export const en: Translations = {
  ...
  statusStack: {
    ...
    coding: {
      ...
      verificationCheckingDetail: 'Checking recorded evidence',
      verificationNoEvidence: 'No verification recorded for this session',
      verificationUnavailableDetail: 'Verification evidence is unavailable',
      verificationChangesAfterCheck: 'Changes were made after this check',
      verificationPathsChanged: count => `${count} path${count === 1 ? '' : 's'} changed since this check`,
      verificationExit: code => `Exit ${code}`,
      verificationFull: 'Full',
      verificationTargeted: 'Targeted',
      verificationRun: 'Verify changes',
      verificationRunAgain: 'Verify again',
      verificationPrompt:
        "Run the appropriate verification checks for the current changes. Use the repository's canonical test, lint, typecheck and build commands where applicable. Report the exact commands and results. Do not make unrelated changes.",
