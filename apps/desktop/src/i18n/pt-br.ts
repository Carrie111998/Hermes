...
export const ptBr: Translations = {
  ...
  boot: {
    ...
    failure: {
      ...
      remoteFailureHint: 'Verifique a URL do gateway e o login em Configurações do gateway, ou troque para o gateway local.',
  ...
  settings: {
    ...
    appearance: {
      ...
      reactionsDesc: 'Reações com emoji no estilo iMessage — reaja às mensagens, e o Hermes também pode reagir às suas.',
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      tts: {
        xai: {
          ...
          sampleRate: 'Taxa de amostragem do áudio em Hz. Valores maiores oferecem melhor qualidade e arquivos maiores.',
    ...
    gateway: {
      ...
      cloudDesc: 'Entre uma vez no Hermes Cloud e escolha entre os agentes da sua conta — sem precisar colar nenhuma URL.',
      ...
      probeError: 'Ainda não foi possível acessar este gateway. Verifique a URL — o método de autenticação aparece assim que ele responder.',
      signedIn: 'Conectado',
      signIn: 'Entrar',
      signOut: 'sair',
      ...
      diagnosticsDesc: 'Mostra o desktop.log no seu gerenciador de arquivos — útil quando o gateway não consegue iniciar.',
      openLogs: 'Abrir logs',
      ...
      sshTrustHint: 'A primeira chave de host apresentada é confiada e fixada; mudanças posteriores falham por segurança.',
      sshHostTitle: 'Host',
    ...
    model: {
      ...
      appliesDesc: 'Vale para novas sessões. Use o seletor de modelos no compositor para trocar o modelo da conversa ativa na hora.',
      provider: 'Provedor',
      model: 'Modelo',
      applying: 'Aplicaring...',
      ...
      auxiliaryDesc: 'Por padrão, as tarefas de apoio rodam no modelo principal. Atribua um modelo dedicado a qualquer tarefa para sobrescrever.',
    ...
    providers: {
      ...
      localEndpoint: {
        ...
        description: 'Aponte o Hermes para qualquer endpoint compatível com a OpenAI (Zyphra, vLLM, llama.cpp, Ollama etc).'
      },
    ...
    sessions: {
      ...
      defaultDirUpdated: 'Pasta padrão de projetos atualizada — inicie uma nova conversa (Ctrl/⌘+N) para que passe a valer',
    ...
    toolsets: {
      ...
      noProviderOptions: 'Este conjunto de ferramentas não tem opções de provedor — ative-o e ele funciona com a configuração atual.',
      ...
      terminalBackend: {
        ...
        needsSetupHint: 'Você pode selecionar este backend agora — os comandos vão falhar até a configuração ser concluída.'
      }
    }
  },
  ...
  skills: {
    ...
    toggleToolset: (label, enabled) => `Alternar o conjunto de ferramentas ${label} ${enabled ? 'ligado' : 'desligado'}`,
  ...
  messaging: {
    ...
    pairingLockedOut: 'Muitas aprovações falharam — esta plataforma foi bloqueada temporariamente. Tente novamente mais tarde.',
  ...
  updates: {
    ...
    availableBodyNoChangelog: 'Uma versão mais nova está pronta. As notas da versão não estão disponíveis para este tipo de instalação.',
    updateNow: 'Atualizar agora',
  ...
  install: {
    ...
    connectExistingDesc: 'Usa um backend remoto com token de sessão ou login pelo navegador. Nenhuma instalação local será iniciada.',
    ...
    remoteSetupDesc: 'Informe a URL do seu gateway. O Hermes Desktop detecta se ele precisa de token ou de login pelo navegador.',
  ...
  onboarding: {
    ...
    preparingInstall: 'O Hermes está terminando a instalação. Isso normalmente leva menos de um minuto na primeira vez.',
    ...
    apiKeyOptions: {
      ...
      openrouter: {
        ...
        description: 'Hospeda centenas de modelos atrás de uma única chave. Uma boa opção padrão para novas instalações.'
      },
      ...
      local: {
        ...
        description: 'Aponte o Hermes para um endpoint local ou auto-hospedado compatível com a OpenAI (vLLM, llama.cpp, Ollama etc).'
      }
    },
  ...
  assistant: {
    thread: {
      ...
      restoreBody:
        'Tudo depois deste prompt é removido da conversa, e o prompt roda de novo a partir daqui.',
    ...
    clarify: {
      ...
      lateAnswerHint: 'Este prompt não está mais aguardando. Escolha uma opção para rascunhá-la como mensagem de complemento.'
    },
    tool: {
  ...
  prompts: {
    ...
    sudoDesc: 'O Hermes precisa da sua senha do sudo para executar um comando privilegiado. Ela é enviada apenas ao seu agente local.',
  ...
  desktop: {
    ...
    skillCommandsAvailable: count => `${count} ${count === 1 ? 'comando de habilidade disponível' : 'comandos de habilidades disponíveis'}.`,
