...
export const ar = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      backdropDesc: 'صورة التمثال المدمجة الباهتة عند عدم عرض خلفية مخصصة.',
      introSplashTitle: 'شاشة المقدمة',
      introSplashDesc: 'الشعار النصي والعبارة التمهيدية في محادثة فارغة.',
      wallpaper: {
        title: 'خلفية مخصصة',
        description: 'تُحفظ على هذا الجهاز لكل ملف شخصي، وتُحسّن مرة واحدة عند الاستيراد.',
        choose: 'اختيار صورة',
        replace: 'استبدال',
        remove: 'إزالة',
        reset: 'إعادة ضبط التعديلات',
        error: 'تعذر تحميل الصورة. تأكد من أنها ملف JPEG أو PNG أو WebP صالح ولا يتجاوز 32 م.ب.',
        unsupported: 'أعد تشغيل Hermes مرة واحدة لتفعيل منتقي الخلفية.',
        profileNote: profile => `محفوظة محليًا للملف الشخصي ${profile}.`,
        preview: 'المعاينة',
        previewEffect: 'مظهر المحادثة',
        previewFull: 'الصورة كاملة',
        visibility: 'العرض',
        displayMode: 'نمط العرض',
        adaptiveTheme: 'ألوان متكيفة مع الخلفية',
        adaptiveThemeDesc: 'تستمد ألوان التمييز والأسطح من الصورة مع الحفاظ على تباين النص.',
        adaptiveThemeAnalyzing: 'جارٍ تحليل ألوان الصورة…',
        adaptiveThemeError: 'تعذر استخراج الألوان من هذه الصورة.',
        paletteMode: 'مصدر الألوان',
        paletteModes: { auto: 'تلقائي', manual: 'يدوي' },
        paletteManualDesc: 'يُطبّق لون التمييز كما هو، بينما يُمزج لون الصبغة برفق مع الأسطح للحفاظ على وضوح النص.',
        paletteDominant: 'صبغة',
        paletteAccent: 'تمييز',
        modes: { fill: 'ملء', fit: 'احتواء', tile: 'تكرار', center: 'توسيط' },
        opacity: 'قوة الصورة',
        blur: 'التمويه',
        overlay: 'قناع الوضوح',
        overlayShape: 'شكل القناع',
