...
export const ar = defineLocale({
  ...
  keybinds: {
    ...
    actions: {
      ...
      'view.findNext': 'المطابقة التالية',
      'view.findPrevious': 'المطابقة السابقة',
  ...
  settings: {
    ...
    config: {
      ...
      attachmentSizeTitle: 'الحد الأقصى لحجم تحميل المعاينة / الصورة',
      attachmentSizeDesc:
        'أقصى حجم لملف محلي تحمّله واجهة سطح المكتب للمعاينات وإرفاق الصور، بالميغابايت. الافتراضي 16. إرفاق الملفات غير الصور عن بُعد يخضع لسقف منفصل 256 ميغابايت. رفع هذه القيمة كثيرًا يحمّل الملف كاملًا في الذاكرة وقد يجمد التطبيق أو يوقفه.',
      attachmentSizeUnit: 'MB',
      attachmentSizeLabel: 'الحد الأقصى لحجم تحميل المعاينة / الصورة بالميغابايت'
    },
    quickEntry: {
    ...
    toolsets: {
      ...
      activeBackend: 'نشط',
      activeBackendHint: 'هذه هي واجهتك الخلفية النشطة',
      useBackend: 'استخدم هذه الواجهة الخلفية',
  ...
  messaging: {
    ...
    pendingAria: count =>
      count === 1 ? 'طلب اقتران واحد معلّق' : count === 2 ? 'طلبا اقتران معلّقان' : `${count} طلبات اقتران معلّقة`,
    approvedUsers: count => `المستخدمون الموافق عليهم (${count})`,
    approve: 'موافقة',
    ...
    revokeDesc: (name: string) => `${name} سيفقد الوصول ولن يُتعرّف عليه في رسالته التالية.`,
    approvedUser: name => `تمت الموافقة على ${name}`,
    approvedHint: 'يُتعرّف عليهم تلقائيًا في رسالتهم التالية.',
    revokedUser: name => `أُلغي وصول ${name}`,
    failedApprove: name => `فشلت الموافقة على ${name}`,
    failedRevoke: name => `فشل إلغاء وصول ${name}`,
    pairingLockedOut: 'محاولات موافقة فاشلة كثيرة — هذه المنصة مقفلة مؤقتًا. حاول لاحقًا.',
    waitingSince: minutes => (minutes < 1 ? 'الآن' : `منذ ${minutes} د`),
    fieldCopy: {
      TELEGRAM_BOT_TOKEN: {
  ...
  composer: {
    ...
    wakeWordListening: phrase => `كلمة الإيقاظ: "${phrase}" — يستمع`,
    wakeWordOff: phrase => `كلمة الإيقاظ: "${phrase}" — متوقف`,
    wakeWordPausedVoice: phrase => `كلمة الإيقاظ: "${phrase}" — متوقف مؤقتًا أثناء المحادثة الصوتية`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      toggleBackendVersion: 'إصدار الواجهة الخلفية',
