...
export const ar = defineLocale({
  ...
  sidebar: {
    ...
    projects: {
      ...
      menuBindProfiles: 'ربط الملفات الشخصية…',
      bindProfilesTitle: 'ربط الملفات الشخصية',
      bindProfilesDesc: name => `اختر الملفات الشخصية التي تتصدر الشريط أثناء نشاط ${name}.`,
      bindProfilesNone: 'لا توجد ملفات شخصية مسماة بعد.',
      menuDelete: 'حذف',
