...
export const ar = defineLocale({
  ...
  profiles: {
    ...
    archiveMenu: 'أرشفة الملف الشخصي',
    archivedBadge: 'مؤرشف',
    archiveTitle: 'أرشفة الملف الشخصي؟',
    archiveDesc: name => `إيقاف التوجيه إلى ${name} مع الاحتفاظ بكل بيانات الملف المحلية.`,
    archivePreserved: 'محفوظ في الأرشيف',
    archiveExcluded: 'بيانات التثبيت غير المضمنة',
    archiveManifestLoading: 'انتظر حتى يكتمل تحميل بيان الأرشيف.',
    archiving: 'جارٍ الأرشفة...',
    archived: 'تمت أرشفة الملف الشخصي',
    restoreMenu: 'استعادة الملف الشخصي',
    restored: 'تمت استعادة الملف الشخصي',
    purgeMenu: 'حذف نهائي',
    purgeTitle: 'حذف الملف المؤرشف نهائيًا؟',
    purgeDesc: name => `سيؤدي هذا إلى حذف بيانات ${name} المؤرشفة نهائيًا ولا يمكن التراجع عنه.`,
    purging: 'جارٍ الحذف النهائي...',
    purged: 'تم حذف الملف المؤرشف',
    ...
    failedRestore: 'فشلت استعادة الملف الشخصي'
  },
  cron: {
    close: 'إغلاق',
    modelImpact: {
