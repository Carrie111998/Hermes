...
export const ar = defineLocale({
  ...
  assistant: {
    thread: {
      ...
      errorRetryLater: 'إعادة المحاولة لاحقًا…',
      errorRetryLaterMenu: 'إعادة المحاولة لاحقًا',
      errorRetryIn1h: 'بعد ساعة',
      errorRetryIn3h: 'بعد 3 ساعات',
      errorRetryIn6h: 'بعد 6 ساعات',
      errorRetryAt: 'إعادة المحاولة في وقت محدد',
      errorRetryAtInvalid: 'أدخل وقتًا مثل 14:30',
      errorRetryScheduled: when => `إعادة محاولة تلقائية ${when}`,
      errorRetryCancelScheduled: 'إلغاء إعادة المحاولة التلقائية',
