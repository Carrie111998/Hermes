...
export const ar = defineLocale({
  ...
  composer: {
    ...
    annotateImage: label => `تعليق على ${label}`,
    annotateTitle: 'التعليق على الصورة',
    annotateDesc: label => `ارسم على ${label} — يُدمج الترميز في الصورة وتُضاف وسيلة إيضاح إلى رسالتك قبل الإرسال.`,
    annotateSave: 'تطبيق التعليق',
