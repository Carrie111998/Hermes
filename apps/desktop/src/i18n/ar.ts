...
export const ar = defineLocale({
  ...
  settings: {
    ...
    notifications: {
      ...
      inAppLabel: 'تنبيهات داخل التطبيق',
      inAppDesc: 'رسائل منبثقة داخل التطبيق (أخطاء وتحذيرات وتأكيدات). أوقفها لإبقاء منطقة المحادثة خالية — لا تتأثر إشعارات نظام التشغيل أعلاه.',
