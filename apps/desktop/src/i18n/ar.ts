...
export const ar = defineLocale({
  ...
  agents: {
    ...
    localBoardSubtitle: 'الملفات المحلية ومهام Cron والعمل المفوض المباشر.',
    liveSubagentsTitle: 'الوكلاء الفرعيون المباشرون',
    localAgentsTitle: 'الوكلاء المحليون',
    localAgentsDesc: 'ملفات Hermes المكتشفة تلقائيا',
    loadingLocalAgents: 'جار تحميل الوكلاء المحليين',
    defaultBadge: 'افتراضي',
    modelInheritsDefault: 'النموذج يرث الافتراضي',
    skillsAndPath: (count, path) => `${count} مهارة · ${path}`,
    noLocalProfiles: 'لم يتم العثور على ملفات محلية.',
    selectAgent: 'اختر وكيلا محليا لفحص مهامه المكتشفة.',
    agentDetail: 'تفاصيل الوكيل',
    loadingAgentJobs: 'جار تحميل مهام الوكيل',
    statModel: 'النموذج',
    statSkills: 'المهارات',
    statJobs: 'المهام',
    statSchedule: 'الجدولة',
    statNextRun: 'التشغيل التالي',
    statLastRun: 'آخر تشغيل',
    statDelivery: 'التسليم',
    statMode: 'الوضع',
    deliveryLocal: 'محلي',
    ...
    noCronJobsTitle: 'لم يتم اكتشاف مهام Cron',
    noCronJobsDesc: profile => `ستظهر المهام الجديدة التي ينشئها ${profile} هنا تلقائيا بعرض افتراضي.`,
