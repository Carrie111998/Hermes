...
export const ar = defineLocale({
  ...
  assistant: {
    ...
    fileCheckpoints: {
      menu: 'نقاط حفظ الملفات',
      title: 'نقاط حفظ الملفات',
      empty: 'لا توجد لقطات ملفات بعد. تظهر بعد أن يعدّل هرمس الملفات.',
      disabled: 'نقاط حفظ الملفات متوقفة. فعّلها لالتقاط مساحة العمل قبل التعديل.',
      enable: 'تفعيل نقاط حفظ الملفات',
      revert: 'إرجاع مساحة العمل',
      revertTitle: 'إرجاع مساحة العمل إلى هذه اللقطة؟',
      revertBody: 'تعود ملفات المشروع إلى هذه اللقطة. تبقى المحادثة كما هي.',
      revertConfirm: 'إرجاع الملفات',
      firstUseTitle: 'حفظ لقطة قبل كل تعديل على الملفات؟',
      firstUseBody:
        'يمكن لهرمس حفظ المشروع خارج git حتى تتراجع عن تغييرات أي دور بنقرة واحدة. لا تُعاد المحادثة للخلف.',
      firstUseConfirm: 'تفعيل اللقطات',
      firstUseSkip: 'ليس الآن',
      restoreFailed: 'تعذر إرجاع تلك الملفات',
      loadFailed: 'تعذر تحميل نقاط حفظ الملفات',
      enabledToast: 'نقاط حفظ الملفات مفعّلة للتعديلات الجديدة'
    },
    approval: {
