...
export const ar = defineLocale({
  ...
  sidebar: {
    ...
    row: {
      ...
      continueOnPhoneAvailabilityHint: 'أبقِ Hermes Desktop مفتوحا والكمبيوتر مستيقظا.',
      continueOnPhoneExpiredTitle: 'انتهت صلاحية هذا الرمز',
      continueOnPhoneExpiredDesc: 'أنشئ رمزا جديدا عندما تكون مستعدا لمسحه.',
      continueOnPhoneNewCode: 'إنشاء رمز جديد',
      continueOnPhoneNotConfiguredTitle: 'الوصول عن بُعد غير معد',
      continueOnPhoneNotConfiguredDesc: 'عيّن عنوان URL عام للوحة تحكم HTTPS مع تسجيل دخول في المتصفح، ثم حاول مجددا.',
