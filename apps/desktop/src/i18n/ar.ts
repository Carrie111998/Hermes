...
export const ar = defineLocale({
  ...
  composer: {
    ...
    rewritePrompt: 'إعادة صياغة الموجّه',
    rewritingPrompt: 'جارٍ إعادة صياغة الموجّه…',
    rewriteBasic: 'إعادة صياغة أساسية',
    rewriteBasicDesc: 'حسّن الوضوح والقواعد دون إضافة نطاق جديد.',
    rewriteBrief: 'توسيع موجز',
    rewriteBriefDesc: 'أضف فقط الأساسيات اللازمة لجعل المهمة قابلة للتنفيذ.',
    rewriteDetailed: 'توسيع مفصّل',
    rewriteDetailedDesc: 'أنشئ مواصفات جاهزة للتنفيذ تشمل الاختبارات ومعايير القبول.',
    rewriteEnhance: 'تحسين',
    rewriteEnhanceDesc: 'أضف اعتبارات هندسية مناسبة، باستخدام سياق المشروع المكتشف عند توفره.',
    rewriteFailed: 'تعذّرت إعادة صياغة الموجّه',
    rewriteDraftChanged: 'تغيّرت المسودة أثناء إعادة الصياغة، لذلك تُرك محتواها الحالي كما هو.',
    tipPre: 'نصيحة: اكتب ',
