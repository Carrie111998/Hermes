...
export const ar = defineLocale({
  ...
  preview: {
    ...
    web: {
      ...
      pick: 'تحديد عنصر الصفحة للدردشة',
      pickCancel: 'إلغاء تحديد العنصر',
      pickFailed: 'تعذر تحديد عنصر الصفحة',
      pickUnavailable: 'لا يمكن تشغيل منتقي العناصر في هذه المعاينة.',
