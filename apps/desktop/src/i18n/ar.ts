...
export const ar = defineLocale({
  ...
  skills: {
    collective: {
      ...
      localCandidates: count => `${count} من المهارات المحلية المرشحة`,
      ...
      proposalNotice:
        'تعرّف Hermes على مهارة قابلة لإعادة الاستخدام بعد هذه المهمة. تبقى أسباب التأهيل على هذا الجهاز؛ ولا تتم مشاركة أي شيء حتى تراجع الحزمة الدقيقة وتوافق عليها.',
      ...
      sendPrivateReview: 'إرسال لمراجعة خادم خاصة بالمالك',
