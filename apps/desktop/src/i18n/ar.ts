...
export const ar = defineLocale({
  ...
  keybinds: {
    ...
    actions: {
      ...
      'view.toggleRightSidebar': 'تبديل اللوحة اليمنى',
      'view.toggleReview': 'تبديل لوحة المراجعة',
      'view.showFiles': 'تبديل متصفح الملفات',
  ...
  rightSidebar: {
    ...
    choosePanel: 'فتح اللوحة اليمنى',
    addPanel: 'إضافة أداة إلى اللوحة اليمنى',
    showPanel: 'إظهار اللوحة اليمنى',
    hidePanel: 'إخفاء اللوحة اليمنى',
    files: 'الملفات',
    review: 'المراجعة',
    artifacts: 'العناصر',
    preview: 'المعاينة',
