...
export const ar = defineLocale({
  ...
  desktop: {
    ...
    modelConfirmTitle: 'تأكيد تبديل النموذج',
    modelConfirmBody: 'هذا النموذج له أسعار معروفة مرتفعة أو يتضمن شروط تدريب على البيانات.',
    modelConfirmAccept: 'التبديل على أي حال',
    modelConfirmCancel: 'إلغاء',
