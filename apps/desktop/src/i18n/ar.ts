...
export const ar = defineLocale({
  ...
  profiles: {
    ...
    avatarRemoved: 'تم إزالة الصورة الرمزية',
    avatarUploading: 'جار الرفع…',
    avatarUploadBatch: 'رفع الصور',
    avatarUploadBatchProgress: (done, total) => `جار الرفع ${done}/${total}…`,
    avatarClickToEnlarge: 'انقر للتكبير',
    avatarClosePreview: 'إغلاق',
    avatarInvalidType: 'استخدم صورة PNG أو JPG أو WEBP أو GIF.',
    avatarTooLarge: 'يجب ألا تزيد الصورة عن 5 ميجابايت.',
