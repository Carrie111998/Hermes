...
export const ar = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      chatLayoutTitle: 'تخطيط المحادثة',
      chatLayoutDesc: 'المكدس يحافظ على العرض الحالي بعرض كامل؛ الفقاعات تميز رسائلك عن ردود Hermes.',
      chatLayoutStacked: 'مكدس',
      chatLayoutBubbles: 'فقاعات',
