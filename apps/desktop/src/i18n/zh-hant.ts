...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      backdropTitle: '聊天背景',
      backdropDesc: '未顯示自訂桌布時使用的淡色雕像圖案。',
      introSplashTitle: '開場標識',
      introSplashDesc: '空白對話中顯示的字標和提示語。',
      wallpaper: {
        title: '自訂桌布',
        description: '僅儲存在本機，並依設定檔分別設定；匯入時只會最佳化一次。',
        choose: '選擇圖片',
        replace: '更換',
        remove: '移除',
        reset: '重設調整',
        error: '無法載入該圖片。請確認它是有效的 JPEG、PNG 或 WebP 檔案，且不超過 32 MB。',
        unsupported: '請重新啟動一次 Hermes 以啟用桌布選擇器。',
        profileNote: profile => `已在本機為「${profile}」設定檔儲存。`,
        preview: '預覽',
        previewEffect: '對話效果',
        previewFull: '完整圖片',
        visibility: '顯示',
        displayMode: '顯示方式',
        adaptiveTheme: '桌布配色',
        adaptiveThemeDesc: '從圖片擷取強調色與表面色，同時保持文字對比度。',
        adaptiveThemeAnalyzing: '正在分析圖片顏色…',
        adaptiveThemeError: '無法從這張圖片擷取顏色。',
        paletteMode: '配色方式',
        paletteModes: { auto: '自動擷取', manual: '手動指定' },
        paletteManualDesc: '強調色會直接套用；基調會輕量混入介面表面，以保持文字可讀性。',
        paletteDominant: '基調',
        paletteAccent: '強調色',
        modes: { fill: '填滿', fit: '適應', tile: '並排', center: '置中' },
        opacity: '圖片強度',
        blur: '模糊',
        overlay: '閱讀遮罩',
        overlayShape: '遮罩形狀',
