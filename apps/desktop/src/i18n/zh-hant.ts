...
export const zhHant = defineLocale({
  ...
  skills: {
    collective: {
      ...
      localCandidates: count => `${count} 個本機候選技能`,
      contributionWorkflow: '貢獻流程',
      potential: '可共享的技能',
      potentialHelp: '目前版本尚未提交的本機技能。',
      ownerReview: '你的貢獻草稿',
      ownerReviewHelp: '仍需你處理的私人草稿和貢獻。',
      noDrafts: '沒有需要你處理的貢獻草稿。',
      ...
      sendPrivateReview: '傳送至僅擁有者可見的伺服器審核',
