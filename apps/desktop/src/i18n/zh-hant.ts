...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      backgroundTitle: '聊天背景',
      backgroundDesc: '在對話後方顯示 Hermes 插圖、單張本機圖片或隨機輪播資料夾。',
      backgroundHermes: 'Hermes',
      backgroundImage: '圖片',
      backgroundFolder: '資料夾',
      backgroundImages: '背景圖片',
      backgroundChooseImage: '選擇背景圖片',
      backgroundChooseFolder: '選擇背景資料夾',
      backgroundChoosing: '正在選擇…',
      backgroundChange: '變更',
      backgroundRemove: '移除',
      backgroundStrength: '背景強度',
      backgroundInterval: '切換間隔',
      backgroundIntervalLabel: minutes => (minutes < 60 ? `${minutes} 分鐘` : `${minutes / 60} 小時`),
      backgroundTruncated: '正在使用此資料夾中前 1,000 張支援的圖片。',
      backgroundProfileNote: profile => `已為 ${profile} 設定檔儲存——每個設定檔保留自己的背景。`,
      backgroundErrors: {
        empty: '此資料夾中沒有支援的圖片。',
        'invalid-source': '該背景來源無效。',
        missing: '找不到所選背景。',
        unreadable: 'Hermes 無法讀取所選背景。',
        unsupported: '請選擇 PNG、JPEG、WebP、GIF、BMP 或 AVIF 圖片。'
      },
      embedsTitle: '內嵌預覽',
      embedsDesc:
