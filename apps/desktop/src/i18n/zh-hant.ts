...
export const zhHant = defineLocale({
  ...
  statusStack: {
    ...
    coding: {
      ...
      verificationStale: '已過期',
      verificationUnverified: '未驗證',
      verificationUnavailable: '無法使用',
      verificationChecking: '檢查中',
      verificationCheckingDetail: '正在檢查已記錄的驗證證據',
      verificationNoEvidence: '此工作階段沒有驗證記錄',
      verificationUnavailableDetail: '無法使用驗證證據',
      verificationChangesAfterCheck: '此驗證後又進行了變更',
      verificationPathsChanged: count => `此驗證後有 ${count} 個路徑發生變更`,
      verificationExit: code => `結束碼 ${code}`,
      verificationFull: '完整',
      verificationTargeted: '定向',
      verificationRun: '驗證變更',
      verificationRunAgain: '再次驗證',
      verificationPrompt:
        '為目前的變更執行適當的驗證。視需要使用儲存庫的標準測試、lint、型別檢查和建置命令。準確報告執行的命令和結果。不要進行無關變更。',
      newBranch: '新增分支',
