...
export const zhHant = defineLocale({
  ...
  notifications: {
    ...
    releaseReadyTitle: 'Hermes 新版本',
    releaseReadyMessage: tag => `${tag || '新的正式版本'}可以安裝了。`,
  ...
  settings: {
    ...
    about: {
      ...
      releaseUpdateReady: tag => `${tag || 'Hermes 新版本'}可以安裝了。`,
      ...
      fastTrack: '快速通道',
      fastTrackDesc: 'main 上的每項變更一發布就取得。適合能接受更頻繁更新的進階使用者。',
      releaseTrackHint: version => `正式版通道 · ${version}`,
      unknownVersion: '未知',
  ...
  updates: {
    ...
    allSetTitle: '已是最新版本',
    releaseReadyTitle: 'Hermes 新版本',
    releaseReadyBody: tag => `${tag || '最新正式版本'}可以安裝，發行說明如下。`,
    releaseNotesUnavailable: '此版本沒有可用的發行說明。',
  ...
  shell: {
    ...
    statusbar: {
      ...
      releasesBehind: count => `落後 ${count} 個正式版本`,
      release: tag => `版本 ${tag}`,
