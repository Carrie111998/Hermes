...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      removeTheme: '移除主題',
      importedBadge: '已匯入',
      createCustomTheme: '建立自訂主題',
      editCustomTheme: '編輯自訂主題',
      customThemeDesc: '分別編輯明亮與深色配色。修改會即時預覽，只有按下儲存後才會寫入。',
      customThemeName: '主題名稱',
      customAccent: '強調色',
      customBackground: '背景色',
      customForeground: '前景色',
      customUiFont: '介面字型',
      customCodeFont: '程式碼字型',
      customSidebar: '透明側欄',
      customContrast: '對比度',
      customInvalidColor: '請輸入有效的十六進位顏色，例如 #0053FD。',
      customReset: '重設',
      pet: {
        title: '寵物',
        intro:
