...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    plugins: {
      title: '桌面插件',
      blurb:
        '載入到此應用程式中的介面擴充——隨建置捆綁，或放入 desktop-plugins 資料夾（包括 Hermes 寫入的插件）。停用會即時卸載插件並在重啟後保持。',
      count: n => `已安裝 ${n} 個`,
      openFolder: '開啟插件資料夾',
      rescan: '重新掃描',
      reveal: '在檔案管理器中顯示',
  ...
  providerManager: {
    title: '提供方管理器',
    description: '啟用提供方、新增自訂端點，並管理在選擇器中顯示的模型。',
    filters: '篩選',
    providerListHeading: '提供方',
    modelsHeading: '模型',
    searchPlaceholder: '搜尋模型',
    noProviders: '沒有可用模型的提供方。',
    noModels: '找不到模型。',
    activeCount: (n: number) => `${n} 個已啟用`,
    allHidden: '所有模型已隱藏 — 不會出現在选择器裡。',
    addProvider: '新增提供方…',
    selectProviderHint: '選擇一個提供方以管理其模型。',
    editProvider: '編輯提供方',
    providerName: '名稱',
    ...
    apiKey: 'API 金鑰',
    apiKeyPlaceholder: '選填 — 留空以保留已儲存的金鑰',
    editProviderCredentials: '編輯憑證',
    baseUrlOverride: 'Base URL 覆寫',
    baseUrlOverridePlaceholder: '留空以使用預設端點',
    apiKeyDescription: '儲存在設定檔的 .env 檔案中',
    configureProvider: '設定提供方',
    configureDescription: '輸入 API 金鑰以啟用此提供方並發現其模型。',
    saveAndDiscover: '儲存並發現模型',
    apiKeyRequired: 'API 金鑰為必填項。',
    configuring: '儲存中…',
    apiMode: 'API 模式',
    apiModeChat: '聊天補全（相容 OpenAI）',
    apiModeAnthropic: 'Anthropic 訊息',
    models: '模型',
    modelsPlaceholder: '每行一個模型 ID，例如\ngpt-4o\nclaude-sonnet-4',
    confirmDelete: '刪除此提供方？此操作無法復原。',
    nameExists: '已存在同名提供方。',
    invalidUrl: '基礎 URL 必須是有效的 http(s) 網址。',
    enableProvider: '啟用提供方',
    disableProvider: '停用提供方',
    discoverModels: '自動發現模型',
    updateList: '更新列表',
    addModel: '新增模型',
    discoveryFailed: '模型發現失敗',
    discoveryEmpty: '未發現新模型',
    listRefreshed: '模型列表已重新整理',
    discoverySuccess: (n: number) => `已新增 ${n} 個模型`,
    manualModelTitle: '新增模型',
    manualModelDescription: '註冊此提供方公開的單一模型。',
    modelId: '模型 ID',
    modelIdPlaceholder: '例如 gpt-4o',
    modelName: '顯示名稱',
    modelNamePlaceholder: '在應用程式中顯示的選用名稱',
    advancedParameters: '進階參數',
    advancedParametersEmpty: '尚無進階參數。',
    modelIdRequired: '模型 ID 為必填項',
    modelExists: '已存在該 ID 的模型',
    groupLocal: '本地',
    groupConfigured: '已設定',
    groupUnconfigured: '未設定',
    searchProviders: '搜尋提供商',
    noProvidersMatch: '沒有符合的提供商。',
    filterVision: '視覺',
    filterMultimodal: '多模態',
    filterReasoning: '推理',
    filterFast: '快速',
    sortActiveFirst: '作用中優先',
    sortAz: 'A → Z',
    sortZa: 'Z → A',
    groupByLetter: '按字母分組',
    activeOnly: '僅作用中',
