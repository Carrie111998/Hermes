...
export const zhHant = defineLocale({
  ...
  desktop: {
    ...
    branchNoStoredMessage: '這個聊天裡還沒有可用於分支的已儲存訊息。',
    sessionBusy: '工作階段忙碌中',
    branchStopCurrent: '分支此聊天前請先停止目前回合。',
    branchNoText: '此訊息沒有可用於分支的文字。',
    branchTitle: n => `草稿：分支 #${n}`,
    branchFailed: '分支失敗',
    branchMessageUnavailable: '訊息不可用',
    branchMessageNotStored: '這則訊息尚未進入已儲存的對話記錄。',
    branchMessageNotMapped: '這則訊息目前還無法映射回已儲存的歷史記錄。',
    deleteFailed: '刪除失敗',
    archived: '已封存',
    archiveFailed: '封存失敗',
