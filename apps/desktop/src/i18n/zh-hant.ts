...
export const zhHant = defineLocale({
  ...
  assistant: {
    thread: {
      ...
      errorRetryLater: '稍後重試…',
      errorRetryLaterMenu: '稍後重試',
      errorRetryIn1h: '1 小時後',
      errorRetryIn3h: '3 小時後',
      errorRetryIn6h: '6 小時後',
      errorRetryAt: '在指定時間重試',
      errorRetryAtInvalid: '請輸入 14:30 這樣的時間',
      errorRetryScheduled: when => `將於 ${when} 自動重試`,
      errorRetryCancelScheduled: '取消自動重試',
      errorOpenLogs: '開啟日誌',
