...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    providers: {
      ...
      connected: '已連結',
      collapse: '收合',
      connectAnother: '連結其他提供者',
      poolStrategy: '集區策略',
      poolStrategyDescription: '選擇 Hermes 如何使用同一提供者的帳戶。',
      poolStrategyLabel: provider => `${provider} 的集區策略`,
      poolStrategies: {
        fill_first: '依序使用',
        no_failover: '不容錯移轉',
        round_robin: '輪詢',
      ...
      failedPoolStrategy: provider => `無法更新 ${provider} 的集區策略`,
