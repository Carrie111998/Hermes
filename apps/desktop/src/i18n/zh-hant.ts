...
export const zhHant = defineLocale({
  ...
  sidebar: {
    ...
    viewMenu: {
      ...
      apply: '切換並使用檢視',
      saveCurrent: '儲存目前檢視…',
      updateCurrent: '使用目前設定更新',
      update: '更新',
      rename: '重新命名…',
      delete: '刪除',
      saveTitle: '儲存側邊欄檢視',
      saveDescription: '儲存目前的分組、排序、篩選、設定檔範圍、中繼資料和顯示模式。',
      renameTitle: '重新命名側邊欄檢視',
      renameDescription: '為此已儲存檢視設定新名稱。',
      applyTitle: '切換個人資料並使用檢視？',
      applyDescription: (name, profile) => `「${name}」會切換到「${profile}」個人資料並開始新聊天，然後套用該檢視。`,
      updateTitle: '要更新已儲存的檢視嗎？',
      updateDescription: name => `要以目前的側邊欄設定取代「${name}」嗎？`,
      deleteTitle: '刪除側邊欄檢視？',
      deleteDescription: name => `刪除「${name}」？這不會變更目前的側邊欄。`,
      nameLabel: '名稱',
      namePlaceholder: '例如 待審核',
      grouping: '分組',
      ordering: '排序',
      show: '顯示',
      inboxStyle: '收件匣樣式',
