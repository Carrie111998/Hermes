...
export const zhHant = defineLocale({
  ...
  artifacts: {
    projectLibrary: '專案成品',
    allProjects: '所有專案',
    allProjectsHint: '展開專案後才會載入最近的成品。',
    noProjects: '沒有專案',
    noProjectsDesc: '加入或開啟專案後，產生的內容會在這裡按專案整理。',
    openSidebar: '在側邊欄開啟',
    openProject: '開啟',
    paneTitle: '成品',
    projectPaneTitle: project => `${project} · 成品`,
    indexingProject: project => `正在索引${project || '專案'}的成品`,
    indexingContext: '正在載入相關成品',
    sessionCount: count => `${count} 個工作階段`,
    loadMoreSessions: (loaded, total) => `載入更多（${loaded}/${total} 個工作階段）`,
    noArtifactsInProject: '這個專案中沒有符合的成品。',
    noContextArtifactsDesc: '目前對話和專案產生的內容會顯示在這裡。',
    noConversationArtifacts: '這次對話暫時沒有成品。',
    noRecentProjectArtifacts: '專案最近的工作階段暫時沒有成品。',
    thisConversation: '這次對話',
    recentInProject: '專案最近',
    viewAll: '查看專案所有成品',
    search: '搜尋成品…',
    refresh: '重新整理成品',
    refreshing: '正在重新整理成品',
