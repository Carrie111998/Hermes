...
export const zhHant = defineLocale({
  ...
  composer: {
    ...
    rewritePrompt: '重寫提示詞',
    rewritingPrompt: '正在重寫提示詞…',
    rewriteBasic: '基礎重寫',
    rewriteBasicDesc: '在不擴大範圍的前提下改善清晰度與文法。',
    rewriteBrief: '簡要擴展',
    rewriteBriefDesc: '僅補充使任務可執行所需的關鍵內容。',
    rewriteDetailed: '詳細擴展',
    rewriteDetailedDesc: '產生包含測試與驗收標準的可實作規格。',
    rewriteEnhance: '強化',
    rewriteEnhanceDesc: '新增相關工程考量，並在可用時使用偵測到的專案脈絡。',
    rewriteFailed: '無法重寫提示詞',
    rewriteDraftChanged: '重寫期間草稿已變更，因此保留了目前內容。',
    tipPre: '提示：輸入 ',
    tipPost: ' 以行內參照檔案。',
    snippetsTitle: '提示詞片段',
