...
export const zhHant = defineLocale({
  ...
  agents: {
    ...
    localBoardSubtitle: '本機設定檔、Cron 作業與即時委派工作。',
    liveSubagentsTitle: '即時子代理',
    localAgentsTitle: '本機代理',
    localAgentsDesc: '自動探索的 Hermes 設定檔',
    loadingLocalAgents: '正在載入本機代理',
    defaultBadge: '預設',
    modelInheritsDefault: '模型繼承預設值',
    skillsAndPath: (count, path) => `${count} 個技能 · ${path}`,
    noLocalProfiles: '找不到本機設定檔。',
    selectAgent: '選擇一個本機代理以檢查其偵測到的作業。',
    agentDetail: '代理詳細資料',
    loadingAgentJobs: '正在載入代理作業',
    statModel: '模型',
    statSkills: '技能',
    statJobs: '作業',
    statSchedule: '排程',
