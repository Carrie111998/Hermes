...
export const zhHant = defineLocale({
  common: {
    ...
    update: '更新',
    view: '查看',
    exitCode: code => `結束 ${code}`,
    imagePreviewFailed: '圖片預覽載入失敗',
    openImage: '開啟圖片',
  ...
  settings: {
    ...
    customEndpoints: {
      ...
      saved: '自訂端點已儲存。',
      saveFailed: '儲存失敗',
      reachableModels: count => `端點可連線，找到 ${count} 個模型。`,
      reachable: '端點可連線。',
      ...
      deleteEndpoint: '刪除端點',
      emptyTitle: '沒有自訂端點',
      emptyDescription: '請在下方新增相容 OpenAI 的端點。',
      editTitle: '編輯端點',
      addTitle: '新增端點',
      name: '名稱',
      namePlaceholder: 'Axet 代理',
      providerId: '提供方 ID',
    ...
    billing: {
      tryAgain: '重試',
      title: '帳單',
      checkingPlanChange: '正在檢查此變更…',
      planChangeBlocked: '無法在此處進行這項變更。',
      alreadyOnPlan: tier => `你目前已在 ${tier} 方案中，無須變更。`,
      scheduledPlanChange: (tier, date, credits) =>
        `將變更為 ${tier}，於 ${date} 生效。現在不會收費；在此之前你會繼續使用目前方案。${credits ? `每月額度變更：${credits}。` : ''}`,
      planChangeUnavailable: '無法在此處排定這項變更。',
      scheduling: '正在排定…',
      ...
      backToBilling: '返回帳單',
      plans: '方案',
      plansUnavailable: '目前沒有可變更到的方案。',
      perMonth: '/月',
      account: '帳戶',
      usage: '用量',
      invoices: '發票',
      autoRefillUpdated: '自動加值已更新。',
      autoRefillTurnedOff: '自動加值已關閉。',
      threshold: '觸發門檻',
      autoRefillThreshold: '自動加值觸發門檻',
      reloadTo: '加值至',
      autoRefillReloadTo: '自動加值目標金額',
      disable: '停用',
      turnOffPrompt: '關閉自動加值？',
      turnOff: '關閉',
      customCreditAmount: '自訂加值金額',
      buy: '購買',
      processingSettlement: '處理中…正在確認結算結果',
      addedBalanceRefreshing: amount => `已加值 ${amount}，正在重新整理餘額。`,
      openPortal: '開啟入口網站',
      openVerification: '開啟驗證頁面',
      dismiss: '關閉提示',
      waitingVerification: '正在等待驗證連結…',
      verifyContinue: '驗證後繼續',
      usageFallback: label => `${label}用量`,
      fixture: name => `測試資料：${name}`,
      updatedAgo: time => `更新於${time}`,
      billingFixture: '帳單測試資料',
      live: '即時',
      openPortalExternal: '開啟入口網站 ↗',
      connectAccountMessage: '請在 TUI 中執行 /portal，或開啟 Nous 入口網站連接帳戶。',
      connectAccountTitle: '連接 Nous 帳戶',
      balance: '餘額',
      plan: '方案',
      autoRefill: '自動加值',
      enabled: '已啟用',
      ...
      updateExternal: '更新 ↗',
      paymentMethodMissingDescription: '請先在入口網站新增付款方式，再購買加值額度。',
      paymentMethod: '付款方式',
      noCard: '尚未綁定信用卡',
      paymentMethodDescription: '管理用於加值和續訂方案的信用卡。',
      adjustPlanExternal: '調整方案 ↗',
      subscriptionUnavailable: '訂閱詳情暫時無法使用，但仍可開啟入口網站管理。',
      renews: date => `續訂日期：${date}`,
      subscriptionDescription: '查看方案並從帳單入口網站變更。',
      opensPortal: '開啟入口網站',
      subscription: '訂閱',
      buyCredits: '購買額度',
      buyCreditsDescription: '為方案外的代理執行購買加值額度。',
      manage: '管理',
      manageAutoRefillPortal: '請在入口網站管理自動加值。',
      autoRefillDescription: '餘額低於門檻時自動補充。',
      turnOnAutoRefillPortal: '請在入口網站啟用自動加值',
      differentCard: '另一張信用卡',
      reconcileExternal: '核對 ↗',
      autoRefillCharges: card => `自動加值使用 ${card}，請在入口網站核對`,
      refillWhen: (amount, threshold) => `餘額低於 ${threshold} 時加值至 ${amount}`,
      subscriptionRemainingOver: (remaining, monthly, over) => `剩餘 ${remaining} / ${monthly} · 超用 ${over}`,
      subscriptionRemaining: (remaining, monthly) => `剩餘 ${remaining} / ${monthly}`,
      subscriptionCreditsRemaining: '剩餘訂閱額度',
      resets: date => `重設日期：${date}`,
      subscriptionCredits: '訂閱額度',
      topUpCreditsRemaining: '剩餘加值額度',
      doesNotExpire: '不會過期',
      topUpCredits: '加值額度',
      amountOfLimitUsed: (amount, limit) => `已用 ${amount} / ${limit}`,
      monthlySpendCapUsed: '每月支出上限使用量',
      defaultCeiling: '預設上限',
      monthlyTerminalBillingSpend: '終端帳單每月支出',
      monthlySpendCap: '每月支出上限',
      planMonthly: (tier, price) => `${tier} · ${price}/月`,
      autoRefillCard: '自動加值信用卡',
      customerDefault: '客戶預設信用卡',
      subscriptionCard: '訂閱信用卡',
      creditsAdded: amount => `已加值 ${amount}。`,
      creditsAddedGeneric: '額度已加值。',
      chargeFailedTitle: '加值失敗',
      chargeOutcomeUnconfirmedMessage: message => `${message} 上一次加值結果尚未確認，重試前請檢查餘額或記錄。`,
      chargeOutcomeUnconfirmedTitle: '加值結果尚未確認',
      couldNotCheckCharge: '無法檢查加值結果。',
      couldNotCheckChargeTitle: '無法檢查加值',
      acceptedNoChargeId: '帳單服務已接受請求，但未傳回加值 ID。',
      chargeCouldNotBeTracked: '無法追蹤加值',
      chargeMayStillSettle: '加值可能仍在結算，重試前請先檢查入口網站。',
      stillProcessing: '處理已超過 5 分鐘',
      bankVerificationRequired: '銀行要求完成 3DS 驗證，請在入口網站完成後繼續購買。',
      cardExpired: '信用卡已過期，請在入口網站更新。',
      cardDeclined: '信用卡遭拒，請在入口網站改用其他信用卡。',
      chargeProcessingError: reason => `加值未成功（${reason}）。`,
      verificationNotGrantedMessage: '驗證已結束，但未授予帳單管理權限。',
      verificationNotGrantedTitle: '驗證未獲核准',
      billingAccessVerifiedMessage: '帳單管理權限已驗證。',
      billingAccessVerifiedTitle: '驗證完成',
      reloadGreaterThanThreshold: '加值目標金額必須大於觸發門檻。',
      invalidAmount: label => `${label}：請輸入最多保留 2 位小數的美元金額。`,
      amountGreaterThanZero: label => `${label}：金額必須大於 $0。`,
      minimumAmount: (label, minimum) => `${label}：最低金額為 ${minimum}。`,
      maximumAmount: (label, maximum) => `${label}：最高金額為 ${maximum}。`,
      errors: {
        tooManyChargesRetry: minutes => `🟡 目前加值請求過多（約 ${minutes} 分鐘後重試）。這不是付款失敗。`,
        tooManyCharges: '🟡 目前加值請求過多。這不是付款失敗。',
        stripeRetry: minutes => `Stripe 暫時異常，請約 ${minutes} 分鐘後重試`,
        stripeTrouble: 'Stripe 暫時異常，請稍後重試',
        confirmCard: '請在入口網站確認此卡可用於終端加值',
        cardConfirmationNeeded: '需要確認信用卡',
        terminalBillingApprovalMessage: '需要允許遠端消費。請先發起加值以授權，然後重試。',
        terminalBillingApprovalTitle: '遠端消費需要核准',
        adminDisabledTerminalBilling: '管理員已停止此終端的遠端消費。',
        youDisabledTerminalBilling: '你已停止此終端的遠端消費。',
        reauthorizeDevice: message => `${message} 請從「設定 → 閘道」重新連線並授權此裝置。`,
        terminalBillingOffTitle: '遠端消費已停止',
        sessionLoggedOutMessage: '工作階段已登出，請從「設定 → 閘道」重新登入。',
        sessionLoggedOutTitle: '工作階段已登出',
        terminalBillingDisabledMessage: '此帳戶的遠端消費已關閉，需要帳單管理員在入口網站的 Hermes Agent 頁面中啟用。',
        terminalBillingDisabledTitle: '遠端消費已關閉',
        adminRoleMessage: '加值需要組織管理員或擁有者權限，請聯絡管理員或在入口網站管理。',
        adminRoleTitle: '需要管理員權限',
        idempotencyMessage: '🔴 此加值識別碼已用於另一金額，請重新發起加值。',
        idempotencyTitle: '重新發起加值',
        noPaymentMethodMessage: '💳 尚未儲存終端加值信用卡。請在入口網站設定（單次購買不會儲存可重用信用卡）。',
        noPaymentMethodTitle: '未儲存信用卡',
        orgAccessMessage: '此權杖未綁定到你可以管理的組織',
        orgAccessTitle: '沒有組織存取權限',
        monthlyCapRemaining: remaining => `🔴 已達每月支出上限，剩餘可用空間 $${remaining}。`,
        monthlyCapMessage: '🔴 已達每月支出上限。',
        monthlyCapTitle: '已達每月支出上限',
        tooManyChargesTitle: '目前加值請求過多',
        stripeTroubleTitle: 'Stripe 暫時異常',
        planLimitMessage: '已達每日方案變更上限，請明天重試',
        planLimitTitle: '已達每日方案變更上限',
        endpointUnavailableMessage: '帳單端點傳回非 JSON 回應，此部署可能未提供該端點。',
        endpointUnavailableTitle: '帳單端點無法使用',
        timeoutMessage: '帳單請求逾時。',
        timeoutTitle: '帳單請求逾時',
        transportMessage: '帳單請求在到達閘道前失敗。',
        transportTitle: '帳單連線失敗',
        defaultMessage: '帳單請求失敗。',
        defaultTitle: '帳單請求失敗'
      }
    },
    plugins: {
    ...
    memoryProvider: {
      ...
      loadFailedDetail: message => `記憶提供方設定載入失敗：${message}`,
      savedTitle: provider => `${provider} 已儲存`,
      savedMessage: '記憶提供方設定已更新。',
      saveFailed: provider => `無法儲存 ${provider} 設定`,
      saveFieldFailed: field => `儲存 ${field} 失敗`,
      loading: '正在載入記憶提供方設定…',
      settings: provider => `${provider} 設定`,
      fieldSet: field => `${field} 已設定`,
      fieldNotSet: field => `${field} 未設定`,
      fieldAbout: field => `關於 ${field}`,
      fullConfig: '完整設定…',
      fullConfigurationTitle: provider => `${provider} — 完整設定`,
      fullConfigurationDescription: (provider, profile) =>
        `${provider} 在「${profile}」設定檔中的所有選項。留空欄位將回退到解析後的主機值或內建預設值。`,
      configReference: provider => `${provider} 設定參考`,
      otherGroup: '其他',
      saveChanges: '儲存變更',
