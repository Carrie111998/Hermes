...
export const zhHant = defineLocale({
  ...
  sidebar: {
    ...
    row: {
      ...
      continueOnPhoneAvailabilityHint: '請保持 Hermes Desktop 開啟，且電腦維持喚醒。',
      continueOnPhoneExpiredTitle: '此代碼已到期',
      continueOnPhoneExpiredDesc: '準備掃描時請建立新代碼。',
      continueOnPhoneNewCode: '建立新代碼',
      continueOnPhoneNotConfiguredTitle: '尚未設定遠端存取',
      continueOnPhoneNotConfiguredDesc: '請設定支援瀏覽器登入的 HTTPS 儀表板公開 URL，然後重試。',
      continueOnPhoneInsecureUrlTitle: '遠端存取 URL 不安全',
      continueOnPhoneInsecureUrlDesc: '請使用沒有內嵌憑證的 HTTPS 儀表板公開 URL。',
      continueOnPhoneUnreachableTitle: '遠端存取無法使用',
      continueOnPhoneUnreachableDesc: 'Hermes 無法連線到儀表板公開 URL。請檢查後重試。',
      continueOnPhoneBrowserAuthTitle: '不支援瀏覽器登入',
