...
export const zhHant = defineLocale({
  ...
  shell: {
    ...
    statusbar: {
      ...
      contextUsagePanel: {
        ...
        compressNow: '立即壓縮',
        compressNowTitle: '在下一輪對話前壓縮此工作階段',
        compressUnavailable: '請等待目前的工作階段活動結束。',
        keepRecent: '保留最近輪次',
        keepRecentAll: '全部摘要',
        keepRecentTitle: '逐字保留所選最近的使用者與 Hermes 對話輪次',
        keepRecentTurns: turns => `${turns} 輪`,
  ...
  desktop: {
    ...
    resumeRetry: '重試',
    compactionGuardTitle: sessionLabel => `正在壓縮「${sessionLabel}」`,
    compactionGuardSessionId: sessionId => `工作階段 ${sessionId}`,
    compactionGuardDescription: 'Hermes 正在摘要此聊天中較早的上下文。只有此聊天會暫時鎖定；您仍可切換到其他工作階段。',
    compactionGuardStatus: '在 Hermes 回報壓縮完成或失敗之前，此處的傳送、引導和排隊功能均已停用。您的草稿會被保留。',
    compactionCompleteTitle: '上下文已壓縮',
    compactionCompleteMessage: '較早的歷史記錄已成功摘要。現在可以繼續此工作階段。',
    compactionFailedTitle: '上下文壓縮失敗',
