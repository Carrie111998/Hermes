...
export const zhHant = defineLocale({
  ...
  skills: {
    ...
    files: '檔案',
    loadingFiles: '正在載入檔案…',
    filesLoadFailed: '技能檔案載入失敗。',
    binary: '二進位',
    binaryUnsupported: path => `${path} 是二進位檔案，無法在文字編輯器中開啟。`,
    discardUnsaved: '放棄未儲存的變更並切換檔案嗎？',
    deleteFile: path => `刪除 ${path}`,
    deleteFileConfirm: path => `從此技能刪除 ${path}？此操作無法復原。`,
    fileDeleted: '技能檔案已刪除',
    edit: '編輯',
    archive: '封存',
