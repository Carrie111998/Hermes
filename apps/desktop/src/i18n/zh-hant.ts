...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    about: {
      ...
      updates: '更新',
      clientUpdates: '桌面應用程式',
      backendUpdates: '已連線的後端',
      checkNow: '立即檢查',
      checking: '檢查中…',
      seeWhatsNew: '查看新增內容',
      updateNow: '立即更新',
      ...
      onLatest: '你已是最新版本。',
      installing: '正在安裝更新。',
      gatewayRestartRequired: '閘道正在執行舊程式碼，需要重新啟動。',
    ...
    fleetUpdates: {
      title: '後端叢集更新',
      intro: '每列代表一個已註冊後端。檢查與操作固定到該閘道；同一安裝的別名只會更新一次。',
      refresh: '重新整理後端',
      updateAll: '全部更新',
      updatingAll: '正在全部更新…',
      backendTitle: label => `${label} 後端`,
      backendVersion: version => `後端 ${version}`,
      deployment: kind => `安裝類型：${kind}`,
      deploymentKinds: {
        cloud: '雲端代管',
        desktop: '桌面用戶程式管理',
        external: '外部管理',
      ...
      current: '後端已是最新',
      failed: '檢查失敗',
      cloudManaged: '由 Hermes Cloud 管理',
      manual: '手動更新',
      partial: '部分更新',
      applying: '正在更新後端…',
      updated: '後端已更新',
      restartRequired: '需要重新啟動閘道',
      restartGateway: '重新啟動閘道',
      restarted: '閘道已重新啟動',
      applyBackend: '更新後端',
      copyCommand: '複製精確指令',
      retry: '重試後端',
      manualToast: '此後端需要執行顯示的手動更新指令。',
      partialToast: '後端更新僅部分完成。重試前請檢查此列。',
      availabilityUnknown: '無法確認此後端是否有可用更新。套用任何更新前請先重新整理。',
      cannotApply: '此後端無法直接套用更新。',
      checkFailed: '後端更新檢查失敗。',
      checkUnavailable: '後端更新檢查無法使用。',
      restartFailed: '閘道重新啟動失敗。',
      restartNoReturn: '閘道未能以目前程式碼恢復。',
      restartRefused: '閘道拒絕重新啟動。',
      sshOwnedServe: label =>
        `${label} 由 Desktop 的 SSH 生命週期提供服務。請中斷連線，在該主機上執行顯示的指令，然後重新連線。`,
      updateFailed: '後端更新失敗。',
      updateNoReturn: '更新後後端未恢復連線。',
      updateRefused: '後端拒絕更新。',
      botContext: (profiles, platforms) =>
        [
          profiles.length ? `Bot 設定檔：${profiles.join('、')}` : '',
          platforms.length ? `平台：${platforms.join('、')}` : ''
        ]
          .filter(Boolean)
          .join(' · ')
    },
  ...
  updates: {
    ...
    everythingBackendTitle: label => `${label} 後端`,
    everythingBackendUpdated: '後端更新已完成。',
    everythingBackendRestarted: '閘道已使用目前的後端程式碼重新啟動。',
    everythingBackendPartial: '後端更新已完成，但仍需後續處理。',
    everythingBackendManualCommand: command => `手動更新此後端：${command}`,
    everythingBackendManual: '此後端需要手動更新。',
    everythingBackendManaged: '此後端由 Hermes Cloud 管理。',
    restartSkewedGatewayTitle: '需要重新啟動後端閘道',
    restartSkewedGatewayBody: '此閘道仍在執行舊版後端程式碼。切換模型或繼續前，僅重新啟動其所屬設定檔。',
    restartSkewedGateway: '重新啟動後端閘道',
    applyStatus: {
      preparing: '正在更新後端…',
      pulling: '後端更新中…',
      ...
      partial: '後端更新僅部分完成。重試前請檢查後端。',
      restartingSkewedGateway: '正在以目前程式碼重新啟動指定的後端閘道…',
      restartFailed: '後端閘道重新啟動失敗。',
      restartComplete: '後端閘道已使用目前程式碼重新啟動。',
      restartNoReturn: '後端閘道未能以目前程式碼恢復。'
    }
  },
