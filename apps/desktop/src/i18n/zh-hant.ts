...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    toolsets: {
      ...
      useBackend: '使用此後端',
      nastechIncluded: '包含在 Nastech 訂閱中；登入 Nastech Portal 即可啟用。',
      nastechAuthNeededTitle: '登入 Nastech Portal',
      nastechAuthNeededMessage: provider => `已儲存 ${provider}，但在登入 Nastech Portal 之前不會啟用。`,
      nastechAuthSignIn: '登入',
      nastechAuthDoneTitle: '已連接 Nastech Portal',
      nastechAuthDoneMessage: '訂閱後端現已啟用。',
      nastechAuthFailed: 'Nastech Portal 登入未完成',
  ...
  skills: {
    ...
    skillArchivedMessage: '可透過 nastech curator restore 還原。'
  },
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot 使用者 ID', placeholder: '@nastech:example.org' },
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro 模型需要付費 Nastech 訂閱。',
    free: '免費',
    freeTier: '免費層',
  ...
  desktop: {
    ...
    handoff: {
      ...
      timedOut: '等待閘道逾時。`nastech gateway` 是否正在執行？'
    }
  },
