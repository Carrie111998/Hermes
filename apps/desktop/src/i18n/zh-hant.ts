...
export const zhHant = defineLocale({
  ...
  statusStack: {
    ...
    coding: {
      ...
      pull: '拉取',
      createBranch: '新建分支',
      createBranchDesc: '從目前 HEAD 建立新分支。',
      renameBranch: '重新命名分支',
      renameBranchDesc: (name: string) => `重新命名 ${name}。`,
      deleteBranch: '刪除分支',
      deleteBranchConfirm: (name: string) => `刪除分支 ${name}？此操作無法復原。`,
      createTag: '新建標籤',
      createTagDesc: '在目前 HEAD 建立新標籤。',
      deleteTag: '刪除標籤',
      deleteTagConfirm: (name: string) => `刪除標籤 ${name}？此操作無法復原。`,
      stashChanges: '暫存變更',
      stashChangesDesc: '暫存所有未提交的變更。',
      stashMessage: '訊息',
      stashMessagePlaceholder: '暫存訊息（選填）',
      applyStash: '套用暫存',
      dropStash: '捨棄暫存',
      dropStashConfirm: (id: string) => `捨棄 ${id}？此操作無法復原。`,
      branchName: '分支名稱',
      tagName: '標籤名稱'
    }
  },
