...
export const zhHant = defineLocale({
  ...
  cron: {
    ...
    scriptTimeoutLabel: '腳本逾時（秒）',
    scriptTimeoutPlaceholder: '全域預設值',
    scriptTimeoutHint: '留空使用全域逾時；輸入 0 可停用牆鐘逾時。',
    scriptTimeoutInvalid: '腳本逾時必須為 0 或正的有限數。',
    scriptTimeoutUnlimited: '無限制',
