...
export const zhHant = defineLocale({
  ...
  desktop: {
    ...
    botDesktop: {
      title: 'Bot Desktop',
      profile: profile => `設定檔：${profile}`,
      runtime: '執行環境',
      wsl: 'WSL + Xvfb',
      docker: 'Docker + Xvfb',
      openStandalone: '開啟獨立桌面',
      openEmbedded: '在 Hermes 工作區中開啟',
      start: '啟動桌面',
      starting: '正在啟動桌面…',
      stop: '停止桌面',
      refresh: '重新整理狀態',
      revealWorkspace: '開啟工作區',
      running: '執行中',
      notRunning: '未執行',
      unavailable: '無法使用',
      viewerTitle: profile => `${profile} Bot Desktop`,
      viewerHint: '每個 Bot 都有獨立的 X 顯示器、瀏覽器資料和工作區。這是 OS 程序邊界，不是虛擬機。',
      startFailed: message => `無法啟動 Bot Desktop：${message}`
    },
    handoff: {
      pickPlatform: '選擇目標平台',
