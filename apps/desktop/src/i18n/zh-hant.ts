...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    model: {
      ...
      applying: '套用中...',
      routingTitle: '模型路由',
      routingDesc: '查看處理每個 Hermes 通道的供應商和模型。自動通道使用主要模型。',
      routingLaneCount: count => `${count} 個通道`,
      mainLane: '主要聊天',
      mainLaneHint: '對話輪次',
      primary: '主要',
      usesMain: '使用主要模型',
      dedicated: '專用',
      routingUnavailable: '無法使用',
      auxiliaryTitle: '輔助模型',
      ...
      tasks: {
        ...
        triage_specifier: { label: '分流說明', hint: '看板規格細化' },
        kanban_decomposer: { label: '看板拆解', hint: '任務拆解' },
        profile_describer: { label: '設定檔描述', hint: '設定檔摘要' },
