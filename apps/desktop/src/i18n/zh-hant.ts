...
export const zhHant = defineLocale({
  ...
  install: {
    ...
    connectExistingDesc: 'HTTPS 閘道，或 ssh://host 透過 SSH 連線。不會啟動本機安裝。',
    ...
    remoteSetupDesc: '貼上 https:// 閘道 URL，或 ssh://host 透過 SSH 連線。',
    remoteUrlTitle: '閘道 URL',
    remoteUrlDesc: '公開儀表板用 https://，SSH 用 ssh://botnet（user@host，可選 :port 與 ?profile=）。',
    remoteUrlPlaceholder: 'https://gateway.example.com/hermes 或 ssh://botnet',
    sshDetected: host =>
      `將透過 SSH 連線 ${host}。測試並套用後，Desktop 會用 ssh-agent 或 ~/.ssh/config 掛到該機器上的 Hermes serve。`,
