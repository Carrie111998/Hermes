...
export const zhHant = defineLocale({
  ...
  pullRequests: {
    title: '提取要求',
    created: '我建立的',
    reviewRequested: '要求我審查',
    closed: '已關閉',
    search: '搜尋提取要求',
    refresh: '重新整理',
    refreshing: '正在重新整理',
    loading: '正在載入提取要求',
    loadingDetails: '正在載入詳細資料',
    open: '開啟',
    draft: '草稿',
    merged: '已合併',
    reviewDecision: '審查決定',
    checks: '檢查',
    openGithub: '在 GitHub 上開啟',
    copyUrl: '複製 URL',
    back: '返回提取要求',
    noneCreated: '沒有我建立的提取要求',
    noneReview: '沒有等待您審查的內容',
    noneClosed: '沒有最近關閉的提取要求',
    ghMissing: '找不到 GitHub CLI',
    authRequired: '需要 GitHub 驗證',
    authHint: '執行 `gh auth login`',
    loadFailed: '載入提取要求失敗',
    detailFailed: '載入提取要求詳細資料失敗',
    retry: '重試',
    updated: '更新時間',
    repository: '儲存庫',
    changedFiles: '變更的檔案',
