...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    gateway: {
      ...
      restartCurrent: '重新啟動目前後端',
      restartCurrentTitle: '重新啟動目前後端',
      restartCurrentDesc: '重新啟動 Desktop 管理的本機或 SSH 後端。進行中的工作可能會中斷。',
      restartingCurrent: '正在重新啟動後端…',
      restartCurrentSuccess: '後端已重新啟動，Desktop 已重新連線。',
      restartCurrentCancelled: '已取消重新啟動。後端仍在執行。',
      restartCurrentRemote: '遠端後端不由 Desktop 管理。只能重新連線。',
      restartCurrentOwnershipFailed: '已停止重新啟動：Desktop 無法證明後端所有權。未終止任何程序。',
      restartCurrentFailed: '後端重新啟動失敗。連線仍可復原。',
      diagnostics: '診斷',
