...
export const ja = defineLocale({
  ...
  agents: {
    ...
    localBoardSubtitle: 'ローカルプロファイル、Cron ジョブ、ライブ委任作業。',
    liveSubagentsTitle: 'ライブサブエージェント',
    localAgentsTitle: 'ローカルエージェント',
    localAgentsDesc: '自動検出された Hermes プロファイル',
    loadingLocalAgents: 'ローカルエージェントを読み込み中',
    defaultBadge: 'デフォルト',
    modelInheritsDefault: 'モデルはデフォルトを継承',
    skillsAndPath: (count, path) => `${count} スキル · ${path}`,
    noLocalProfiles: 'ローカルプロファイルが見つかりません。',
    selectAgent: 'ローカルエージェントを選択して検出済みジョブを確認します。',
    agentDetail: 'エージェント詳細',
    loadingAgentJobs: 'エージェントジョブを読み込み中',
    statModel: 'モデル',
    statSkills: 'スキル',
    statJobs: 'ジョブ',
    statSchedule: 'スケジュール',
    ...
    noCronJobsTitle: 'Cron ジョブは検出されていません',
    noCronJobsDesc: profile => `${profile} で作成された新しいジョブは、デフォルトビューで自動的にここに表示されます。`,
