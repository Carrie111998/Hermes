...
export const ja = defineLocale({
  ...
  cron: {
    ...
    scriptTimeoutLabel: 'スクリプトのタイムアウト（秒）',
    scriptTimeoutPlaceholder: 'グローバル設定',
    scriptTimeoutHint: '空欄でグローバル値、0 で制限なしになります。',
    scriptTimeoutInvalid: 'タイムアウトには 0 または正の有限数を指定してください。',
    scriptTimeoutUnlimited: '無制限',
