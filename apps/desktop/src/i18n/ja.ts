...
export const ja = defineLocale({
  ...
  statusStack: {
    ...
    coding: {
      ...
      renameBranchDesc: (name: string) => `${name} の名前を変更します。`,
      deleteBranch: 'ブランチを削除',
      deleteBranchConfirm: (name: string) => `ブランチ ${name} を削除しますか？この操作は取り消せません。`,
      createTag: '新規タグ',
      createTagDesc: '現在の HEAD に新しいタグを作成します。',
      deleteTag: 'タグを削除',
      deleteTagConfirm: (name: string) => `タグ ${name} を削除しますか？この操作は取り消せません。`,
      stashChanges: '変更をスタッシュ',
      stashChangesDesc: 'コミットされていない変更をすべてスタッシュします。',
      stashMessage: 'メッセージ',
      stashMessagePlaceholder: 'スタッシュのメッセージ（任意）',
      applyStash: 'スタッシュを適用',
      dropStash: 'スタッシュを破棄',
      dropStashConfirm: (id: string) => `${id} を破棄しますか？この操作は取り消せません。`,
      branchName: 'ブランチ名',
      tagName: 'タグ名'
    }
  },
