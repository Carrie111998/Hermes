...
export const tr = defineLocale({
  common: {
    ...
    targetSession: 'Hedef oturum',
    openInHermes: 'Hermes’te aç',
    quickEntry: 'Hızlı Giriş',
    profiles: 'Profiller',
    removeReference: 'Referansı kaldır',
    hatchingProgress: 'Yumurtadan çıkma ilerlemesi',
    reactedByHermes: 'Hermes tepki verdi',
    openDiagram: 'Diyagramı aç',
    moaPresets: 'MoA hazır ayarları',
    driverHealth: 'Sürücü sağlığı',
    screenRecording: 'Ekran Kaydı',
    accessibility: 'Erişilebilirlik',
    conversationTimeline: 'Sohbet zaman çizelgesi',
    timelineScrubber: 'Zaman çizelgesi kaydırıcısı',
    grabKeyFrom: 'Anahtarını şuradan al:',
    ...
    usage: 'Kullanım',
    invoices: 'Faturalar',
    autoRefillThreshold: 'Otomatik yükleme eşiği',
    autoRefillAmount: 'Otomatik yükleme miktarı',
    customCreditAmount: 'Özel kredi miktarı',
    customEndpoints: 'Özel Uç Noktalar',
    deleteEndpoint: 'Uç noktayı sil',
    noCustomEndpoints: 'Özel uç nokta yok',
    addEndpointDesc: 'Aşağıya OpenAI uyumlu bir uç nokta ekleyin.',
    dangerZone: 'Tehlikeli bölge',
    confirmUninstall: 'Kaldırmayı onayla',
    uninstallHermes: 'Hermes’i kaldır',
    mixtureOfAgents: 'Ajanların Karışımı',
    preset: 'Hazır ayar',
    newPreset: 'yeni hazır ayar',
    aggregator: 'Toplayıcı',
    searchThemes: 'Temalarınızı veya VS Code Marketplace’i arayın…',
    auto: 'Otomatik',
    myProfile: 'profilim',
    splitRight: 'Sağ',
    splitDown: 'Aşağı',
    ...
    splitUp: 'Yukarı',
    alertCaution: 'Dikkat',
    alertImportant: 'Önemli',
    alertNote: 'Not',
    alertTip: 'İpucu',
    alertWarning: 'Uyarı',
    youtubeEmbed: 'YouTube gömülü öğesi',
    spotifyEmbed: 'Spotify gömülü öğesi',
    messageInput: 'Mesaj…',
    loadingMemoryProviderSettings: 'Bellek sağlayıcı ayarları yükleniyor...',
    askHermes: 'Hermes’e sor…',
    notConnectedReconnect: 'Bağlı değil — yeniden bağlanmak için Hermes’i aç',
    sendTo: 'Şuna gönder',
    loadingEmoji: 'Emoji yükleniyor…',
