...
export const zh: Translations = {
  ...
  sidebar: {
    ...
    row: {
      ...
      cleanupTitle: '移除会话工作树？',
      cleanupBlockedTitle: '无法移除工作树',
      cleanupAllowedDesc: (branch, path) => `移除 ${branch} 在 ${path} 的工作树？会话和分支将保留以供审计。`,
      cleanupInspectFailed: '无法检查工作树',
      cleanupRemoving: '正在移除工作树…',
      cleanupRemoved: '工作树已移除',
      cleanupRemove: '移除工作树',
      cleanupReasons: {
        active: '仍有会话正在使用此工作树。',
        dirty: '工作树中有未提交或未跟踪的更改。',
