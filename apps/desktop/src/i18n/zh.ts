...
export const zh: Translations = {
  ...
  learningInbox: {
    title: '学习收件箱',
    subtitle: '在记忆、技能和自动化加入 Hermes 之前，先审核建议。',
    loading: '正在加载学习候选…',
    refresh: '刷新收件箱',
    emptyTitle: '没有待审核内容',
    emptyDesc: '开启记忆和技能审批后，未来的学习内容会显示在这里。',
    approvalOff: '审批已关闭',
    approvalHint: '未来的记忆和技能写入目前会立即保存。',
    enableApprovals: '开启审批',
    approvalsEnabled: '审批闸门已开启',
    memory: '记忆',
    skill: '技能',
    automation: '自动化',
    approve: '批准',
    ...
    source: '来源',
    origin: '来源上下文',
    noSessionEvidence: '此候选项没有记录会话引用。',
    loadFailed: '无法加载学习收件箱',
    actionFailed: '学习操作失败',
    approved: '已批准学习候选项',
    dismissed: '已忽略学习候选项',
    openGraph: '打开记忆图谱',
    openSkills: '打开技能',
    candidateCount: count => `${count} 个候选项待审核`
  },
  agents: {
    close: '关闭代理',
    title: '派生树',
