...
export const zh: Translations = {
  ...
  skills: {
    ...
    channels: {
      search: '搜索渠道、能力或工具…',
      loadFailed: '渠道能力加载失败。',
      description: '明确选择该消息渠道的新 Agent 会话可以使用哪些工具集和 MCP 服务。',
      customBoundary: '自定义能力边界',
      inheritedDefaults: '继承默认能力',
      toolsets: 'Agent 能力',
      toggleToolset: label => `切换该渠道的 ${label}`,
      highImpact: '高影响',
      required: '渠道必需能力',
      mcpAccess: 'MCP 访问',
      mcpAll: '全部已启用服务',
      mcpNone: '全部禁止',
      mcpSelected: '仅所选服务',
      noMcp: '当前没有已启用的 MCP 服务。',
      save: '保存能力',
      savedTitle: '渠道能力已保存',
      savedMessage: channel => `${channel} 的新会话将使用此能力边界。`,
      saveFailed: channel => `保存 ${channel} 的能力失败`
    },
    hub: {
