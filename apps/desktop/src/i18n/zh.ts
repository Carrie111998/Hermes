...
export const zh: Translations = {
  ...
  notifications: {
    ...
    releaseReadyMessage: tag => `${tag || '新的正式版本'}可以安装了。`,
  ...
  settings: {
    ...
    about: {
      ...
      releaseUpdateReady: tag => `${tag || 'Hermes 新版本'}可以安装了。`,
      ...
      fastTrack: '快速通道',
      fastTrackDesc: 'main 上的每项更改一发布就获取。适合能接受更频繁更新的高级用户。',
  ...
  updates: {
    ...
    allSetTitle: '已是最新',
    releaseReadyTitle: 'Hermes 新版本',
    releaseReadyBody: tag => `${tag || '最新正式版本'}可以安装，发行说明如下。`,
    releaseNotesUnavailable: '此版本没有可用的发行说明。',
  ...
  shell: {
    ...
    statusbar: {
      ...
      releasesBehind: count => `落后 ${count} 个正式版本`,
      release: tag => `版本 ${tag}`,
