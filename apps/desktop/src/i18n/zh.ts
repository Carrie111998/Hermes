...
export const zh: Translations = {
  ...
  composer: {
    ...
    commandDescs: {
      ...
      '/approve': '批准待处理的高危命令',
      '/background': '在后台运行一个 prompt',
      '/battery': '切换状态栏中的彩色电池指示器',
      '/blueprint': '从蓝图模板设置自动化',
      '/branch': '分支当前会话（探索不同路径）',
      '/browser': '管理浏览器 CDP 连接 [connect|disconnect|status]（仅限本地网关）',
      '/bundles': '列出技能捆绑包（一个别名可加载多个技能）',
      '/busy': '控制 Hermes 工作时按 Enter 的行为',
      '/codex-runtime': '切换 Codex app-server 运行时',
      '/commands': '浏览所有命令和技能（分页）',
      '/compress': '压缩对话上下文（加 here [N] 保留最近 N 轮）',
      '/config': '显示当前配置',
      '/context': '上下文窗口详情（用量、压缩统计、吞吐量）',
      '/cron': '管理定时任务',
      '/curator': '后台技能维护（状态、运行、置顶、归档）',
      '/debug': '创建调试报告并获取可分享链接',
      '/deny': '拒绝待处理的高危命令',
      '/diff': '显示工作目录中的 git 变更',
      '/egress': '显示 Docker 出口代理状态',
      '/fast': '切换快速模式（OpenAI 优先处理 / Anthropic 快速模式）',
      '/focus': '切换专注视图（仅显示 prompt 和最终回复）',
      '/footer': '切换网关运行时元数据页脚',
      '/goal': '设置跨回合持续执行的静态目标',
      '/handoff': '将会话转接到消息平台（Telegram、Discord 等）',
      '/hatch': '生成新的 petdex 宠物',
      '/history': '显示对话历史',
      '/image': '为下一条 prompt 附加本地图片',
      '/indicator': '选择 TUI 繁忙指示器样式',
      '/init': '从仓库扫描生成 AGENTS.md 项目指令',
      '/insights': '显示用量分析和统计',
      '/journey': '打开学习历程时间线',
      '/kanban': '多配置档协作面板（任务、链接、评论）',
      '/learn': '从目录/URL/聊天/笔记中学习可复用技能',
      ...
      '/platforms': '显示网关/消息平台连接状态',
      '/plugins': '列出已安装的插件及其状态',
      '/profile': '切换活跃的 Hermes 配置档',
      '/prompt': '在外部编辑器中编写下一条 prompt（markdown）',
      '/queue': '将 prompt 排入下一轮',
      '/reasoning': '管理推理强度和显示方式',
      '/redraw': '强制完整重绘 UI',
      '/reload': '重新加载 .env 变量到运行中的会话',
      '/reload-mcp': '从配置重新加载 MCP 服务器',
      '/reload-skills': '重新扫描 skills 目录以发现新增或移除的技能',
      '/restart': '排空活跃运行后优雅重启网关',
      '/retry': '重试上一条用户消息',
      ...
      '/skin': '切换桌面主题或循环到下一个',
      '/snapshot': '创建或恢复配置/状态快照',
      '/start': '响应平台启动心跳',
      '/status': '显示当前会话状态',
      '/statusbar': '切换状态栏',
      '/steer': '在下一个工具调用后引导运行',
      '/stop': '停止运行中的后台进程',
      '/subgoal': '添加或管理当前目标的额外条件',
      '/subscription': '查看 Nous 订阅计划并在浏览器中更改',
      '/suggestions': '审核建议的自动化',
      '/timestamps': '切换消息和 /history 中的时间戳',
      '/title': '重命名当前会话',
      '/tools': '列出或切换 agent 可用的工具',
      '/toolsets': '列出可用工具集',
      '/topic': '启用或查看 Telegram DM 话题会话',
      '/topup': '显示 Nous 余额并管理账单',
      '/undo': '回退 N 个用户回合',
      '/update': '更新 Hermes Agent 到最新版本',
      '/usage': '显示会话 token 用量',
      '/verbose': '循环切换工具进度显示级别',
