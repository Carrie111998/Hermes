...
export const zh: Translations = {
  ...
  statusStack: {
    ...
    coding: {
      ...
      pull: '拉取',
      createBranch: '新建分支',
      createBranchDesc: '从当前 HEAD 创建新分支。',
      renameBranch: '重命名分支',
      renameBranchDesc: (name: string) => `重命名 ${name}。`,
      deleteBranch: '删除分支',
      deleteBranchConfirm: (name: string) => `删除分支 ${name}？此操作无法撤销。`,
      createTag: '新建标签',
      createTagDesc: '在当前 HEAD 创建新标签。',
      deleteTag: '删除标签',
      deleteTagConfirm: (name: string) => `删除标签 ${name}？此操作无法撤销。`,
      stashChanges: '暂存更改',
      stashChangesDesc: '暂存所有未提交的更改。',
      stashMessage: '消息',
      stashMessagePlaceholder: '暂存消息（可选）',
      applyStash: '应用暂存',
      dropStash: '丢弃暂存',
      dropStashConfirm: (id: string) => `丢弃 ${id}？此操作无法撤销。`,
      branchName: '分支名称',
      tagName: '标签名称'
    }
  },
