...
export const zh: Translations = {
  ...
  skills: {
    ...
    files: '文件',
    loadingFiles: '正在加载文件…',
    filesLoadFailed: '技能文件加载失败。',
    binary: '二进制',
    binaryUnsupported: path => `${path} 是二进制文件，无法在文本编辑器中打开。`,
    discardUnsaved: '放弃未保存的更改并切换文件吗？',
    deleteFile: path => `删除 ${path}`,
    deleteFileConfirm: path => `从该技能中删除 ${path}？此操作无法撤销。`,
    fileDeleted: '技能文件已删除',
    edit: '编辑',
    archive: '归档',
