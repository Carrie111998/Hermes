...
export const zh: Translations = {
  ...
  notifications: {
    ...
    voice: {
      ...
      routeAmbiguous: destination => `多个会话匹配“${destination}”。请使用更长的标题。`,
      routeFailed: title => `无法发送到“${title}”`,
      routeInvalidSyntax: '请用“and”或停顿分隔会话标题和请求。',
      routeMissingPrompt: destination => `请说出要发送到“${destination}”的内容。`,
      routeNotFound: destination => `未找到匹配“${destination}”的会话。请尝试完整标题。`,
      routedToSession: title => `已发送到“${title}”。`,
      routeUnavailable: '会话路由尚未就绪。请重试。',
