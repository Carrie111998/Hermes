...
export const zh: Translations = {
  ...
  profiles: {
    ...
    avatarRemoved: '头像已移除',
    avatarUploading: '上传中…',
    avatarUploadBatch: '批量上传头像',
    avatarUploadBatchProgress: (done, total) => `上传中 ${done}/${total}…`,
    avatarClickToEnlarge: '点击放大查看',
    avatarClosePreview: '关闭',
    avatarInvalidType: '请使用 PNG、JPG、WEBP 或 GIF 格式图片。',
