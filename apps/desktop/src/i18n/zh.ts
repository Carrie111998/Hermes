...
export const zh: Translations = {
  ...
  settings: {
    ...
    appearance: {
      ...
      backgroundDesc: '在对话后方显示 Hermes 插图、单张本地图片或随机轮播文件夹。',
      backgroundHermes: 'Hermes',
      backgroundImage: '图片',
      backgroundFolder: '文件夹',
      backgroundImages: '背景图片',
      backgroundChooseImage: '选择背景图片',
      backgroundChooseFolder: '选择背景文件夹',
      backgroundChoosing: '正在选择…',
      backgroundChange: '更改',
      backgroundRemove: '移除',
      backgroundStrength: '背景强度',
      backgroundInterval: '切换间隔',
      backgroundIntervalLabel: minutes => (minutes < 60 ? `${minutes} 分钟` : `${minutes / 60} 小时`),
      backgroundTruncated: '正在使用此文件夹中前 1,000 张受支持的图片。',
      backgroundProfileNote: profile => `已为 ${profile} 配置文件保存——每个配置文件保留自己的背景。`,
      backgroundErrors: {
        empty: '此文件夹中没有受支持的图片。',
        'invalid-source': '该背景来源无效。',
        missing: '找不到所选背景。',
        unreadable: 'Hermes 无法读取所选背景。',
        unsupported: '请选择 PNG、JPEG、WebP、GIF、BMP 或 AVIF 图片。'
      },
      embedsTitle: '内嵌预览',
      embedsDesc:
