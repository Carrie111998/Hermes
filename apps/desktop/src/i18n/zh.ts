...
export const zh: Translations = {
  ...
  desktop: {
    ...
    botDesktop: {
      title: 'Bot Desktop',
      profile: profile => `配置档案：${profile}`,
      runtime: '运行时',
      wsl: 'WSL + Xvfb',
      docker: 'Docker + Xvfb',
      openStandalone: '打开独立桌面',
      openEmbedded: '在 Hermes 工作区中打开',
      start: '启动桌面',
      starting: '正在启动桌面…',
      stop: '停止桌面',
      refresh: '刷新状态',
      revealWorkspace: '打开工作区',
      running: '运行中',
      notRunning: '未运行',
      unavailable: '不可用',
      viewerTitle: profile => `${profile} Bot Desktop`,
      viewerHint: '每个 Bot 都有独立的 X 显示、浏览器数据和工作区。这是 OS 进程边界，不是虚拟机。',
      startFailed: message => `无法启动 Bot Desktop：${message}`
    },
    handoff: {
      pickPlatform: '选择目标平台',
