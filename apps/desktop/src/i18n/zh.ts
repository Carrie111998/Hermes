...
export const zh: Translations = {
  ...
  shell: {
    ...
    statusbar: {
      ...
      contextUsagePanel: {
        ...
        compressNow: '立即压缩',
        compressNowTitle: '在下一轮对话前压缩此会话',
        compressUnavailable: '请等待当前会话活动结束。',
        keepRecent: '保留最近轮次',
        keepRecentAll: '全部摘要',
        keepRecentTitle: '逐字保留所选最近的用户与 Hermes 对话轮次',
        keepRecentTurns: turns => `${turns} 轮`,
  ...
  desktop: {
    ...
    resumeRetry: '重试',
    compactionGuardTitle: sessionLabel => `正在压缩“${sessionLabel}”`,
    compactionGuardSessionId: sessionId => `会话 ${sessionId}`,
    compactionGuardDescription: 'Hermes 正在总结此聊天中较早的上下文。只有此聊天会暂时锁定；您仍可切换到其他会话。',
    compactionGuardStatus: '在 Hermes 报告压缩完成或失败之前，此处的发送、引导和排队功能均已禁用。您的草稿会被保留。',
    compactionCompleteTitle: '上下文已压缩',
    compactionCompleteMessage: '较早的历史记录已成功总结。现在可以继续此会话。',
    compactionFailedTitle: '上下文压缩失败',
