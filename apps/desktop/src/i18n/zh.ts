...
export const zh: Translations = {
  ...
  assistant: {
    thread: {
      ...
      errorRetryLater: '稍后重试…',
      errorRetryLaterMenu: '稍后重试',
      errorRetryIn1h: '1 小时后',
      errorRetryIn3h: '3 小时后',
      errorRetryIn6h: '6 小时后',
      errorRetryAt: '在指定时间重试',
      errorRetryAtInvalid: '请输入 14:30 这样的时间',
      errorRetryScheduled: when => `将于 ${when} 自动重试`,
      errorRetryCancelScheduled: '取消自动重试',
      errorOpenLogs: '打开日志',
