...
export const zh: Translations = {
  common: {
    ...
    backToBilling: '返回账单',
    plan: '方案',
    paymentAndCredits: '付款与积分',
    usage: '使用量',
    invoices: '发票',
    autoRefillThreshold: '自动充值阈值',
    autoRefillAmount: '自动充值金额',
    customCreditAmount: '自定义积分金额',
    customEndpoints: '自定义端点',
    deleteEndpoint: '删除端点',
    noCustomEndpoints: '无自定义端点',
    addEndpointDesc: '在下方添加一个 OpenAI 兼容端点。',
    dangerZone: '危险区域',
    confirmUninstall: '确认卸载',
    uninstallHermes: '卸载 Hermes',
    mixtureOfAgents: '智能体混合',
    preset: '预设',
    newPreset: '新预设',
    aggregator: '聚合器',
    searchThemes: '搜索你的主题或 VS Code Marketplace…',
    auto: '自动',
    myProfile: '我的配置文件',
    splitRight: '右',
    splitDown: '下',
    ...
    messageInput: '消息…',
    loadingMemoryProviderSettings: '正在加载记忆提供程序设置...',
    askHermes: '向 Hermes 提问…',
    notConnectedReconnect: '未连接 — 打开 Hermes 重新连接',
    sendTo: '发送到',
    loadingEmoji: '正在加载表情…',
    noEmojiFound: '未找到表情。',
    billing: '账单',
