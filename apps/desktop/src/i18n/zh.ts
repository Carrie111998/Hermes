...
export const zh: Translations = {
  ...
  statusStack: {
    ...
    coding: {
      ...
      verification: '验证',
      verificationPassed: '已通过',
      verificationFailed: '失败',
      verificationStale: '已过期',
      verificationUnverified: '未验证',
      verificationUnavailable: '不可用',
      verificationChecking: '检查中',
      verificationCheckingDetail: '正在检查已记录的验证证据',
      verificationNoEvidence: '此会话没有验证记录',
      verificationUnavailableDetail: '验证证据不可用',
      verificationChangesAfterCheck: '此验证后又进行了更改',
      verificationPathsChanged: count => `此验证后有 ${count} 个路径发生更改`,
      verificationExit: code => `退出码 ${code}`,
      verificationFull: '完整',
      verificationTargeted: '定向',
      verificationRun: '验证更改',
      verificationRunAgain: '再次验证',
      verificationPrompt:
        '为当前更改运行适当的验证。根据需要使用仓库的标准测试、lint、类型检查和构建命令。准确报告执行的命令和结果。不要进行无关更改。',
      newBranch: '新建分支',
