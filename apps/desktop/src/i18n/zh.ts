...
export const zh: Translations = {
  ...
  pullRequests: {
    ...
    reviewDecision: '审查决定',
    checks: '检查',
    openGithub: '在 GitHub 上打开',
    copyUrl: '复制 URL',
    back: '返回拉取请求',
    noneCreated: '没有我创建的拉取请求',
    noneReview: '没有等待您审查的内容',
    noneClosed: '没有最近关闭的拉取请求',
    ghMissing: '未找到 GitHub CLI',
    authRequired: '需要 GitHub 身份验证',
    authHint: '运行 `gh auth login`',
    loadFailed: '加载拉取请求失败',
    detailFailed: '加载拉取请求详情失败',
    retry: '重试',
    updated: '更新时间',
    repository: '仓库',
    changedFiles: '更改的文件',
