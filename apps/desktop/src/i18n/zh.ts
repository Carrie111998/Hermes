...
export const zh: Translations = {
  ...
  cron: {
    ...
    scriptTimeoutLabel: '脚本超时（秒）',
    scriptTimeoutPlaceholder: '全局默认值',
    scriptTimeoutHint: '留空使用全局超时；输入 0 可禁用墙钟超时。',
    scriptTimeoutInvalid: '脚本超时必须为 0 或正的有限数。',
    scriptTimeoutUnlimited: '无限制',
