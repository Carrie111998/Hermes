...
export const zh: Translations = {
  ...
  settings: {
    ...
    appearance: {
      ...
      backdropTitle: '聊天背景',
      backdropDesc: '未显示自定义壁纸时使用的淡色雕像图案。',
      introSplashTitle: '开场标识',
      introSplashDesc: '空白对话中显示的字标和提示语。',
      wallpaper: {
        title: '自定义壁纸',
        description: '仅保存在本机，并按配置文件分别设置；导入时会一次性优化图片。',
        choose: '选择图片',
        replace: '更换',
        remove: '移除',
        reset: '重置调节',
        error: '无法加载该图片。请确认它是有效的 JPEG、PNG 或 WebP 文件，且不超过 32 MB。',
        unsupported: '请重启一次 Hermes 以启用壁纸选择器。',
        profileNote: profile => `已在本机为「${profile}」配置文件保存。`,
        preview: '预览',
        previewEffect: '对话效果',
        previewFull: '完整图片',
        visibility: '显示',
        displayMode: '显示方式',
        adaptiveTheme: '壁纸配色',
        adaptiveThemeDesc: '从图片提取强调色和表面色，同时保持文字对比度。',
        adaptiveThemeAnalyzing: '正在分析图片颜色…',
        adaptiveThemeError: '无法从这张图片中提取颜色。',
        paletteMode: '配色方式',
        paletteModes: { auto: '自动提取', manual: '手动指定' },
        paletteManualDesc: '强调色会直接应用；基调会轻量混入界面表面，以保持文字可读性。',
        paletteDominant: '基调',
        paletteAccent: '强调色',
        modes: { fill: '铺满', fit: '适应', tile: '平铺', center: '居中' },
        opacity: '图片浓度',
        blur: '模糊',
        overlay: '阅读遮罩',
        overlayShape: '遮罩形状',
