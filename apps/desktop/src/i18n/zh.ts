...
export const zh: Translations = {
  ...
  skills: {
    collective: {
      ...
      localCandidates: count => `${count} 个本地候选技能`,
      contributionWorkflow: '贡献流程',
      potential: '可共享的技能',
      potentialHelp: '当前版本尚未提交的本地技能。',
      ownerReview: '你的贡献草稿',
      ownerReviewHelp: '仍需你处理的私有草稿和贡献。',
      noDrafts: '没有需要你处理的贡献草稿。',
      ...
      sendPrivateReview: '发送到仅所有者可见的服务器审核',
