...
export const zh: Translations = {
  ...
  agents: {
    ...
    localBoardSubtitle: '本地配置档、Cron 作业和实时委派工作。',
    liveSubagentsTitle: '实时子代理',
    localAgentsTitle: '本地代理',
    localAgentsDesc: '自动发现的 Hermes 配置档',
    loadingLocalAgents: '正在加载本地代理',
    defaultBadge: '默认',
    modelInheritsDefault: '模型继承默认值',
    skillsAndPath: (count, path) => `${count} 个技能 · ${path}`,
    noLocalProfiles: '未找到本地配置档。',
    selectAgent: '选择一个本地代理以检查其检测到的作业。',
    agentDetail: '代理详情',
    loadingAgentJobs: '正在加载代理作业',
    statModel: '模型',
    statSkills: '技能',
    statJobs: '作业',
    statSchedule: '计划',
