...
export const zh: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      restartCurrent: '重启当前后端',
      restartCurrentTitle: '重启当前后端',
      restartCurrentDesc: '重启 Desktop 管理的本地或 SSH 后端。正在执行的任务可能会中断。',
      restartingCurrent: '正在重启后端…',
      restartCurrentSuccess: '后端已重启，Desktop 已重新连接。',
      restartCurrentCancelled: '已取消重启。后端继续运行。',
      restartCurrentRemote: '远程后端不由 Desktop 管理。只能重新连接。',
      restartCurrentOwnershipFailed: '已停止重启：Desktop 无法证明后端归属。未终止任何进程。',
      restartCurrentFailed: '后端重启失败。连接仍可恢复。',
      diagnostics: '诊断',
