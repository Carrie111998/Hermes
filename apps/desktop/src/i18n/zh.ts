...
export const zh: Translations = {
  ...
  settings: {
    ...
    model: {
      ...
      routingTitle: '模型路由',
      routingDesc: '查看处理每个 Hermes 通道的提供商和模型。自动通道使用主模型。',
      routingLaneCount: count => `${count} 个通道`,
      mainLane: '主聊天',
      mainLaneHint: '对话轮次',
      primary: '主要',
      usesMain: '使用主模型',
      dedicated: '专用',
      routingUnavailable: '不可用',
      auxiliaryTitle: '辅助模型',
      ...
      tasks: {
        ...
        triage_specifier: { label: '分流说明', hint: '看板规格细化' },
        kanban_decomposer: { label: '看板拆解', hint: '任务拆解' },
        profile_describer: { label: '资料描述', hint: '资料摘要' },
