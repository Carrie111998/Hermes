...
export const zh: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      linkedDevicesLoading: '正在加载已关联设备…',
      linkedDevicesError: '无法加载已关联设备。',
      linkedDevicesEmpty: '没有已关联设备',
      linkedDevicesEmptyDesc: '从聊天中关联手机后会显示在这里。',
      linkedDevicesDates: (linked, used) => `关联于 ${linked} · 上次使用 ${used}`,
      linkedDevicesRevoke: '撤销',
      linkedDevicesRevoking: '正在撤销…',
      linkedDevicesRevoked: '已撤销关联设备。',
      linkedDevicesRevokeFailed: '无法撤销关联设备。'
    },
    keys: {
  ...
  sidebar: {
    ...
    row: {
      ...
      continueOnPhoneDesc: '用手机扫描二维码即可安全打开此聊天，之后访问时会自动重新连接。',
      continueOnPhonePreparing: '正在检查安全远程访问…',
      continueOnPhoneQrAlt: '此 Hermes 会话的二维码',
      continueOnPhoneExpiresIn: seconds => `代码将在 ${seconds} 秒后过期`,
      continueOnPhoneAvailabilityHint: '请保持 Hermes Desktop 打开，且电脑处于唤醒状态。',
      continueOnPhoneExpiredTitle: '此代码已过期',
      continueOnPhoneExpiredDesc: '准备扫描时请创建新代码。',
      continueOnPhoneNewCode: '创建新代码',
      continueOnPhoneNotConfiguredTitle: '尚未配置远程访问',
      continueOnPhoneNotConfiguredDesc: '请设置支持浏览器登录的 HTTPS 仪表板公共 URL，然后重试。',
      continueOnPhoneInsecureUrlTitle: '远程访问 URL 不安全',
      continueOnPhoneInsecureUrlDesc: '请使用没有嵌入凭据的 HTTPS 仪表板公共 URL。',
      continueOnPhoneUnreachableTitle: '远程访问不可用',
      continueOnPhoneUnreachableDesc: 'Hermes 无法访问仪表板公共 URL。请检查后重试。',
      continueOnPhoneBrowserAuthTitle: '不支持浏览器登录',
