...
export const zh: Translations = {
  ...
  desktop: {
    ...
    slashCommandDescs: {
      '/new': '开始一个新的桌面对话',
      '/branch': '将最新消息分支为新对话',
      '/yolo': '切换 YOLO — 自动批准高风险命令',
      '/wake': '控制桌面唤醒词监听 [on|off|status]',
      '/handoff': '将此会话移交到其他消息平台',
      '/profile': '切换当前使用的 Hermes 配置档案',
      '/skin': '切换桌面主题，或循环到下一个主题',
      '/title': '重命名当前会话',
      '/help': '显示桌面斜杠命令',
      '/browser': '管理浏览器 CDP 连接 [connect|disconnect|status]（仅限本地网关）',
      '/journey': '打开记忆图谱 — 随时间演进的技能与记忆',
      '/model': '切换此会话使用的模型',
      '/resume': '恢复已保存的会话',
      '/approvals': '查看或设置审批模式 [manual|smart|off]',
      '/agents': '显示活跃的桌面会话与正在运行的任务',
      '/background': '在后台运行一个提示词',
      '/compress': '压缩当前对话上下文',
      '/debug': '创建调试报告',
      '/goal': '管理此会话的常驻目标',
      '/loop': '在此会话中按固定间隔重复运行一个提示词',
      '/personality': '切换此会话的人格',
      '/pet': '切换或领养一个 petdex 宠物 (/pet, /pet list, /pet boba)',
      '/hatch': '生成一个新宠物（打开宠物生成器）',
      '/queue': '将提示词加入下一轮队列',
      '/retry': '重试最后一条用户消息',
