  ...
  preview: {
    ...
    web: {
      ...
      annotation: {
        ...
        iframeBlocked: '无法标注嵌入式跨域内容',
        pickerFailed: '无法在此页面启动标注',
        sentToComposer: '标注已添加到输入框',
        sessionTitle: (count: number) => `标注中 · ${count} 处`,
        finishSession: '完成',
        cancelSession: '取消',
        add: '添加',
        discard: '放弃',
        navigatedAway: '页面已跳转 — 标注模式结束',
        navigatedAwaySubmitted: '页面已跳转 — 已收集的标注已添加到输入框',
        brushTitle: (count: number) => `画笔标注 · ${count} 笔`,
        ...
        imageSaveFailed: '保存标注图片失败',
        screenshotsAttached: (count: number) => `${count} 张截图已作为图片附件添加`,
        locate: '在页面上定位',
        remove: '移除此标注'
      }
    }
