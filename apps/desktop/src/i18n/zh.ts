...
export const zh: Translations = {
  ...
  composer: {
    ...
    rewritePrompt: '重写提示词',
    rewritingPrompt: '正在重写提示词…',
    rewriteBasic: '基础重写',
    rewriteBasicDesc: '在不扩大范围的前提下改善清晰度和语法。',
    rewriteBrief: '简要扩展',
    rewriteBriefDesc: '仅补充使任务可执行所需的关键内容。',
    rewriteDetailed: '详细扩展',
    rewriteDetailedDesc: '生成包含测试和验收标准的可实施规范。',
    rewriteEnhance: '增强',
    rewriteEnhanceDesc: '添加相关工程考虑，并在可用时使用检测到的项目上下文。',
    rewriteFailed: '无法重写提示词',
    rewriteDraftChanged: '重写期间草稿已更改，因此保留了当前内容。',
    tipPre: '提示：输入 ',
    tipPost: ' 以内联引用文件。',
    snippetsTitle: '提示词片段',
