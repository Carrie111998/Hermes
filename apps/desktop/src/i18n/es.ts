...
export const es = defineLocale({
  ...
  notifications: {
    ...
    errors: {
      ...
      gatewayAuthFailed: 'Falló la autenticación del gateway — comprueba tu API_SERVER_KEY.',
      methodNotAllowed:
  ...
  settings: {
    ...
    plugins: {
      ...
      blurb:
        'Extensiones de la interfaz cargadas en esta app: incluidas en la compilación o colocadas en la carpeta desktop-plugins, también las que escribe Hermes. Al desactivar un plugin, se descarga al instante y permanece desactivado tras reiniciar.',
    ...
    fieldLabels: defineFieldCopy({
      ...
      'desktop.repoScanRoots': 'Carpetas de búsqueda de repositorios',
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      'desktop.repoScanEnabled': 'Busca repositorios Git en carpetas locales para mostrarlos en Proyectos.',
      'desktop.repoScanRoots': 'Carpetas que se buscarán. Déjalo vacío para buscar en tu directorio de inicio.',
      ...
      'tts.xai.language': 'Código del idioma hablado (p. ej., en, pt-BR) o "auto" para detectarlo automáticamente.',
      'tts.xai.speed': 'Velocidad de reproducción. 0.7 = más lento, 1.0 = normal, 1.5 = más rápido.',
      ...
      'tts.xai.bitRate': 'Tasa de bits de MP3 en bps. Solo se aplica cuando el códec es mp3.',
    ...
    toolsets: {
      ...
      nousAuthFailed: 'No se completó el inicio de sesión en Nous Portal',
      ...
      terminalBackend: {
        ...
        needsSetupHint:
          'Puedes seleccionar este backend ahora; los comandos fallarán hasta que termine la configuración.'
      }
    }
  },
  skills: {
  ...
  webhooks: {
    ...
    toggleFailed: name => `No se pudo actualizar "${name}"`,
  ...
  install: {
    ...
    probeError: 'No se pudo acceder a ese gateway de Hermes.',
    identityProvider: 'tu proveedor de identidad',
    authTitle: 'Autenticación',
  ...
  shell: {
    ...
    statusbar: {
      ...
      connectionCloudTooltip: host => `Conectado a Hermes Cloud en ${host} · haz clic para gestionar`,
      connectionSshTooltip: host => `Conectado por SSH a ${host} · haz clic para gestionar`,
      connectionRemoteTooltip: host => `Conectado al backend remoto ${host} · haz clic para gestionar`,
  ...
  zones: {
    ...
    split: dir => `Dividir hacia ${dir}`,
    move: dir => `Mover hacia ${dir}`,
    dirUp: 'arriba',
    dirDown: 'abajo',
    dirLeft: 'la izquierda',
    dirRight: 'la derecha',
    pluginDisabled: pluginId => `Plugin "${pluginId}" desactivado`,
    pluginDisabledBody: 'Vuelve a activarlo en Configuración → Plugins para recuperar el panel.',
    missingPane: paneId => `Falta el panel: ${paneId}`,
    editTitle: 'Diseños',
    editHint: 'Elige un diseño o arrastra paneles entre zonas. Haz clic derecho en una zona para dividirla.',
    reset: 'Restablecer',
