import { FIELD_DESCRIPTIONS_ES, FIELD_LABELS_ES } from '@/app/settings/constants'
...
export const es: Translations = defineLocale({
  ...
  keybinds: {
    ...
    actions: {
      ...
      'session.archive': 'Archivar sesión actual',
      ...
      'hud.snapToPointer': 'Mover el HUD al puntero (global, mientras el HUD está abierto)',
  ...
  settings: {
    ...
    plugins: {
      ...
      unavailable: 'Los plugins de escritorio no están disponibles',
      couldNotResolveFolder: 'No se pudo resolver la carpeta de plugins',
      couldNotOpenFolder: 'No se pudo abrir la carpeta de plugins',
      backendHomeMissing: 'El backend no informó de su directorio de inicio',
      kinds: {
        bundled: 'incluido',
        disk: 'en disco',
    ...
    appearance: {
      ...
      translucencyGlassDesc:
        'Cristal mate: el escritorio se ve a través como un desenfoque suave mientras el texto se mantiene nítido. Solo macOS.',
      translucencyModeClear: 'Claro',
      ...
      translucencyScope: {
        window: 'Ventana completa',
        sidebar: 'Solo barra lateral'
      },
    ...
    about: {
      ...
      bundleOutOfSyncDesc:
        'El runtime de Hermes se actualizó, pero la app de escritorio sigue siendo una compilación antigua — faltarán funciones nuevas de interfaz (como el Modo Bot) hasta que se actualice. Ejecuta la actualización de abajo para reconstruir la app. Si la advertencia no desaparece, reinstala desde el último instalador de escritorio.',
    ...
    connections: {
      ...
      headerRemove: 'Quitar',
      duplicateLocal: 'Esta app ya gestiona una conexión local — solo puede haber una.',
      duplicateUrl: label => `Ya existe una conexión a esta URL de gateway («${label}»).`,
      duplicateSsh: label => `Ya existe una conexión a este host SSH («${label}»).`,
      sameBackendHint: label => `Mismo backend que «${label}»`,
      localAddHint: 'Local no está disponible: la conexión local gestionada ya existe (solo hay una).',
      cloudAddHint:
        'Consejo: iniciar sesión en Hermes Cloud arriba descubre tus agentes automáticamente — usa este formulario solo para registrar manualmente la URL de una instancia conocida.',
    ...
    memory: {
      ...
      oauthSet: 'oauth establecido',
      waitingConsent: 'Esperando consentimiento del navegador…',
      cancel: 'Cancelar',
      couldNotStart: 'No se pudo iniciar la conexión.',
      startFailed: 'Error al iniciar la conexión',
      timedOut: 'Tiempo agotado — inténtalo de nuevo.',
      connectionFailed: 'Falló la conexión.',
      leaveBlankToKeep: 'Déjalo en blanco para conservar el valor actual',
      set: 'establecido',
      about: label => `Acerca de ${label}`,
      saved: label => `${label} guardado`,
      configUpdated: 'Configuración del proveedor de memoria actualizada.',
      saveSettingsFailed: label => `Error al guardar la configuración de ${label}`,
      fullConfigTitle: label => `${label} — configuración completa`,
      fullConfigDesc: (label, profile) =>
        `Cada opción de ${label} para el perfil ${profile}. Los campos en blanco usan el host resuelto o el valor predeterminado integrado.`,
      configReference: label => `Referencia de configuración de ${label}`,
      saveChanges: 'Guardar cambios',
      loadFailed: 'Error al cargar la configuración del proveedor de memoria',
      retry: 'Reintentar',
      loading: 'Cargando la configuración del proveedor de memoria...',
      settingsFor: label => `Configuración de ${label}`,
      setPill: label => `${label} establecido`,
      notSetPill: label => `${label} no establecido`,
      fullConfig: 'Configuración completa…',
      saveFieldFailed: label => `Error al guardar ${label}`
    },
    customEndpoints: {
      title: 'Endpoints personalizados',
      emptyTitle: 'No hay endpoints personalizados',
      emptyDesc: 'Añade un endpoint compatible con OpenAI abajo.',
      active: 'Activo',
      use: 'Usar',
      ...
      context: 'Contexto',
      apiKey: 'Clave API',
      useForNewChats: 'Usar para chats nuevos',
      discoverModels: 'Descubrir modelos',
      test: 'Probar',
      save: 'Guardar',
      saved: 'Endpoint personalizado guardado.',
      apiKeySet: 'Clave API establecida',
      optional: 'Opcional',
      leaveBlankToKeep: 'Déjalo en blanco para conservar la clave actual',
      loadFailed: 'No se pudieron cargar los endpoints personalizados',
      saveFailed: 'Error al guardar',
      validationFailed: 'Falló la validación del endpoint.',
      validationFailedTitle: 'Error de validación',
      reachable: 'El endpoint es accesible.',
      reachableFound: count => `El endpoint es accesible. Se encontraron ${count} modelos.`,
      activationFailed: 'Error al activar',
      deleteFailed: 'Error al eliminar'
    },
    computerUse: {
      platformNoteLinux: 'Controla tu escritorio mediante la pila de accesibilidad X11/XWayland — sin solicitud de permisos.',
      platformNoteWindows:
        'La primera ejecución puede mostrar un aviso de Windows SmartScreen para el worker UIAccess de cua-driver — permítelo.',
      granted: 'Concedido',
      notGranted: 'No concedido',
      unknown: 'Desconocido',
      readStatusFailed: 'No se pudo leer el estado de Computer Use',
      requestPermissionsFailed: 'No se pudieron solicitar permisos',
      approveTitle: 'Aprobar en Ajustes del Sistema',
      approveMessage: 'macOS mostrará un diálogo de permisos atribuido a CuaDriver. Apruébalo y luego vuelve aquí.',
      checking: 'Comprobando el estado de Computer Use…',
      unsupported: platform => `Computer Use no es compatible con esta plataforma (${platform}).`,
      installDriver: 'Instala el backend cua-driver abajo para controlar esta máquina.',
      installDriverThenGrant: ' Luego concede Accesibilidad y Grabación de pantalla aquí.',
      grantsAttach:
        'Los permisos se asocian a la identidad propia de CuaDriver (com.trycua.driver), no a Hermes — por eso el diálogo se atribuye al proceso que controla tu Mac.',
      recheck: 'Volver a comprobar',
      accessibility: 'Accesibilidad',
      accessibilityHint: 'Permite que cua-driver envíe clics y teclas, y lea el árbol de accesibilidad.',
      screenRecording: 'Grabación de pantalla',
      screenRecordingHint: 'Permite que cua-driver capture capturas de pantalla de las ventanas de las apps.',
      driverHealth: 'Salud del driver',
      ready: 'Listo',
      notReady: 'No listo',
      readyMessage: 'Computer Use está listo. Pídele al agente que capture una app y haga clic por ti.',
      waitingApproval: 'Esperando aprobación…',
      grantPermissions: 'Conceder permisos'
    },
    uninstall: {
      dangerZone: 'Zona de peligro',
      checking: 'Comprobando qué está instalado…',
      confirmTitle: 'Confirmar desinstalación',
      confirmDesc: consequence => `Esto elimina ${consequence}. No se puede deshacer.`,
      appPath: path => `App: ${path}`,
      uninstalling: 'Desinstalando…',
      yesUninstall: 'Sí, desinstalar',
      cancel: 'Cancelar',
      title: 'Desinstalar Hermes',
      intro: 'Elige cuánto eliminar. La app se cierra para terminar el trabajo; reabre el instalador cuando quieras volver.',
      guiTitle: 'Desinstalar solo la GUI de Chat',
      guiDesc: 'Elimina esta app de escritorio. El agente de Hermes, tu configuración y los chats se conservan.',
      guiConsequence: 'la GUI de Chat de escritorio (esta app y sus datos)',
      liteTitle: 'Desinstalar GUI + agente, conservar mis datos',
      liteDesc: 'Elimina la app y el agente de Hermes, pero conserva la configuración, los chats y los secretos para una futura reinstalación.',
      liteConsequence: 'la GUI de Chat y el agente de Hermes (se conservan configuración, chats y secretos)',
      fullTitle: 'Desinstalar todo',
      fullDesc: 'Elimina la app, el agente y todos los datos del usuario — configuración, chats, trabajos programados, secretos, registros.',
      fullConsequence: 'TODO — la GUI de Chat, el agente de Hermes y toda tu configuración, chats, secretos y registros',
      couldNotStart: 'No se pudo iniciar la desinstalación.'
    },
    billingPlans: {
      checkingChange: 'Comprobando este cambio…',
      cannotMakeHere: 'Ese cambio no se puede hacer aquí.',
      cannotScheduleHere: 'Este cambio no se puede programar aquí.',
      alreadyOn: name => `Ya estás en ${name} — no hay nada que cambiar.`,
      changeTo: (name, date) =>
        `Cambio a ${name} — tendrá efecto el ${date}. Sin cargo ahora; mantienes tu plan actual hasta entonces.`,
      monthlyCreditsChange: delta => ` Cambio mensual de créditos: ${delta}.`,
      tryAgain: 'Reintentar',
      ...
      plans: 'Planes',
      noPlansAvailable: 'No hay planes disponibles para cambiar ahora mismo.'
    },
    billing: {
      billing: 'Facturación',
      plan: 'Plan',
      ...
      differentCard: 'una tarjeta distinta',
      planValue: (tier, price) => `${tier} · ${price}/mes`,
      ...
      creditsPerMonth: credits => `$${credits} créditos/mes`,
      connectTitle: 'Conecta tu cuenta de Nous',
      connectMessage:
        'Ejecuta /portal en la TUI o abre el portal de Nous para conectar tu cuenta.',
      noCardTitle: 'No hay método de pago registrado',
      noCardMessage:
        'La compra de créditos de recarga y la recarga automática siguen desactivados hasta que haya una tarjeta registrada. Añade una en el portal.',
      paymentMethod: 'Método de pago',
      paymentMethodDesc: 'Gestiona la tarjeta usada para las recargas y renovaciones de la suscripción.',
      buyCreditsNow: 'Comprar créditos ahora',
      buyCreditsDesc: 'Un cargo único en tu tarjeta, añadido a tu saldo hoy.',
      refillWhenLow: 'Recargar cuando esté bajo',
      refillManageDesc: 'Gestiona la recarga automática desde el portal.',
      refillTurnOn: 'Activa la recarga automática desde el portal',
      refillCharges: card => `La recarga automática cobra a ${card} — reconcíliala en el portal`,
      refillChargesConfigured: (reloadTo, threshold) =>
        `Cobra ${reloadTo} automáticamente cuando tu saldo baje de ${threshold}.`,
      refillKeepTopped: 'Mantén tu saldo cargado cuando baje de tu umbral.',
      subscriptionUnavailable:
        'Los detalles de la suscripción no están disponibles; abrir el portal sigue disponible.',
      noSubscription: 'Sin suscripción activa — los modelos de pago descuentan créditos de recarga.',
      planCancelsOn: date => `Se cancela el ${date}.`,
      planChangesTo: (tier, date) => `Cambia a ${tier} el ${date}.`,
      planRenews: date => `Se renueva el ${date}`,
      subCredits: 'Créditos de suscripción',
      subCreditsRemaining: 'Créditos de suscripción restantes',
      subResets: date => `Se reinicia el ${date}`,
      subLeft: (remaining, monthly) => `${remaining} de ${monthly} restantes`,
      subOver: (remaining, monthly, over) => `${remaining} de ${monthly} restantes · ${over} de exceso`,
      topupCredits: 'Créditos de recarga',
      topupNoExpire: 'No caducan',
      monthlyCap: 'Límite de gasto mensual',
      monthlyCapUsed: 'Límite de gasto mensual usado',
      monthlyCapUsedOf: (spent, limit) => `${spent} de ${limit} usado`,
      capDefault: 'Límite por defecto',
      capCustom: 'Gasto remoto mensual',
      usageFallback: label => `uso de ${label}`,
      processingSettlement: 'Procesando… comprobando liquidación',
      addedRefreshing: amount => `${amount} añadidos. El saldo se está actualizando.`,
      openPortalLabel: 'Abrir portal',
      retry: 'Reintentar',
      customCreditAmount: 'Importe personalizado de créditos',
      billingPreviewFixture: 'Fixture de vista previa de facturación (solo desarrollo)',
      preview: 'vista previa',
      live: 'en vivo',
      provenanceAutoRefill: 'tarjeta de recarga automática',
      provenanceCustomerDefault: 'predeterminada del cliente',
      provenanceSubPin: 'tarjeta de suscripción'
    },
    billingErrors: {
      consentRequiredTitle: 'Se necesita confirmar la tarjeta',
      consentRequiredMessage: 'Confirma esta tarjeta para los cargos en el terminal en el portal',
      insufficientScopeTitle: 'Remote Spending necesita aprobación',
      insufficientScopeMessage:
        'Esto requiere permitir Remote Spending. Inicia una recarga para permitirlo y reintenta.',
      revokedByAdmin: 'Un administrador detuvo el gasto remoto para este terminal.',
      revokedByUser: 'Detuviste el gasto remoto para este terminal.',
      revokedTitle: 'El gasto remoto se detuvo',
      revokedMessage: who => `${who} Reconecta desde Configuración → Gateway para reautorizar este dispositivo.`,
      sessionRevokedTitle: 'Sesión cerrada',
      sessionRevokedMessage: 'Tu sesión se cerró. Inicia sesión de nuevo desde Configuración → Gateway.',
      spendingOffTitle: 'El gasto remoto está desactivado',
      spendingOffMessage:
      ...
      roleRequiredTitle: 'Se necesita rol de administrador',
      roleRequiredMessage: 'Añadir fondos requiere un admin/owner de la organización. Pídele a un admin o gestiona en el portal.',
      idempotencyConflictTitle: 'Inicia una recarga nueva',
      idempotencyConflictMessage:
        '🔴 Esa clave de cargo ya se usó para un importe distinto. Inicia una recarga nueva.',
      noPaymentMethodTitle: 'No hay tarjeta guardada',
      noPaymentMethodMessage:
        '💳 Aún no hay tarjeta guardada para cargos en el terminal. Configura una en el portal (las compras de crédito de un solo uso no guardan una tarjeta reutilizable).',
      orgAccessDeniedTitle: 'Acceso a la organización denegado',
      orgAccessDeniedMessage: 'Este token no está vinculado a una organización que puedas gestionar',
      monthlyCapReachedTitle: 'Se alcanzó el límite de gasto mensual',
      monthlyCapReachedMessage: '🔴 Se alcanzó el límite de gasto mensual.',
      monthlyCapReachedHeadroom: remaining => `🔴 Se alcanzó el límite de gasto mensual — quedan $${remaining} de margen.`,
      rateLimitedTitle: 'Demasiados cargos ahora mismo',
      rateLimitedMessage: mins =>
        `🟡 Demasiados cargos ahora mismo${mins}. Esto no es un fallo de pago.`,
      stripeUnavailableTitle: 'Stripe está teniendo problemas',
      stripeUnavailableMessage: mins => `Stripe está teniendo problemas — reintenta en un momento${mins}`,
      upgradeCapTitle: 'Se alcanzó el límite diario de cambio de plan',
      upgradeCapMessage: 'Se alcanzó el límite diario de cambio de plan — reintenta mañana',
      endpointUnavailableTitle: 'Endpoint de facturación no disponible',
      endpointUnavailableMessage:
        'El endpoint de facturación devolvió una respuesta no JSON (puede no estar disponible en este despliegue).',
      timeoutTitle: 'La solicitud de facturación caducó',
      timeoutMessage: 'La solicitud de facturación caducó.',
      transportTitle: 'Falló la conexión de facturación',
      transportMessage: 'La solicitud de facturación falló antes de llegar al gateway.',
      genericFailedTitle: 'La solicitud de facturación falló',
      genericFailedMessage: 'La solicitud de facturación falló.',
      retryInMinutes: mins => ` (reintenta en ~${mins} min)`
    },
    billingCharge: {
      creditsAdded: 'Créditos añadidos.',
      amountAdded: amount => `$${amount} añadidos.`,
      failedTitle: 'Falló el cargo',
      unconfirmedTitle: 'Resultado del cargo sin confirmar',
      unconfirmedMessage: refusal =>
        `${refusal} El resultado de tu último cargo no está confirmado; comprueba tu saldo/historial antes de reintentar.`,
      couldNotCheckTitle: 'No se pudo comprobar el cargo',
      couldNotCheckMessage: 'No se pudo comprobar el cargo.',
      noChargeIdMessage:
        'El servicio de facturación aceptó la solicitud pero no devolvió un id de cargo.',
      noChargeIdTitle: 'No se pudo rastrear el cargo',
      timedOutTitle: 'Aún procesando tras 5 minutos',
      timedOutMessage: 'El cargo aún puede liquidarse. Comprueba el portal antes de reintentar.',
      bankVerification:
        'Tu banco requiere verificación (3DS). Complétala en el portal para finalizar esta compra.',
      cardExpired: 'Tu tarjeta ha caducado. Actualízala en el portal.',
      cardDeclined: 'Tu tarjeta fue rechazada. Prueba con otra tarjeta en el portal.',
      genericFailed: reason => `El cargo no se realizó (${reason}).`
    },
    billingStepUp: {
      notApprovedTitle: 'La verificación no fue aprobada',
      notApprovedMessage:
        'La verificación terminó sin permitir Remote Spending para este terminal.',
      completeTitle: 'Verificación completa',
      completeMessage: 'Remote Spending está permitido para este terminal.'
    },
    billingAutoReload: {
      thresholdLabel: 'Umbral',
      thresholdAria: 'Umbral de recarga automática',
      reloadToLabel: 'Recargar hasta',
      reloadToAria: 'Importe de recarga automática',
      updated: 'Recarga automática actualizada.',
      turnedOff: 'Recarga automática desactivada.',
      confirmTurnOff: '¿Desactivar la recarga automática?',
      turnOff: 'Desactivar',
      cancel: 'Cancelar',
      disable: 'Desactivar',
      saving: 'Guardando…',
    ...
    billingAmounts: {
      thresholdLabel: 'Umbral',
      reloadToLabel: 'Recarga hasta',
      mustBeGreater: 'El importe de recarga debe ser mayor que el umbral.',
      enterAmount: label =>
        `${label}: introduce un importe en dólares con como máximo 2 decimales.`,
      greaterThanZero: label => `${label}: el importe debe ser mayor que $0.`,
      minimum: (label, amount) => `${label}: el mínimo es ${amount}.`,
      maximum: (label, amount) => `${label}: el máximo es ${amount}.`
    },
    billingApi: {
      requestFailed: 'La solicitud de facturación falló.'
    },
    providerDescriptions: {
      'Nous Portal': 'Modelos alojados de Hermes y entrenados por Nous',
      'Fireworks AI': 'API de modelos directa compatible con OpenAI',
      OpenRouter: 'Agregador de cientos de modelos de vanguardia',
      Anthropic: 'Acceso a la API de Claude (Sonnet, Opus, Haiku)',
      xAI: 'Modelos Grok (usa OAuth para SuperGrok / Premium+)',
      Gemini: 'Google AI Studio (Gemini 1.5 / 2.0 / 2.5)',
      DeepSeek: 'API directa de DeepSeek (V3.x, R1)',
      'DashScope (Qwen)': 'DashScope de Alibaba Cloud — Qwen y modelos de varios proveedores',
      'GLM / Z.AI': 'Endpoints alojados de Zhipu GLM-4.6 y Z.AI',
      'Kimi / Moonshot': 'Endpoints de código y Kimi K2 de Moonshot',
      'Kimi (China)': 'Endpoint de Moonshot en China',
      MiniMax: 'Endpoints internacionales MiniMax-M2 y Hailuo',
      'MiniMax (China)': 'Endpoint de MiniMax en China continental',
      'Hugging Face': 'Inference Providers — más de 20 modelos abiertos vía router.huggingface.co',
      'OpenCode Zen': 'Acceso de pago por uso a modelos de código seleccionados',
      'OpenCode Go': 'Suscripción de $10/mes para modelos de código abiertos',
      'NVIDIA NIM': 'build.nvidia.com o tu propio endpoint NIM local',
      'Ollama Cloud': 'Modelos abiertos alojados en la nube de ollama.com',
      'LM Studio': 'Servidor local de LM Studio (compatible con OpenAI)',
      StepFun: 'Modelos de código StepFun Step Plan',
      'Xiaomi MiMo': 'MiMo-V2.5 y modelos propietarios de Xiaomi',
      'Arcee AI': 'Modelos pequeños y medianos alojados por Arcee',
      'GMI Cloud': 'GPU y servido de modelos de GMI Cloud',
      'Azure Foundry': 'Endpoints personalizados de Azure AI Foundry (compatibles con OpenAI / Anthropic)',
      'AWS Bedrock': 'Autenticación vía perfil y región de AWS'
    },
    mcp: {
  ...
  profiles: {
    ...
    renameDescSuffix: '.',
    displayNameTitle: 'Nombra este agente',
    displayNameDesc: 'Establece un nombre visible en toda la app. El ID interno del perfil sigue siendo "default".',
