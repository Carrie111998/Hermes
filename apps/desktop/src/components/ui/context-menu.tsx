...
export const ORION_CONTEXT_MENU_TRIGGER_ATTR = 'data-orion-context-menu-trigger'

function ContextMenuTrigger({ ...props }: React.ComponentProps<typeof ContextMenuPrimitive.Trigger>) {
  return (
    <ContextMenuPrimitive.Trigger data-slot="context-menu-trigger" {...props} data-orion-context-menu-trigger="" />
  )
}
