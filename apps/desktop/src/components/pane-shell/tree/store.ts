...
const STORAGE_KEY = 'orion.desktop.layoutTree.v2'

writeKey('orion.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('orion.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('orion.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'orion.desktop.dismissedPanes.v1'
...
const PANE_SHARE_KEY = 'orion.desktop.paneShare.v1'
...
const HIDDEN_STRIP_TAB_KEY = 'orion.desktop.hiddenStripTabs.v1'
...
writeKey('orion.desktop.paneDockHeals.v1', null)
...
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__ORION_LAYOUT_TREE__ = {
    close: closeTreePane,
