...
const FALLBACK_COPY: IntroCopy[] = [
  ...
  {
    headline: 'What should Douglas Agent look at?',
...
function fallbackCopyForPersonality(personalityKey: string): IntroCopy[] {
  ...
  return [
    ...
    {
      headline: `What does ${label} Douglas Agent need to see?`,
    ...
    {
      headline: `What should ${label} Douglas Agent tackle?`,
