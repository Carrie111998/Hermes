...
import type { ModelOptionProvider, OAuthProvider } from '@/types/orion'
...
const API_KEY_OPTIONS: ApiKeyOption[] = [
  ...
  },
  {
    ...
    docsUrl: 'https://github.com/zacharyjleach-stack/Aries#bring-your-own-endpoint',
    placeholder: 'http://127.0.0.1:8000/v1'
  }
]

// Build the FULL API-key provider catalog from the backend model options so the
// onboarding / Providers key form lists every `api_key` provider `orion model`
...
const SHOW_ALL_KEY = 'orion-onboarding-show-all-v1'
