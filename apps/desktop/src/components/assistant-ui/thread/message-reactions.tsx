      ...
      >
        {expanded ? (
          ...
          <>
            ...
            <Button aria-label={t.common.moreEmoji} onClick={() => setExpanded(true)} size="icon-sm" variant="ghost">
              <Plus />
            </Button>
          </>
        )}
    ...
    >
      {reactions.map(reaction =>
        reaction.author === 'user' && onRetract ? (
          <button
            aria-label={t.common.removeReaction(reaction.emoji)}
          ...
          <span
            ...
            key={`${reaction.author}-${reaction.emoji}`}
            title={t.common.reactedByHermes}
          >
            {reaction.emoji}
          </span>
        )
