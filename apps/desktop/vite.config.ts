...
export default defineConfig(({ command }) => ({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\orion\orion-agent\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@orion/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@orion/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@orion/shared': path.resolve(__dirname, '../shared/src'),
