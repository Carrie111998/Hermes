/**
 * Canonical Orion skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$ORION_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`orion_cli/skin_engine.py`),
 ...
 *   • CLI     → `orion_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
