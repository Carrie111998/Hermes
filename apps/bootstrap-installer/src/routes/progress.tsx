...
export default function ProgressScreen({ bootstrap }: ProgressProps) {
  ...
  const title = bootstrap.status === 'completed' ? 'Done' : isUpdate ? 'Updating Orion' : 'Setting up Orion Agent'

  const description = isUpdate
    ? 'Orion is updating to the latest version — this only takes a moment.'
  ...
  return (
    <div className="orion-fade-in flex h-full flex-col">
