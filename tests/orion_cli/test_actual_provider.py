...
from orion_cli import runtime_provider as rp
...
from orion_cli.providers import determine_api_mode
from orion_cli.providers import get_label
from orion_cli.providers import normalize_provider as normalize_overlay_provider
...
def test_actual_profile_fetch_models_normalizes_env_base_url(monkeypatch):
    ...
    monkeypatch.setattr("orion_cli.urllib_security.open_credentialed_url", _open)
