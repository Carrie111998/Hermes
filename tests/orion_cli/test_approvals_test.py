"""Tests for ``orion approvals test`` — dry-run approval verdict CLI.
...
from orion_cli import approvals_test as at
...
class TestOutputAndWiring:
    ...
    def test_dispatcher_routes_test_subcommand(self, isolated_approvals, capsys):
        from orion_cli.approvals_suggest import approvals_command
        args = _args(["ls"])
    ...
    def test_parser_wires_test_subcommand(self, isolated_approvals, capsys):
        from orion_cli.subcommands.approvals import build_approvals_parser
