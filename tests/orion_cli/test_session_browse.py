"""Tests for the interactive session browser (`orion sessions browse`).
...
from orion_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """orion sessions browse should be parseable."""
