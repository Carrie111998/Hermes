"""Tests for orion tools disable/enable/list command (backend)."""
...
class TestToolsDisableBuiltin:
    ...
    def test_disable_removes_toolset_from_platform(self):
        ...
        with patch("orion_cli.tools_config.load_config", return_value=config), \
             patch("orion_cli.tools_config.save_config") as mock_save:
    ...
    try:
        with patch(
            ...
            side_effect=discover_deferred_platform,
             ...
             patch("orion_cli.tools_config.load_config", return_value=config), \
             patch("orion_cli.tools_config.save_config") as save:
