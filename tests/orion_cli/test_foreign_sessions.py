"""Tests for orion_cli.foreign_sessions — Claude Code / Codex CLI import.

Fixture JSONL is synthesized inline (tmp_path); the SessionDB is opened
against a temp path so nothing touches the real ORION_HOME store.
"""
...
from orion_cli.foreign_sessions import (
