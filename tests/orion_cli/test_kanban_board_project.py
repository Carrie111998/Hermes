...
A kanban board can be scoped to a first-class Orion project so every task on
...
def fresh_home(tmp_path, monkeypatch):
    ...
    for var in ("ORION_KANBAN_DB", "ORION_KANBAN_WORKSPACES_ROOT", "ORION_KANBAN_HOME", "ORION_KANBAN_BOARD"):
