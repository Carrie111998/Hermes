...
Every ``CommandDef`` with ``execute`` set must:
  * name a key that exists in :data:`orion_cli.slash_exec.EXECUTORS`, and
...
from orion_cli.commands import COMMAND_REGISTRY, resolve_command
from orion_cli.slash_exec import (
    EXECUTORS,
    CommandContext,
    CommandReply,
    execute_command,
