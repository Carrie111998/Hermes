"""Tests for `orion secrets bitwarden token` / `orion secrets onepassword token`.
...
from orion_cli import onepassword_secrets_cli as op_cli
from orion_cli import secrets_cli as bw_cli
