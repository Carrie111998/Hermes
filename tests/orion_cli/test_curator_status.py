"""Tests for `orion curator status` output.
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated ORION_HOME with real agent-created skills on disk."""
    home = tmp_path / ".orion"
    skills = home / "skills"
    ...
    from orion_cli import curator as curator_cli
...
def test_adopt_subcommand_is_registered():
    ...
    import orion_cli.curator as curator_cli
