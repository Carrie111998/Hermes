"""Tests for the ``orion prompt-size`` diagnostic (issue #34667)."""
...
from orion_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(orion_home, memory_text="", user_text=""):
    mem_dir = orion_home / "memories"
...
def _seed_skill(orion_home, name, description):
    skill_dir = orion_home / "skills" / "demo" / name
