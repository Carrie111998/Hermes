"""Tests for `orion chat --safe-mode` isolation."""
...
_VARS = ("ORION_SAFE_MODE", "ORION_IGNORE_USER_CONFIG", "ORION_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["ORION_SAFE_MODE"] == "1"
        assert os.environ["ORION_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["ORION_IGNORE_RULES"] == "1"
        return True
