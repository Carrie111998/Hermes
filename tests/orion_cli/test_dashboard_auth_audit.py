...
Profile-aware location: ``$ORION_HOME/logs/dashboard-auth.log``.
...
from orion_cli.dashboard_auth.audit import audit_log, AuditEvent


@pytest.fixture
def profile_home(tmp_path, monkeypatch):
    """Redirect $ORION_HOME and ~ to a tmp dir for the duration of the test."""
    home = tmp_path / ".orion"
    home.mkdir()
