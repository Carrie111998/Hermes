...
from orion_cli.commands import (
...
def _isolate_config(monkeypatch, home):
    ...
    monkeypatch.setenv("ORION_MANAGED_DIR", str(home / "missing-managed"))
    from orion_cli import managed_scope
    from orion_cli.config import _LOAD_CONFIG_CACHE, _RAW_CONFIG_CACHE
