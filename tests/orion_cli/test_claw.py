...
from orion_cli import claw as claw_mod
...
class TestFindMigrationScript:
    ...
    def test_finds_project_root_script(self, tmp_path):
        script = tmp_path / "openclaw_to_orion.py"
...
class TestCmdMigrate:
    ...
    def test_full_preset_does_not_enable_secrets_silently(self, tmp_path, capsys):
        ...
        even under the 'full' preset.  This mirrors OpenClaw's migrate-orion
        ...
        fake_mod = ModuleType("openclaw_to_orion")
...
class TestPrintMigrationReport:
    ...
    def test_dry_run_report(self, capsys):
        report = {
            ...
            "items": [
                {"kind": "soul", "status": "migrated", "destination": "/home/user/.orion/SOUL.md"},
                {"kind": "memory", "status": "migrated", "destination": "/home/user/.orion/memories/MEMORY.md"},
