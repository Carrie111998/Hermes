"""Tests for the specifier module + `orion kanban specify` CLI surface.
...
from orion_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `orion kanban …` argparse surface directly."""
