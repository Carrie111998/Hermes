"""Tests for ``orion approvals suggest`` (orion_cli/approvals_suggest.py).

Approval history in Orion is implied, not ledgered: the session DB
...
from orion_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
