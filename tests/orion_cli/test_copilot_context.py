...
class TestGetCopilotModelContext:
    ...
    @patch("orion_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("orion_cli.models._urlopen_model_catalog_request")
    ...
    @patch("orion_cli.models.fetch_github_model_catalog", return_value=[])
