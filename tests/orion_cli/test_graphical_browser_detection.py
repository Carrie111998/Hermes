"""Tests for `_can_open_graphical_browser()` in orion_cli.auth.

Guards the fix for the May 2026 report where `orion auth add xai-oauth`
...
from orion_cli.auth import _can_open_graphical_browser
