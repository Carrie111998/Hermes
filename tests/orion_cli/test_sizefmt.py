"""Tests for the shared byte formatter (orion_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from orion_cli.backup import _format_size as backup
    from orion_cli.checkpoints import _fmt_bytes as checkpoints
    from orion_cli.doctor import _human_bytes as doctor
