...
from orion_cli.dashboard_auth import clear_providers, list_providers
from orion_cli.plugins import PluginManager, discover_plugins
from orion_cli.plugins_cmd import ensure_basic_auth_plugin_enabled_in_config
...
class TestBasicProviderLoadsAfterUnblock:
    def test_disabled_basic_blocks_registration(self, orion_home, monkeypatch):
