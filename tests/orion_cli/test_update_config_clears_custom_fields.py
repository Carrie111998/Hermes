"""Tests for orion_cli.auth._update_config_for_provider clearing stale fields.
...
from orion_cli.auth import _update_config_for_provider
from orion_cli.config import clear_model_endpoint_credentials, get_config_path
