"""Regression: ``orion update`` should take a managed checkout off autocrlf=true.
...
``orion update`` has to repair them.
...
from orion_cli.update_cmd import _normalize_managed_eol
