...
from orion_cli.subcommands.plugins import build_plugins_parser
...
def test_doctor_uses_registration_to_reject_bad_hook_and_callback_signature(
    ...
    from orion_cli.plugin_dev import doctor_plugin
...
def test_doctor_restores_global_tool_policy_and_module_state(tmp_path: Path) -> None:
    ...
    before_modules = {
        ...
        if name == "orion_plugins" or name.startswith("orion_plugins.")
    }
