...
def _run_copilot_switch(
    ...
    with (
        patch("orion_cli.model_switch.resolve_alias", return_value=None),
        patch("orion_cli.model_switch.list_provider_models", return_value=[]),
        patch(
        ...
        patch("orion_cli.model_switch.get_model_info", return_value=None),
        patch("orion_cli.model_switch.get_model_capabilities", return_value=None),
        patch("orion_cli.models.detect_provider_for_model", return_value=None),
    ):
        return switch_model(
            raw_input=raw_input,
