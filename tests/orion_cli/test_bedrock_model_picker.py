...
Covers the three paths changed by fix/bedrock-provider-model-ids-live-discovery:
  ...
  2. list_authenticated_providers() Section 2 (ORION_OVERLAYS) — bedrock
...
# ---------------------------------------------------------------------------
# 2. list_authenticated_providers() — bedrock via ORION_OVERLAYS (Section 2)
# ---------------------------------------------------------------------------
...
class TestBedrockOverlayRegistration:
    """bedrock entry in ORION_OVERLAYS is correctly configured."""

    def test_bedrock_overlay_exists(self):
        from orion_cli.providers import ORION_OVERLAYS
        assert "bedrock" in ORION_OVERLAYS
    ...
    def test_bedrock_aliases_resolve(self):
        from orion_cli.providers import normalize_provider
