"""`orion memory status` should explain *why* a provider is unavailable.

Regression coverage for Orion/orion-agent#2765: when the selected
...
import orion_cli.memory_setup as memory_setup
