...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in ORION_OVERLAYS
        overlay = ORION_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify orion doctor recognizes Xiaomi env vars."""

    def test_provider_env_hints(self):
        from orion_cli.doctor import _PROVIDER_ENV_HINTS
