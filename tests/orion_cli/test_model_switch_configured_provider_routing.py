...
``tests/orion_cli/test_user_providers_model_switch.py``.
"""
...
def _run_switch(
    *,
    ...
    with patch("orion_cli.model_switch.resolve_alias", return_value=None), \
         ...
         patch("orion_cli.model_switch.normalize_model_for_provider", side_effect=lambda model, provider: model), \
         patch("orion_cli.models.validate_requested_model", return_value=validation), \
