...
from orion_cli import gateway as orion_gateway
from orion_cli import gateway_windows
from orion_cli import main as cli_main
from orion_cli import process_identity
...
def test_control_plane_argv_is_not_a_gateway():
    ...
    serve = "C:\\Orion\\.venv\\Scripts\\python.exe -m orion_cli.main serve --host 127.0.0.1"
    run = "C:\\Orion\\.venv\\Scripts\\python.exe -m orion_cli.main gateway run"
...
def test_control_plane_classifier_is_token_based_not_substring():
    ...
    py = "C:\\Orion\\.venv\\Scripts\\python.exe -m orion_cli.main"
...
def test_pause_skips_cold_start_plan_when_desktop_owns_lifecycle(monkeypatch):
    ...
    monkeypatch.setattr(orion_gateway, "find_gateway_pids", lambda **_k: [])
