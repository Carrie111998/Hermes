...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (orion_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_orion_overlays():
    """orion_cli.providers.get_provider("vertex") backs
