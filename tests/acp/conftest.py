...
Keeps the ACP server tests offline: ``OrionACPAgent._build_model_state``
calls ``orion_cli.inventory.build_models_payload``, which (without this
...
def _offline_model_inventory(monkeypatch):
    ...
    import orion_cli.inventory as inventory
