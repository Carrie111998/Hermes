...
def _ensure_redaction_enabled(monkeypatch):
    """Ensure ORION_REDACT_SECRETS is not disabled by prior test imports."""
    monkeypatch.delenv("ORION_REDACT_SECRETS", raising=False)
...
class TestTerminalOutputRedaction:
    ...
    def test_command_reads_env_file_detection(self):
        ...
        # With paths
        assert _command_reads_env_file("cat ~/.orion/.env")
