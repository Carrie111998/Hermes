...
def test_normalize_lang_accepts_supported():
    ...
    assert i18n._normalize_lang("vi") == "vi"
...
def test_normalize_lang_accepts_aliases():
    ...
    assert i18n._normalize_lang("Vietnamese") == "vi"
    assert i18n._normalize_lang("Tiếng Việt") == "vi"
    assert i18n._normalize_lang("vi-VN") == "vi"
...
def test_t_explicit_lang():
    ...
    assert i18n.t("approval.denied", lang="vi").endswith("Từ chối")
