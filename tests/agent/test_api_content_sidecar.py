...
class TestMaxIterationsSummaryReplay:
    def test_iteration_boundary_is_mechanical_and_does_not_replay_sidecars(self):
        """The hard boundary must not synthesize another model turn."""
        from run_agent import AIAgent
        ...
        assert out.startswith("[RUNTIME BOUNDARY RECEIPT — NOT MODEL-AUTHORED]")
        assert captured == {}
