...
def _isolate_macos_keychain(monkeypatch):
    """Keep these adapter tests independent of the developer's Keychain.

    Keychain behavior has its own test module with mocked ``security`` command
    responses. This module exercises file, environment, pool, and refresh
    precedence instead.
    """
    monkeypatch.setattr(
