...
to a generic "Your API key was rejected... run orion setup" message, which is
...
def test_nous_401_guidance_strings_present():
    ...
    # Must give a concrete re-auth command, not a generic "orion setup".
    assert "orion portal" in source
