...
thinking phase.  Orion's default cloud-stream stale detector
(``ORION_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``ORION_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
