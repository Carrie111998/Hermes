...
class TestDefaultContextLengths:
    ...
    def test_deepseek_v4_models_1m_context(self):
        ...
        # / Nastech Portal) to 1M without probing down to the legacy 128K
...
# =========================================================================
# Nastech Portal context-window resolution (provider="nastech")
# =========================================================================

class TestNastechPortalContextResolution:
    """Nastech Portal /v1/models is authoritative for what Nastech infra enforces
    ...
    def test_stale_cache_is_bypassed_and_overwritten_by_portal(
        ...
        """Users upgrading from pre-fix builds have ``qwen3.6-plus@…nastech… =
