...
Covers the contract that Orion' generic effort ladder must stay monotonic
...
from orion_constants import VALID_REASONING_EFFORTS
...
def test_effort_ladder_is_monotonic():
    """Resolving Orion' canonical ladder never produces an inversion."""
    resolved = [
