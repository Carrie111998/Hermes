...
- All nine bundled plugins (bing-browser, brave-free, ddgs, searxng, exa,
...
class TestBundledPluginsRegister:
    ...
    @pytest.mark.parametrize(
        "plugin_name",
        ["bing-browser", "brave-free", "ddgs", "searxng", "exa", "parallel", "tavily", "firecrawl", "xai"],
    )
