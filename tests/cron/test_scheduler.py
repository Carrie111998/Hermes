    ...
    def test_fresh_loop_rejection_does_not_leak_coroutine(
        ...
        if reject_submit:
            ...
            def run_worker(timeout):
                ...
                # The worker is submitted either bare or wrapped in a copied
                # contextvars.Context (#100489 profile propagation).
        ...
        with warnings.catch_warnings(record=True) as caught:
            ...
            # The worker callable is submitted either bare or wrapped in a
            # copied contextvars.Context (#100489 profile propagation).
