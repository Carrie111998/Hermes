...
class TestCronFilePermissions(unittest.TestCase):
    ...
    def test_ensure_dirs_sets_0700(self):
        # cron.jobs resolves paths dynamically from HERMES_HOME; point it at the
        # temp dir so ensure_dirs() creates <tmp>/cron and <tmp>/cron/output.
    ...
    def test_save_job_output_sets_0600(self):
        # Dynamic resolution: output lands under <HERMES_HOME>/cron/output.
