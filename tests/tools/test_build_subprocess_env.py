...
def test_e2e_child_sees_orion_home_and_no_planted_secret(tmp_path, monkeypatch):
    """A real child spawned with a factory-built env must see ORION_HOME
    ...
    code = (
        "import os, json; "
        "print(json.dumps({'home': os.environ.get('ORION_HOME'), "
    ...
    assert result["home"] == str(orion_home)
