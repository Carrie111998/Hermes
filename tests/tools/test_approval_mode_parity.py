...
CASES = [
    pytest.param(None, "manual", 300, id="unset-defaults"),
    pytest.param(
...
def test_tui_loader_delegates_to_core(hermes_home, tui_server):
    ...
    with patch.object(approval_mod, "_get_approval_mode", return_value="smart"):
        # Smart mode is retired at the surface boundary; even a stale core
        # value is clamped to owner-driven manual approval.
