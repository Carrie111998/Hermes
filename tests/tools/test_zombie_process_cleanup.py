...
class TestDelegationCleanup:
    ...
    def test_run_single_child_calls_close(self, monkeypatch, tmp_path):
        ...
        from orion_cli.observability import relay_runtime
        ...
        def run_conversation(**_kwargs):
            observed["orion_home"] = get_orion_home()
        ...
        token = set_orion_home_override(profile_home)
        try:
        ...
        assert observed["orion_home"] == profile_home
    ...
    def test_timed_out_child_keeps_relay_session_until_its_turn_exits(
        ...
        profile_token = set_orion_home_override(profile_home)
        ...
        try:
            ...
            release_child.set()
            reset_orion_home_override(profile_token)
            relay_runtime._reset_for_tests()
