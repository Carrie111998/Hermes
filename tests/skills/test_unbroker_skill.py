...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and orion-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # orion-agent (tests/skills/)
]
