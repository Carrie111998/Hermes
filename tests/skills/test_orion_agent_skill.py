"""The `orion-agent` skill is what a running Orion knows about itself.

`website/` is never packaged, so an installed Orion has no local copy of the
user guide; skills ARE synced into `$ORION_HOME/skills/`. The skill therefore
...
shipped feature is invisible and the agent answers "Orion can't do that."
"""
...
SKILL_DIR = REPO / "skills" / "autonomous-ai-agents" / "orion-agent"
