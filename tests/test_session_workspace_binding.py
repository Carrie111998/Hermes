"""Session <-> workspace grouping key (orion_state.workspace_key).

The key is what `orion sessions list --workspace` groups/filters on. It is a
...
from orion_state import workspace_key
