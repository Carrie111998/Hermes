...
class TestReadChain:
    ...
    def test_reads_new_list_format(self):
        ...
        cfg = {
            "fallback_providers": [
                ...
                {"provider": "nous", "model": "Charterforge-4-Llama-3.1-405B"},
            ]
        }
    ...
    def test_merges_new_and_legacy_formats(self):
        ...
        cfg = {
            ...
            "fallback_model": {"provider": "nous", "model": "Charterforge-4"},
        }
        assert _read_chain(cfg) == [
            {"provider": "openrouter", "model": "anthropic/claude-sonnet-4.6"},
            {"provider": "nous", "model": "Charterforge-4"},
        ]
...
class TestRemoveCommand:
    ...
    def test_remove_selected_entry(self, isolated_home, capsys):
        ...
        # Picker returns index 1 (the middle entry, "nous / Charterforge-4")
