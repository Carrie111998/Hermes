...
class TestProfileRestoration:
    ...
    def test_import_creates_profile_wrappers(self, tmp_path, monkeypatch):
        ...
        coder_path = wrapper_dir / f"coder{wrapper_suffix}"
        researcher_path = wrapper_dir / f"researcher{wrapper_suffix}"
        assert coder_path.exists()
        assert researcher_path.exists()

        # Wrappers should contain the right content
        coder_wrapper = coder_path.read_text()
