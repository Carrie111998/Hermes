...
if sys.platform != "win32":
    # Unix-only module. A bare top-level ``import pty`` raises at collection
    # time on Windows and aborts the ENTIRE tests/ tree (same failure mode as
    # the old test_curses_color_compat.py ``import curses``); the sole
    # consumer is already skipif-guarded for win32.
    import pty
