...
def test_seed_supervise_skeleton_creates_expected_layout(
    ...
    # Exercise the ownership/mode contract with an identity the test process
    # can actually assign. macOS tmp dirs may inherit group 0, which causes
    # the kernel to strip setgid from an unprivileged chmod.
