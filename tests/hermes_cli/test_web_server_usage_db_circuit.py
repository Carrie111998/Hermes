...
def test_corrupt_usage_db_fails_closed_and_opens_circuit(
    ...
    monkeypatch.setattr(web_server, "_usage_db_circuit", {})
    monkeypatch.setattr(web_server, "_usage_db_last_error_log", {})
    log_calls = []
    monkeypatch.setattr(
        web_server._log,
        "error",
    ...
    real_get_usage = web_server._get_usage_analytics
    db_attempts = []
    ...
    monkeypatch.setattr(web_server, "_get_usage_analytics", counted_get_usage)
