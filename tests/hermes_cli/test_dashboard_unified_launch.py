...
class TestUnifiedDashboardRouting:
    ...
    def test_surface_probe_recognizes_pre_webapp_hermes_as_dashboard(self, main_mod, monkeypatch):
        ...
        assert main_mod._dashboard_surface_at("127.0.0.1", 9119) == "dashboard"
        ...
        assert main_mod._dashboard_surface_at("127.0.0.1", 9119) is None
    ...
    def test_profile_launch_reexecs_machine_dashboard(self, main_mod, monkeypatch):
        ...
        monkeypatch.setattr(main_mod, "_dashboard_surface_at", lambda host, port: None)
        execs = []
