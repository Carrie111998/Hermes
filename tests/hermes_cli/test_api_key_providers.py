...
class TestResolveProvider:
    ...
    def test_alias_kiro_acp(self):
        ...
        assert resolve_provider("kiro-agent") == "kiro-acp"
...
class TestRuntimeProviderResolution:
    ...
    def test_runtime_kiro_acp_uses_kiro_process_runtime(self, monkeypatch):
        ...
        def boom(*_a, **_k):
            raise AssertionError("credential pool must not run for kiro-acp")

        monkeypatch.setattr("hermes_cli.runtime_provider.load_pool", boom)
        from hermes_cli.runtime_provider import resolve_runtime_provider
