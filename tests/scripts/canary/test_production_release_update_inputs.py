...
def _signed_update(
    ...
    _plan, _approval, publication = v4_test._release_update_documents(
        fixture.private,
        fixture.trusted,
        fixture.payload,
        fixture.unit_publication,
        overrides=overrides,
    )
    return publication
...
def _fixture() -> Fixture:
    ...
    payload = v4_test._payload()
    unit_plan, unit_approval, unit_publication = (
        v4_test._unit_documents(private, trusted, payload)
    )
    host_receipt = dict(
