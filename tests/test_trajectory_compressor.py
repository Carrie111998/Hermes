...
def test_import_loads_env_from_orion_home(tmp_path, monkeypatch):
    home = tmp_path / ".orion"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-orion-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-orion-home"
