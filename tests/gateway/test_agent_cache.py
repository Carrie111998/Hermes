...
class TestExtractCacheBustingConfig:
    ...
    def test_honcho_cache_busting_config_memoized_by_content_and_host(
        self,
        monkeypatch,
        tmp_path,
    ):
        ...
        class FakeConfig:
            ...
            @classmethod
            def from_global_config(cls, config_path=None, host=None):
                parse_calls.append((config_path, host))
                return cls()
        ...
        assert parse_calls == [(config_path, "hermes")]
