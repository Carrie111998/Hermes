...
def store(tmp_path, monkeypatch):
    ...
    ~/.orion/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at orion_state import time, before pytest's ORION_HOME monkeypatch
    fires — the autouse fixture's ORION_HOME override doesn't help here.)
    """
    import orion_state
