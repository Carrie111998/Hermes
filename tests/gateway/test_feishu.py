...
class TestAdapterBehavior(unittest.TestCase):
    ...
    @patch.dict(os.environ, {**PLATFORM_ENV, "FEISHU_GROUP_POLICY": "open"}, clear=True)
    ...
    @patch.dict(os.environ, {**PLATFORM_ENV, "FEISHU_VERIFICATION_TOKEN": "expected-token"}, clear=True)
...
class TestHydrateBotIdentity(unittest.TestCase):
    ...
    @patch.dict(os.environ, {**PLATFORM_ENV, "FEISHU_BOT_OPEN_ID": "ou_env"}, clear=True)
...
class TestWebhookSecurity(unittest.TestCase):
    ...
    def _make_adapter(self, encrypt_key: str = "") -> "FeishuAdapter":
        ...
        with patch.dict(os.environ, {**PLATFORM_ENV, "FEISHU_APP_ID": "cli", "FEISHU_APP_SECRET": "sec", "FEISHU_ENCRYPT_KEY": encrypt_key}, clear=True):
            return FeishuAdapter(PlatformConfig())
    ...
    @patch.dict(os.environ, {**PLATFORM_ENV, "FEISHU_ENCRYPT_KEY": "secret"}, clear=True)
...
class TestDedupTTL(unittest.TestCase):
    ...
    def test_load_tolerates_malformed_timestamp_values(self):
        ...
        with tempfile.TemporaryDirectory() as temp_home:
            with patch.dict(os.environ, {**PLATFORM_ENV, "HERMES_HOME": temp_home}, clear=True):
                adapter = FeishuAdapter(PlatformConfig())
...
class TestGroupMentionAtAll(unittest.TestCase):
    ...
    @patch.dict(os.environ, {**PLATFORM_ENV, "FEISHU_GROUP_POLICY": "allowlist", "FEISHU_ALLOWED_USERS": "ou_allowed"}, clear=True)
...
class TestProcessingReactions(unittest.TestCase):
    ...
    # ------------------------------------------------------------- env toggle
    @patch.dict(os.environ, {**PLATFORM_ENV, "FEISHU_REACTIONS": "false"}, clear=True)
