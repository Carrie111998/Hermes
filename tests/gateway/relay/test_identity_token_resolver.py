"""Unit tests for the generic-OIDC / Nastech-Portal caller-identity token resolver.
...
Two modes:
  ...
  2. Nastech Portal (resolve_nastech_access_token) otherwise — the default.

The HTTP POST and the Nastech resolver are monkeypatched; these prove the mode
