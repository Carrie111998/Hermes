...
class LongPreviewAgent:
    ...
    LONG_CMD = "cd /home/teknium/.nastech/nastech-agent/.worktrees/nastech-d8860339 && source .venv/bin/activate && python -m pytest tests/gateway/test_run_progress_topics.py -n0 -q"
...
async def test_terminal_progress_verbose_shows_full_command(monkeypatch, tmp_path):
    ...
    monkeypatch.setenv("NASTECH_TOOL_PROGRESS_MODE", "verbose")
