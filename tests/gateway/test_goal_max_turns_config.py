...
async def test_goal_command_slow_db_init_still_persists(tmp_path, monkeypatch):
    ...
    tests/orion_cli/test_goals_db_bootstrap_off_loop.py; no wall-clock
    ...
    real_session_db = orion_state.SessionDB
    ...
    monkeypatch.setattr(orion_state, "SessionDB", _SlowSessionDB)
