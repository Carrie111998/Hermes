...
class FakeTextChannel:
    def __init__(self, channel_id: int = 1, name: str = "general", guild_name: str = "Orion Server"):
        self.id = channel_id
        self.name = name
...
class FakeThread:
    def __init__(self, channel_id: int = 1, name: str = "thread", parent=None, guild_name: str = "Orion Server"):
        self.id = channel_id
        self.name = name
        self.parent = parent
