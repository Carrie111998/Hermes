"""Tests for _setup_feishu() in orion_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("orion_cli.config.save_env_value", side_effect=mock_save), \
         patch("orion_cli.config.get_env_value", side_effect=mock_get), \
         patch("orion_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("orion_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("orion_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("orion_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("orion_cli.cli_output.print_header"), \
         patch("orion_cli.cli_output.print_info"), \
         patch("orion_cli.cli_output.print_success"), \
         patch("orion_cli.cli_output.print_warning"), \
         patch("orion_cli.cli_output.print_error"), \
