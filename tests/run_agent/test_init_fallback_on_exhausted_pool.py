...
def test_init_codex_fallback_updates_complete_runtime_identity():
    fb = _mock_client(
        api_key="codex-token-1234567890",
    ...
    with patch(
        ...
        agent = AIAgent(
            provider="alibaba-coding-plan",
            requested_provider="alibaba-coding-plan",
            model="qwen3.6-plus",
            api_key=None,
            base_url=None,
            quiet_mode=True,
    ...
    assert agent.base_url.rstrip("/") == "https://chatgpt.com/backend-api/codex"
