...
from acp_adapter.server import OrionACPAgent
from acp_adapter.session import SessionManager, SessionState
from orion_cli import mcp_startup
...
class FakeAgent:
    ...
    def __init__(self):
        ...
        self.enabled_toolsets = ["orion-acp"]
...
def test_acp_late_refresh_adds_tools_when_discovery_lands_after_build(monkeypatch):
    ...
    acp_agent = OrionACPAgent(session_manager=manager)
