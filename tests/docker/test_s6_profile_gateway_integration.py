...
The unit tests in tests/orion_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned orion-writable by the
...
from orion_cli.service_manager import S6ServiceManager
