...
from orion_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/orion_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("orion_cli.lifecycle.invoke_hook")
@patch("orion_cli.lifecycle.finalize_session")
...
@patch("orion_cli.plugins.invoke_hook")
