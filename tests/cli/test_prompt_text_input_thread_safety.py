"""Tests for ``OrionCLI._prompt_text_input`` thread-safe input dispatch.
...
def _make_cli():
    """Minimal OrionCLI shell exposing prompt fallback helpers."""
    import cli as cli_mod

    obj = object.__new__(cli_mod.OrionCLI)
    obj._app = MagicMock()
