"""Regression test: orion update must not load cryptography eagerly."""
...
assert 'orion_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running orion update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so orion_cli is importable,
...
import orion_cli.main
from orion_cli.update_cmd import _cmd_update_check
