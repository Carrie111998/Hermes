#!/usr/bin/env python3
"""
SWE Runner with Orion Trajectory Format

A runner that uses Orion-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Orion-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Orion-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Orion format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Orion-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Orion-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Orion Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Orion-Agent's built-in execution environments
    and outputs trajectories in Orion-Agent format.
    """
    ...
    def _convert_to_orion_format(
        ...
        """
        Convert internal message format to Orion trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Orion trajectory format
        trajectory = self._convert_to_orion_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Orion trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Orion Trajectory Format")
    print("=" * 60)
