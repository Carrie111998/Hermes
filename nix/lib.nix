      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via ORION_BUNDLED_SKILLS /
            # ORION_OPTIONAL_SKILLS (see orion-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + ORION_BUNDLED_LOCALES
            # / ORION_OPTIONAL_MCPS, not via the wheel. Excluding them
