...
two endpoints so a fresh Orion install with **zero web credentials** still
...
def provider_tier(name: str) -> str:
    ...
    ``orion tools`` picker's Free/Paid rows). ``free`` forces the keyless
    ...
    try:
        ...
        return {
            ...
            "error": (
                ...
                "backend via `orion tools` for reliable service."
            ),
        }
    ...
    try:
        ...
        return {
            ...
            "error": (
                ...
                "via `orion tools` for reliable service."
            ),
        }
