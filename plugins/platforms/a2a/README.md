...
- Inbound text — including `/`-prefixed text — is preserved verbatim behind a
  model-visible untrusted-peer frame; remote peers cannot invoke operator
  slash commands. The primary model remains the sole semantic authority.
