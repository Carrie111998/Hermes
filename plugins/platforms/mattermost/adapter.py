...
def _apply_yaml_config(yaml_cfg: dict, mattermost_cfg: dict) -> dict | None:
    ...
    if "strict_mention" in mattermost_cfg:
        seeded["strict_mention"] = mattermost_cfg["strict_mention"]
        if not _skip_env_bridge and not os.getenv("MATTERMOST_STRICT_MENTION"):
