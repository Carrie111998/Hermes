...
required — uses aiohttp which is already a Orion dependency.
...
def interactive_setup() -> None:
    ...
    ``orion_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Orion delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # orion_cli/setup.py::_setup_mattermost function.
