...
Config: ~/.orion/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.orion/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_orion_home()`` helper (ORION_HOME-aware and
...
RULES_FILE = get_orion_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_orion_home() / "feishu_comment_pairing.json"
