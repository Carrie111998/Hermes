...
class FeishuAdapter(BasePlatformAdapter):
    ...
    async def _handle_card_action_event(self, data: Any) -> None:
        ...
        # Feishu exposes a callback token for card actions, but this synthetic
        # command text is generated by the adapter from structured callback
        # fields. Treat the token as a routing/dedupe anchor only, not as
        # authorization-grade current-message provenance for hooks.
        mark_source_identity_ambiguous(synthetic_event)
