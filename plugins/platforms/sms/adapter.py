...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Orion gateway adapter.

    Each inbound phone number gets its own Orion session (multi-tenant).
...
# static dict in orion_cli/gateway.py, and the _send_sms dispatch in
