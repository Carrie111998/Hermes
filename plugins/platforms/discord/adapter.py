...
from .command_sync import _CommandSyncHelpers
...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def _canonicalize_app_command_payload(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return _CommandSyncHelpers._canonicalize_app_command_payload(self, payload)
    ...
    def _normalize_permissions(value: Any) -> Optional[str]:
        ...
        return _CommandSyncHelpers._normalize_permissions(value)
    ...
    def _existing_command_to_payload(self, command: Any) -> Dict[str, Any]:
        ...
        """
        return _CommandSyncHelpers._existing_command_to_payload(self, command)

    def _canonicalize_app_command_option(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        return _CommandSyncHelpers._canonicalize_app_command_option(self, payload)
    ...
    def _patchable_app_command_payload(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return _CommandSyncHelpers._patchable_app_command_payload(self, payload)
