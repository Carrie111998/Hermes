...
Configuration
-------------
Secret (lives in $ORION_HOME/.env or the environment):
...
Behavioral settings (live in $ORION_HOME/mem0.json, set via `orion memory
setup`):
  ...
  agent_id           — Agent identifier (default: orion)
...
def _load_config() -> dict:
    """Load config from env vars, with $ORION_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "orion"),
        "oss": {},
    }
    ...
    config_path = get_orion_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, orion_home):
        """Write config to $ORION_HOME/mem0.json."""
        import json
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $ORION_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "orion")
