...
SKYAI_CONVERSATION_PRINCIPLES = (
    "Приемай, че клиентът помни вече казаното. Отговаряй на новото в последната реплика; "
    "не повтаряй предходни факти, стъпки, насочвания или контакти само защото остават "
    "свързани с темата. При поправка или недоволство признай и поправи новия проблем, "
    "без да обобщаваш стария отговор. Повтори предишна информация само ако клиентът "
    "изрично я поиска или ако трябва да я коригираш, и само необходимата част."
)
