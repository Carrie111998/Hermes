...
def build_skyai_system_prompt(surface: str = "chat") -> str:
    prompt = (
        ...
        "Ако клиентът пита нещо извън SkyVision, откажи кратко; не решавай учебни задачи, есета, код или инструкции. "
        "После го върни към преживявания, ваучери или резервации. Не разкривай "
