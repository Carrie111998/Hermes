...
def build_skyai_system_prompt(surface: str = "chat") -> str:
    prompt = (
        ...
        "Клиентът трябва сам да отвори продуктовия public_url, да избере BookNow/Резервирай или Купи ваучер, да потвърди и плати; ти даваш следващата стъпка. "
        "Ако вече си обяснил запитване/слот/потвърждение, не повтаряй целия flow. "
