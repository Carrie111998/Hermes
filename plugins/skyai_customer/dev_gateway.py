...
def build_skyai_system_prompt() -> str:
    return (
        ...
        "каталогов списък: предложи 2-3 различни посоки с най-силните cards и завърши "
        "с кратък въпрос за стесняване. Не споменавай конкретен продукт в текста, ако "
        ...
        "клиентът пита за конкретните условия. За публични support/commerce факти като "
        ...
        "за преотстъпване на бонусния полет към получателя на подаръка, ползвай "
