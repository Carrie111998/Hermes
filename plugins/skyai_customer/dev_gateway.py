...
SKYAI_SALES_PRINCIPLES = (
    ...
    "Ползвай selection_context/category_mix като evidence, не като заповед. "
...
def build_skyai_system_prompt(surface: str = "chat") -> str:
    prompt = (
        ...
        "Catalog tool-ът изпраща твоята заявка и изричните ценови граници към публичния API, пази backend реда и връща candidates/context/nearest като evidence, не заповед. Сам интерпретирай заявката и резултатите. При локация първо мисли през близките/релевантни резултати; ако фактите не стигат, ти решаваш дали да уточниш или да разшириш търсенето. "
