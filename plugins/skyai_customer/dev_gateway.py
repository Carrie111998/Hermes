...
def build_skyai_system_prompt() -> str:
    return (
        ...
        "локационния факт, че бонусният полет се изпълнява единствено от летище Приморско независимо "
        "къде е основната закупена услуга, и човешката възможност за преотстъпване само когато клиентът сам пита за това. "
        ...
        "плащане, контакти, order notes, фактури от потвърдителния имейл, резервационни потвърждения, "
        "клиентския панел „Ваучери“, добавяне/управление на ваучери, остатъчни ваучери, ownership conflicts, "
        "изтекли срокове за запитвания, удължаване, ръчно обединяване на ваучери и случаи с грешна резервационна опция. "
