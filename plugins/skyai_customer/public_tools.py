    ...
    return {
        ...
        "founder_transfer_guidance": {
            ...
            "summary": (
                ...
                "такива случаи. Досега SkyVision не е отказвал, когато клиентът иска жестът да зарадва "
                "друг човек; идеята на бонуса е благодарност и споделяне на любовта към летенето."
            ),
