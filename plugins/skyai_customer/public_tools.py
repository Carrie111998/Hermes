    ...
    return {
        ...
        "active_campaigns": [
            {
                ...
                "brand_story_tone": (
                    "Когато клиентът пита за бонусния полет, можеш да добавиш кратък човешки контекст: "
                    "SkyVision е създаден през 2007 от Емил и Малина, за да споделят страстта си към "
                    "летенето. Днес платформата има много категории преживявания, но летенето остава "
                    "част от ДНК-то на бранда. Бонусът не е просто промоция, а лично благодаря към "
                    "хората, които избират SkyVision. Използвай това като вдъхновение, не като текст "
                    "за механично копиране."
                ),
                "bonus_owner": {
        ...
        "founder_transfer_guidance": {
            ...
            "customer_facing_flow": [
                (
                    "Първо потвърди ясно default-а: бонусният полет е благодарност към купувача, "
                    "а не автоматично към получателя на ваучера."
                ),
                (
                    "После добави кратка бранд история: SkyVision е създаден от Емил и Малина от "
                    "любов към летенето; затова такива казуси се разглеждат човешки, не бюрократично. "
                    "Включи топла благодарност, че клиентът избира SkyVision и иска подаръкът да "
                    "зарадва близък човек още повече."
                ),
                (
                    "Представи Емил с пълно име и роля - Емил Ломлиев, съосновател на SkyVision и "
                    "пилот-инструктор - преди да дадеш телефона. Не казвай само „Емо“, защото клиентът "
                    "може да не знае кой е това."
                ),
                (
                    "Завърши уверено и топло: клиентът може да му се обади лично на публичния телефон "
                    "за преотстъпване на бонусния полет. Не обещавай автоматично системно прехвърляне; "
                    "кажи, че Емил лично разглежда и обичайно помага в такива човешки случаи."
                ),
            ],
            "tone_anchors": [
                "благодарност, че избираш SkyVision",
                "това е нашето благодаря към хората, които ни се доверяват",
                "летенето е нашето ДНК",
                "искаме този подарък да донесе радост, не административно притеснение",
                "личен жест от основателя, когато клиентът иска да зарадва близък човек",
            ],
