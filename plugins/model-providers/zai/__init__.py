...
request omits ``thinking``.  Orion' ``reasoning_config = {"enabled": False}``
...
:meth:`ZaiProfile.build_api_kwargs_extras` translates the Orion reasoning
...
(per Z.AI / BigModel docs).  Orion' richer effort scale is collapsed onto
...
def _glm_5_2_reasoning_effort(
    ...
    """Map Orion reasoning effort onto GLM's native vocabulary.
