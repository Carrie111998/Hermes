...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Orion\s+(Agent|Audit)$", re.IGNORECASE),
    ...
    re.compile(r".*\[bot\]$", re.IGNORECASE),             # any GitHub [bot] suffix (orion-seaeye[bot] etc.)
...
IGNORED_EMAILS = {
    ...
    "orion@nousresearch.com",
    "orion-audit@example.com",
    "nousbot@nousresearch.com",
    "orion@habibilabs.dev",
    "omx@oh-my-codex.dev",
    "codex@openai.com",
