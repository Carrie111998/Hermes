...
DEFAULT_DATASETS = [
    "Orion/swe-terminus-agent-glm-kimi-minimax",
    "Orion/orion-agent-megascience-sft1",
    "Orion/Orion-Agent-Thinking-GLM-4.7-SFT2",
    "Orion/Orion-Agent-Thinking-GLM-4.7-SFT1",
    "Orion/terminal-tasks-glm-orion-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "Orion/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload Orion/{output_name} {final_output}")
