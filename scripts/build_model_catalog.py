#!/usr/bin/env python3
"""Build the Orion Model Catalog — a centralized JSON manifest of curated models.
...
Orion CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Orion release.
...
# Ensure ORION_HOME is set for imports that touch it at module level.
os.environ.setdefault("ORION_HOME", os.path.join(os.path.expanduser("~"), ".orion"))

from orion_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "orion-agent repo",
            "docs": "https://your-orion-docs.example/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Orion '
