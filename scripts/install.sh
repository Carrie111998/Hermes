...
# here only defers the failure to `npm ci` under engine-strict. Keep this in sync with the root
# package.json. Anything outside the supported lines is replaced with the
# Hermes-managed Node $NODE_VERSION.
