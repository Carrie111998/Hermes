...
# strips pyproject.toml's [tool.uv] settings, so pass the cutoff explicitly to
# every uv package-resolution command below.
UV_EXCLUDE_NEWER="2026-08-11T21:47:48.879648000Z"
