...
def main() -> None:
    ...
    orion_home = Path(tempfile.mkdtemp(prefix="orion-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "orion-gateway-smoke",
    ...
    print(json.dumps({"orion_home": str(orion_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
