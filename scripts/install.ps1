...
$RepoUrlSsh = "git@github.com:kotasiddharth/hermes-agent.git"
$RepoUrlHttps = "https://github.com/kotasiddharth/hermes-agent.git"
$PythonVersion = "3.11"
    ...
    if (-not $didUpdate) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                ...
                if ($Commit) {
                    $zipUrl = "https://github.com/kotasiddharth/hermes-agent/archive/$Commit.zip"
                    $zipLabel = $Commit
                } elseif ($Tag) {
                    $zipUrl = "https://github.com/kotasiddharth/hermes-agent/archive/refs/tags/$Tag.zip"
                    $zipLabel = $Tag
                } else {
                    $zipUrl = "https://github.com/kotasiddharth/hermes-agent/archive/refs/heads/$Branch.zip"
                    $zipLabel = $Branch
                }
