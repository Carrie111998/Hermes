#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from Orion logs.
...
With no LOGFILE, reads ``$ORION_HOME/logs/agent.log`` (default ~/.orion).
...
def default_log() -> Path:
    home = os.environ.get("ORION_HOME") or str(Path.home() / ".orion")
