...
ORION_HOME = Path(os.getenv("ORION_HOME", Path.home() / ".orion"))
...
def check_config(groq_key, eleven_key):
    ...
    # Voice mode state
    voice_mode_path = ORION_HOME / "gateway_voice_mode.json"
