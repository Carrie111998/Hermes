#!/usr/bin/env python3
"""Build the Orion Skills Index — a centralized JSON catalog of all skills.
...
`orion skills search/install` can use it without hitting the GitHub API.
...
# Ensure ORION_HOME is set (needed by tools/skills_hub.py imports)
os.environ.setdefault("ORION_HOME", os.path.join(os.path.expanduser("~"), ".orion"))
...
def main():
    print("Building Orion Skills Index...", flush=True)
