...
exec env -i \
  ...
  ${HERMES_RUN_ROOTLESS_PODMAN_TESTS:+HERMES_RUN_ROOTLESS_PODMAN_TESTS="$HERMES_RUN_ROOTLESS_PODMAN_TESTS"} \
  ${HERMES_ROOTLESS_PODMAN_TEST_IMAGE:+HERMES_ROOTLESS_PODMAN_TEST_IMAGE="$HERMES_ROOTLESS_PODMAN_TEST_IMAGE"} \
