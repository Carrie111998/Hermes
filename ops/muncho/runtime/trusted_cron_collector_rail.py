...
COLLECTOR_SPECS: tuple[CollectorSpec, ...] = (
    ...
    _spec("e62f55ca93ca", "voice-context-model-authored-digest", {"kind": "interval", "minutes": 60}, "voice_stage", model_review=True, json_roots=(_VOICE_INPUT,), historical_source_delivery="discord:1504852355588423801:1524321461714681976", preserve_source_prompt=True),
