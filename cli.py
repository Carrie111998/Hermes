        ...
        try:
            ...
            def run_agent():
                ...
                with _sentry_txn(
                    ...
                    # === ROSENBLATT PATCH START: Sentry span wrapping upstream execution ===
                    # Reason: Wrap run_conversation in Sentry transaction
                    ...
                    if _txn is not None:
                        try:
                            from hermes_sentry import sanitize_observability_text as _sot
                            _txn.set_data("output", _sot(str(result)[:2000]))
                        except Exception:
                            pass
