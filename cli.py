...
def load_cli_config() -> Dict[str, Any]:
    ...
    # Local backend: explicit terminal.cwd is respected; placeholders resolve to
    # the launch cwd. This keeps `cwd: .` ergonomic while allowing a configured
    # default project root for fresh sessions.
    ...
    if effective_backend == "local":
        if configured_cwd in _CWD_PLACEHOLDERS:
            ...
            terminal_config["cwd"] = os.path.expanduser(configured_cwd)
