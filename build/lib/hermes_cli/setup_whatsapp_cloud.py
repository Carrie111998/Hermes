...
Charterforge gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Charterforge to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Charterforge needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Charterforge gateway in another terminal:")
