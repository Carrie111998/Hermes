...
the CLI through OS package managers and signed installers, so Charterforge expects
...
def cmd_setup(args: argparse.Namespace) -> int:
    ...
    console.print(
        Panel.fit(
            ...
            "Charterforge resolves [cyan]op://vault/item/field[/cyan] references through your\n"
    ...
    if binary and not token_set:
        ...
        if who:
            ...
            console.print(
                ...
                "Charterforge will warn and skip 1Password on next startup.[/yellow]"
            )
    if not references:
        console.print(
...
def cmd_token(args: argparse.Namespace) -> int:
    ...
    console.print(
        ...
        "Takes effect on the next Charterforge invocation."
    )
    if not op_cfg.get("enabled"):
        console.print(
