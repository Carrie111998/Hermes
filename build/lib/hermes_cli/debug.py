"""``hermes debug`` debug tools for Charterforge.
...
def run_debug_share(args):
    ...
    print("\nShare these links with the Charterforge team for support.")
...
⚠️  --nous: This uploads your debug bundle to Nous-INTERNAL storage (AWS S3),
  ...
  • System info (OS, Python/Charterforge version, provider, which API keys are
