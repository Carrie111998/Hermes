"""Charterforge skin/theme engine — the theme SDK for every surface.

A data-driven skin system that lets users (and Charterforge itself) customize the
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Charterforge"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ Charterforge "       # Response box header label
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "Charterforge"
...
- ``default`` — Classic Charterforge gold/kawaii (the current look)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Charterforge — gold and kawaii",
        # Dark-authored. Values match the TUI's DARK_THEME so the classic CLI
        # and the TUI render the same Charterforge gold.
        "colors": {
        ...
        "branding": {
            "agent_name": "Charterforge",
            "welcome": "Welcome to Charterforge! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Charterforge ",
            "prompt_symbol": "❯",
