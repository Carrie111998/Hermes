"""
Security advisory checker for Charterforge.
...
run in environments where the rest of Charterforge failed to import.
"""
...
def _installed_version(pkg_name: str) -> Optional[str]:
    ...
    except ImportError:  # py<3.8 — Charterforge requires 3.10+ but defensive.
        return None
    try:
