"""CLI for the Charterforge Kanban board — ``hermes kanban …`` subcommand.
...
def build_parser(parent_subparsers: argparse._SubParsersAction) -> argparse.ArgumentParser:
    ...
    kanban_parser = parent_subparsers.add_parser(
        ...
        description=(
            "Durable SQLite-backed task board shared across Charterforge profiles. "
...
def _cmd_daemon(args: argparse.Namespace) -> int:
    ...
    def _ready_queue_nonempty() -> bool:
        ...
        task whose assignee maps to a real Charterforge profile (i.e. one the
