...
benchmarked ten harnesses on hostile-file handling — and whose Orion column
...
Every task runs the full Orion agent (file + terminal + search toolsets)
...
Rules of engagement (from orionbench discipline):
