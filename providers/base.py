...
def _profile_user_agent() -> str:
    """Return a ``orion-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from orion_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"orion-cli/{_ver}"
    except Exception:
        return "orion-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # orion-cli UA so the catalog endpoint is reachable.
