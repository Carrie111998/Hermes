...
# Default CMD: sleep infinity keeps the container alive so s6-supervised
# services (gateway, dashboard) stay running. Override with `hermes` or
# `chat` for interactive CLI use.
CMD [ "sleep", "infinity" ]
