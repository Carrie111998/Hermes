        ...
        if has_binary_extension(str(_resolved)):
            ...
            return json.dumps({
                "error": (
                    ...
                    "Use image_analyze for images, or terminal to inspect binary files."
                ),
            })
