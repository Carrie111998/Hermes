...
FAL_MODELS: Dict[str, Dict[str, Any]] = {
    ...
    "bytedance/seedream/v5/pro/text-to-image": {
        ...
        "speed": "~10s",
        "strengths": "ByteDance flagship, photoreal, bilingual text",
        "price": "$0.068/image (≤1536²), $0.135 above",
        "size_style": "image_size_preset",
        "sizes": {
            "landscape": "landscape_16_9",
            "square": "square_hd",
        ...
        "edit_supports": {
            ...
            "output_format", "enable_safety_checker", "sync_mode",
        },
        # FAL: "Up to 10 images are supported; if more are sent, only the last 10".
        "max_reference_images": 10,
    },
    "bytedance/seedream/v5/lite/text-to-image": {
        "display": "Seedream V5 Lite",
        "speed": "~6s",
        "strengths": "Cheaper Seedream tier, auto 2K/3K/4K presets",
        # FAL does not publish a rate for this endpoint yet.
        "price": "unpublished",
        "size_style": "image_size_preset",
        "sizes": {
            "landscape": "landscape_16_9",
    ...
    "ideogram/v4/instant": {
        ...
        "speed": "~3s",
        "strengths": "Fastest Ideogram tier, typography",
        "price": "$0.0075/MP (~$0.03 at 2K)",
        "size_style": "image_size_preset",
        "sizes": {
            "landscape": "landscape_16_9",
            "square": "square_hd",
        ...
        "supports": {
            "prompt", "image_size", "num_images", "output_format",
            "expansion_model", "enable_safety_checker", "seed", "sync_mode",
        },
        "upscale": False,
    },
    "ideogram/v4/fast": {
        ...
        "speed": "~5s",
        "strengths": "Typography with TURBO/BALANCED/QUALITY tiers",
        "price": "$0.005-0.018/MP by rendering_speed",
        "size_style": "image_size_preset",
        "sizes": {
            "landscape": "landscape_16_9",
            "square": "square_hd",
        ...
        "supports": {
            "prompt", "image_size", "num_images", "output_format",
            "expansion_model", "rendering_speed", "enable_safety_checker",
            "seed", "sync_mode",
        },
        "upscale": False,
    },
    "alibaba/qwen-image-3/text-to-image": {
        ...
        "speed": "~10s",
        "strengths": "LLM-based, complex text, negative prompts",
        "price": "$0.04/image (1K), $0.075 (2K)",
        "size_style": "image_size_preset",
        "sizes": {
            "landscape": "landscape_16_9",
            "square": "square_hd",
        ...
        "defaults": {
            "num_images": 1,
            "output_format": "png",
            # On by default upstream; costs an extra rewrite pass per request.
            "enable_prompt_expansion": False,
        },
        "supports": {
            "prompt", "image_size", "num_images", "output_format",
            "negative_prompt", "enable_prompt_expansion",
            "enable_safety_checker", "seed", "sync_mode",
        },
        "upscale": False,
        "edit_endpoint": "alibaba/qwen-image-3/edit",
        "edit_supports": {
            "prompt", "image_urls", "image_size", "num_images",
            "output_format", "negative_prompt", "enable_prompt_expansion",
            "enable_safety_checker", "seed", "sync_mode",
        },
        # FAL: "Reference images for editing (1-3 images required)".
        "max_reference_images": 3,
    },
    "microsoft/mai-image-2.5-pro": {
        "display": "MAI Image 2.5 Pro",
        "speed": "~12s",
        "strengths": "Microsoft MAI, photoreal, native aspect ratios",
        "price": "~$0.17/image",
        "size_style": "aspect_ratio",
        "sizes": {
            "landscape": "16:9",
    ...
    "google/nano-banana-2-lite": {
        ...
        "speed": "~5s",
        "strengths": "Cheaper Gemini image tier, fixed 1K output",
        "price": "~$0.05/image (1K)",
        "size_style": "aspect_ratio",
        "sizes": {
            "landscape": "16:9",
        ...
        # No `resolution` knob on the lite tier — output is fixed at 1K.
        "supports": {
            "prompt", "aspect_ratio", "num_images", "output_format",
            "safety_tolerance", "seed", "sync_mode", "limit_generations",
        ...
        "edit_supports": {
            "prompt", "image_urls", "aspect_ratio", "num_images",
            "output_format", "safety_tolerance", "seed", "sync_mode",
            "limit_generations", "thinking_level", "system_prompt",
        },
        # FAL states no cap; mirrors the nano-banana-pro entry above.
        "max_reference_images": 2,
    },
    "fal-ai/recraft/v4.1/text-to-image": {
        "display": "Recraft V4.1",
        "speed": "~8s",
        "strengths": "Design systems, palette + background control",
        # FAL does not publish a rate for this endpoint yet.
        "price": "unpublished",
        "size_style": "image_size_preset",
        "sizes": {
        ...
        # Recraft V4.1 exposes no num_images/output_format/seed.
        "supports": {
            "prompt", "image_size", "enable_safety_checker",
            "colors", "background_color",
        },
    ...
    "fal-ai/nano-banana-2": {
        "display": "Nano Banana 2 (Gemini 3 Image)",
        "speed": "~8s",
        "strengths": "Gemini 3, reasoning depth, text rendering, up to 4K",
        "price": "$0.08/image (1K); 2K ×1.5, 4K ×2",
        "size_style": "aspect_ratio",
        "sizes": {
            "landscape": "16:9",
            "square": "1:1",
        ...
        "defaults": {
            ...
            "output_format": "png",
            "safety_tolerance": "5",
            # 1K is the base rate; 2K/4K are 1.5x/2x per FAL's pricing note.
            "resolution": "1K",
        },
        "supports": {
            "prompt", "aspect_ratio", "num_images", "output_format",
