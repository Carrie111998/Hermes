...
def image_generate_tool(
    ...
    try:
        ...
        # below and how source images are encoded. A stored but unavailable
        # selection raises its specific error here; only a category that was
        # never configured can report that no backend is available.
        managed_gateway = _resolve_managed_fal_gateway()
