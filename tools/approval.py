...
def _get_approval_timeout() -> int:
    ...
    try:
        ...
        # time_t overflow this clamp exists to prevent. Mirror the per-host
        # ceiling of agent.deadline.MAX_SAFE_TIMEOUT_S — 1 year on POSIX,
        # but the DWORD-millisecond ceiling on Windows (WaitForSingleObject
        # caps at ~49.7 days; a year overflows it).
        safe_cap = 4_294_907 if sys.platform == "win32" else 365 * 24 * 3600
    if raw > safe_cap:
        logger.warning(
