...
def _skills_dir() -> Path:
    ...
    ``SKILLS_DIR`` remains as a compatibility override for tests and the
    dashboard's existing scoped swap. When it has not been overridden, resolve
    from the live profile context instead of retaining the import-time home.
    """
...
def _get_category_from_path(skill_path: Path) -> Optional[str]:
    ...
    """
    # Try the active local skills directory first,
