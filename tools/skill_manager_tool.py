...
SKILL_MANAGE_SCHEMA = {
    ...
    "description": (
        ...
        "IMPORTANT — state file paths: Skill scripts MUST NOT write state to "
        "Path(__file__).parent or the skill directory — skill directories are "
        "synced and may be overwritten by skills_sync. Persistent state belongs "
        "under $HERMES_HOME/state/skills/<skill-name>. In Python, use "
        "from hermes_constants import get_hermes_home; "
        "get_hermes_home() / 'state' / 'skills' / '<skill-name>'. "
        "$HERMES_HOME is always set in the runtime environment.\n\n"
