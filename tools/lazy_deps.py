...
LAZY_DEPS: dict[str, tuple[str, ...]] = {
    ...
    "tool.dashboard": (
        ...
        "starlette==1.3.1",  # Reviewed 2026 advisory floor; sync with pyproject [web]
        "python-multipart==0.0.32",  # FastAPI UploadFile/Form; sync with core + [web]
    ),
    ...
    "tool.computer_use": (
        "mcp==1.26.0",
        "starlette==1.3.1",  # Reviewed 2026 advisory floor; sync with [computer-use]
    ),
