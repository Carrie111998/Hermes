...
LAZY_DEPS: dict[str, tuple[str, ...]] = {
    ...
    # tokenization) even though sherpa-onnx doesn't declare it; pypinyin is
    # required by text2token's ppinyin mode, which tokenizes Chinese phrases
    # against the wenetspeech / zh-en KWS models (no bpe.model).
    "wake.sherpa": (
        "sherpa-onnx==1.13.4",
        "sentencepiece==0.2.2",
        "sounddevice==0.5.5",
