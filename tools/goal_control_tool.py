    ...
    *,
    ...
    try:
        ...
        with goal_state_transaction(caller_session_id):
            ...
            manager = GoalManager(
                session_id=caller_session_id,
                default_max_turns=_configured_max_turns(),
            )
...
GOAL_CONTROL_SCHEMA = {
    ...
    "description": (
        ...
        "The calling session is the only permitted scope."
    ),
    "parameters": {
        "type": "object",
        "properties": {
            ...
            "max_turns": {
                "type": "integer",
                "minimum": 1,
                "description": "Optional continuation-turn budget for set/update.",
            },
            "acceptance_evidence": {
                "type": "array",
