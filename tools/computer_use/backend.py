...
class UIElement:
    ...
    # (trycua/cua#1961 — Surface 6 of Orion/orion-agent#47072).
...
class CaptureResult:
    ...
    # trycua/cua#1961 — Surface 7 of Orion/orion-agent#47072).
...
class ActionResult:
    ...
    verify → escalate ladder (Orion/orion-agent#67052). ``ok`` stays
