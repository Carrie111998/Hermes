...
Only included in the orion-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "Orion-Agent (https://github.com/zacharyjleach-stack/Aries)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_orion_home() / "cache" / "discord_capabilities.json"
