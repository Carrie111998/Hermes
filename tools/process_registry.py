    ...
    def spawn_local(
        ...
        if use_pty:
            ...
            try:
                ...
                # ``safe_command`` already contains the compound-background
                # rewrite from issue #68915. The Codex bridge must transform
                # that value (and return it unchanged when ineligible), never
                # reintroduce the raw command on the PTY path.
                ...
                pty_argv = [user_shell, "-lic", f"set +m; {pty_command}"]
