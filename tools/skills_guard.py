...
Trust levels:
  - builtin:   Ships with Orion. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.orion/\.env|\~/\.orion/\.env',
     "orion_env_access", "critical", "exfiltration",
     "directly references Orion secrets file"),
    ...
    (r'\.orion/config\.yaml|\.orion/SOUL\.md',
     "orion_config_mod", "critical", "persistence",
     "references Orion configuration files directly"),
...
# scan. `.skillignore` is the Orion-native name; `.clawhubignore` is honored
