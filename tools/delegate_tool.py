...
def _build_child_system_prompt(
    ...
    *,
    ...
    parts.append(
        ...
        "COMPLETION CONTRACT: You have exactly one turn and no user to hand "
        "back to mid-task. Never end your turn on a plan, a progress report, "
        "or a statement that work is underway or about to happen — if more "
        "work remains, do it now, in this turn. A narration like \"I'm now "
        "running the tests\" or \"validation is underway\" is not a final "
        "answer; the turn ends only when the deliverable exists or you are "
        "genuinely blocked, and your summary must state which of the two it "
        "is (and, if blocked, what you need).\n\n"
