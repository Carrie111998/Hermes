...
MEMORY_SCHEMA = {
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "content": {
                "type": "string",
                "description": "The entry content. Required for 'add', 'replace', and 'patch' (single-op shape; for 'patch' it is the replacement text). Alias: 'new_text' is also accepted (mirrors old_text)."
            },
            "old_text": {
                "type": "string",
