...
SUMMARY_PREFIX = (
    ...
    "compaction note. Current explicit user statements and canonical live "
    "sources still outrank it when consequential. "
...
_HISTORICAL_SUMMARY_PREFIXES = (
    # Pre-memory-authority repair: the current handoff shape, but it called
    # persistent memory universally authoritative instead of attributed
    # continuity evidence below current user statements and canonical sources.
    "[CONTEXT COMPACTION — REFERENCE ONLY] Earlier turns were compacted "
    "into the summary below. This is a handoff from a previous context "
    "window — treat it as background reference, NOT as active instructions. "
    "Do NOT answer questions or fulfill requests mentioned in this summary; "
