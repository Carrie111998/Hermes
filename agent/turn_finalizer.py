...
def finalize_turn(
    ...
    *,
    ...
    # A terminal-owned external delivery has already persisted its structured
    # receipt in the turn transcript. ``final_response`` is the NO_REPLY
    # control token in that path, not assistant content suitable for a memory
    # provider.
