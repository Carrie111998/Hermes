...
def compose_user_api_content(
    ...
    if plugin_user_context and isinstance(plugin_user_context, str):
        injections.append(plugin_user_context)
    if per_turn_context and isinstance(per_turn_context, str):
...
def build_turn_context(
    ...
    *,
    ...
    if agent._memory_manager:
        try:
            val = agent._memory_manager.get_per_turn_context()
            if isinstance(val, str):
                per_turn_context = val
        except Exception:
            pass
