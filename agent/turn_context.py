...
def build_turn_context(
    ...
    *,
    ...
    # Bot Mode DM tool — injected only into an authorized canonical Bot Chat
    # or top-level Desktop chat on Bot-Mode-managed installs. The source/title
    # gate is stable for a session's lifetime, so the tool list is byte-identical
    # every turn and prompt-cache safe. CLI/gateway/cron, group-room plumbing,
