...
def build_turn_context(
    ...
    *,
    ...
    # Imported lazily: ``agent_runtime_helpers`` imports this module at top
    # level, so a module-level import here would be a cycle (same reason
    # ``note_turn_start`` is pulled in inside this function).
