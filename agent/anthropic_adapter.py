...
def build_anthropic_kwargs(
    ...
    # Official Kimi adaptive-thinking support supersedes the fork's older
    # "skip thinking kwargs on Kimi" guard; replay/signature handling above
    # still uses ``_is_kimi_family_endpoint`` for signed-block advantages.
