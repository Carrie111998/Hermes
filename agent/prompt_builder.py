...
def build_skills_system_prompt(
    ...
    if not skills_by_category:
        ...
        result = (
            ...
            "For any non-trivial task, follow the skill-selector protocol:\n"
            "  1. Call skill_retrieve(\\\"<user's exact request>\\\") before committing to a skill.\n"
            "  2. Load at least 2 candidate skills — the best match may live in a different category.\n"
            "  3. Check loaded skills' related_skills field for author-curated alternatives.\n"
            "  4. When multiple output formats exist (slides / video / dashboard / document),\n"
