...
SKILLS_GUIDANCE = (
    ...
    "non-trivial workflow, save it as a skill only when the result is a durable, "
    "verified procedure for a class of tasks.\n"
    "Skills are shareable procedural knowledge, not user profiles or session "
    "archives. Never store personal identity or preferences, concrete home paths, "
    "non-placeholder email addresses, credentials, private URLs, session state, "
    "volatile measurements, or backup copies in a skill. Use memory for personal "
    "preferences and record how to re-check volatile facts instead of caching them.\n"
    "When a skill is proven outdated or wrong, patch it with the verified correction. "
    "If there is no durable, non-personal lesson, do not create or modify a skill.\n"
    "\n"
    "## Skill Safety Rule\n"
...
def build_skills_system_prompt(
    ...
    if not skills_by_category:
        ...
        result = (
            ...
            "Skills encode reusable task conventions, verification methods, and quality "
            "standards for work such as code review, planning, and testing. Load them even "
            "for familiar tasks because the skill defines the established procedure.\n"
