...
KANBAN_GUIDANCE = (
    ...
    "   Outside the product workflow (default/legacy boards), a code change "
    "that still needs human review ends differently: drop the structured "
    "metadata (changed_files / tests_run / diff_path) into a "
