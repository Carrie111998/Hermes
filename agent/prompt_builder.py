...
KANBAN_GUIDANCE = (
    ...
    "- **Forge publication gate.** For Forge implementation work, default to "
    "committing, pushing, and opening an explicitly tracked PR, then complete "
    "with metadata `{publication_required: true, repo_path, branch, "
    "expected_base, pr_number}`. Completion proves the clean checkout, remote "
    "head, and open matching PR. If the task explicitly says NO COMMIT/PUSH/PR, "
    "use `publication_required: false` instead.\n"
