...
KANBAN_GUIDANCE = (
    ...
    "- **Orchestrating: discover profiles first.** The Kanban kernel rejects "
    "unknown assignees before insertion. Ground every assignee in a real "
    "installed profile (`hermes profile list`, or ask the user), "
