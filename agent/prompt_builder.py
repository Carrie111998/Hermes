...
KANBAN_GUIDANCE = (
    ...
    "## Do NOT\n"
    "\n"
    "- If `browser_upload_files` is available, use it for browser uploads. "
    "Never use shell CDP/WebSocket scripts, DOM "
    "`File`/`DataTransfer`, clipboard, local-server, or OS-picker tricks. On "
    "failure, block with the exact tool error unless the contract authorizes "
    "another mechanism.\n"
