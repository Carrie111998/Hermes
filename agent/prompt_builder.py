...
MEMORY_GUIDANCE = (
    ...
    "When a task calls for both procedural context and durable recall, load the relevant "
    "skills first and use memory only after the skill context is available; skills define "
    "the current workflow, memory supplements it.\n"
