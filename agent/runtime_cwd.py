...
_SESSION_CWD: ContextVar = ContextVar("ORION_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    # configured path is otherwise honored verbatim — including the Orion
    # source tree itself, which is a legitimate workspace when the user is
    # developing Orion (per-surface policy for fallback-picked directories
