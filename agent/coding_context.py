...
CODING_AGENT_GUIDANCE = (
    ...
    "- When the same linter/type fix fails repeatedly, stop repeating that "
    "approach: re-read the evidence, inspect the surrounding contracts, and "
    "try a materially different safe strategy. Ask the user only after the "
    "reasonable alternatives inside the approved scope are exhausted or a "
    "specific missing authority/input genuinely prevents progress.\n"
