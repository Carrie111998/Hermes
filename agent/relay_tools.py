"""Core NeMo Relay adapter for Orion tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Orion tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Orion Relay tool execution cannot run on an active event-loop thread"
    )
