...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    # [rosenblatt] copilot_remote delegation guidance — tells the agent to
    # default delegated SWE work to GitHub Copilot remote sessions when the
    # copilot_remote toolset is loaded. Mirrors HEAD pre-extraction logic.
    if "copilot_remote" in agent.valid_tool_names:
        stable_parts.append(COPILOT_REMOTE_DELEGATION_GUIDANCE)
