...
_SKILL_REVIEW_PROMPT = (
    ...
    "from. Capture it.\n"
    "  • A kanban completion or review-required handoff included "
    "structured `metadata.deviations`. Treat that as a first-class "
    "lessons signal: recurring/spec-significant departures should "
    "become skill updates or concise durable memory facts about how "
    "this environment actually needs to be operated.\n"
...
_COMBINED_REVIEW_PROMPT = (
    ...
    "emerged.\n"
    "  • A kanban completion or review-required handoff carried "
    "structured `metadata.deviations`. Treat that as high-signal input "
    "for reusable lessons: recurring/spec-significant departures "
    "should become skill updates or concise durable memory facts.\n"
