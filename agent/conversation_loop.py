...
from agent.error_classifier import FailoverReason, classify_api_error, is_library_exception
        ...
        while retry_count < max_retries:
            ...
            try:
                    ...
                    if agent._session_db and agent.session_id:
                        try:
                            ...
                            agent._session_db.update_token_counts(
                                ...
                                model=agent.model,
                                api_call_count=1,
                                source=agent._session_source_for_persistence(),
                ...
                is_local_validation_error = (
                    ...
                    # SR-493 (ADR-0024 §4, ported in the v0.15.1 catch-up): a
                    # ValueError/TypeError raised from INSIDE an LLM SDK is
                    # backend-contract drift, not a Hermes programming bug — let
                    # it retry/fallback (and SR-471 alerts) instead of aborting
                    # silently. Broader than the specific NoneType-not-iterable
                    # shape above (covers any site-packages/openai|anthropic frame).
