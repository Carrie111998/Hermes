...
from agent.turn_request import (
    INTERRUPT_SCAFFOLD_MARKER as _INTERRUPT_SCAFFOLD_MARKER,
    _apply_context_engine_selection,
    _canonicalize_api_tool_calls,
    _canonicalize_tool_call_arguments,
...
def run_conversation(
    ...
    while (api_call_count < agent.max_iterations and agent.iteration_budget.remaining > 0) or agent._budget_grace_call:
        ...
        # Build the isolated provider-facing projection. Durable history stays
        # owned by this loop; the request module only returns the filtered
        # history reference plus an API-only structural copy.
        _prepared_request = build_turn_request(
            agent,
            messages,
        ...
        messages = _prepared_request.messages
        api_messages = _prepared_request.api_messages
        tools_for_api = _prepared_request.tools_for_api
