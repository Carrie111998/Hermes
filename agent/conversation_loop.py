...
def run_conversation(
    ...
    # A completed turn's review belongs to that turn's captured destination.
    # It may finish after a later ordinary user message; do not cancel it here,
    # or a busy routed profile silently loses its learning receipt. Explicit
    # user interruption and gateway shutdown still fan out through
    # ``_active_children`` and retain cancellation authority.
