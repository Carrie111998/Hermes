...
Orion' support is deliberately narrow (live verification, Aug 2026):
...
Ownership model: Orion' local compression stays fully armed as the
...
def _is_summary_item(item: Any) -> bool:
    """True when *item* is a canonical Orion compression-summary message.
...
def prune_pre_checkpoint_items(
    ...
    - Compression summary messages (``_is_summary_item``, the canonical
      ...
      byte/character-sliced: Orion summaries carry structural framing
