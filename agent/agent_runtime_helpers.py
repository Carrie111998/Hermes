...
AGENT_RUNTIME_POST_HOOK_TOOL_NAMES = frozenset(
    {"todo", "session_search", "memory", "clarify", "read_terminal", "read_preview", "read_window_below", "read_terminal", "read_preview", "read_window_below", "setup_mcp", "delegate_task", "model_override"}
)
...
def invoke_tool(agent, function_name: str, function_args: dict, effective_task_id: str,
    ...
    if function_name == "todo":
        ...
        def _execute(next_args: dict) -> Any:
            return _finish_agent_tool(agent._dispatch_model_override(next_args), next_args)
    else:
        def _execute(next_args: dict) -> Any:
