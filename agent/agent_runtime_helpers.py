...
def convert_to_trajectory_format(
    agent: Any, messages: List[Dict[str, Any]], user_query: str, completed: bool
) -> List[Dict[str, Any]]:
    """Compatibility forwarder to the persistence-boundary implementation."""
    from agent.tool_result_persistence import convert_to_trajectory_format as _convert

    return _convert(agent, messages, user_query, completed)
