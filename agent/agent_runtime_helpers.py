    ...
    with _sentry_tool_span(
        ...
        if function_name == "todo":
            ...
            if not session_db:
                ...
                _result = json.dumps({"success": False, "error": format_session_db_unavailable()})
            else:
            ...
            _result = agent._memory_manager.handle_tool_call(function_name, function_args)
            ...
            _result = agent._dispatch_delegate_task(function_args)
        else:
