...
def init_agent(
    ...
    # Platform-neutral gateway origin metadata for plugin routing. Keep a
    # private copy so callers cannot mutate the active turn through their input
    # mapping after agent construction.
