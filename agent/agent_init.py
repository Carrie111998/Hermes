...
def init_agent(
    ...
    try:
        ...
        agent._tool_snapshot_generation = 0
    # Tool definitions are part of the prompt-cached conversation prefix.
    # Freeze the disclosure policy once and use this exact immutable snapshot
    # for both assembly and every later bridge authorization in this agent.
