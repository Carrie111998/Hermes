...
# ``data:`` field before Orion receives a completion chunk.  Keeping this
...
# case: a stream dies mid-response and Orion persists a content-less
...
# Request parameters that Orion sends on SOME routes only, paired with the
...
def classify_api_error(
    ...
    *,
    ...
    # orion_cli.plugins.VALID_HOOKS for the callback contract). Callback
    ...
    try:
        from orion_cli.plugins import get_plugin_error_classification
