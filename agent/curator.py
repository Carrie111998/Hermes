...
CURATOR_REVIEW_PROMPT = (
    ...
    "    IMPORTANT: You MUST call skill_view(name) for a skill immediately\n"
    "    before calling skill_manage(patch) on it — even if you read it\n"
    "    earlier in this session. After context compaction, prior reads\n"
    "    are forgotten. skill_manage will REFUSE your patch if the skill\n"
    "    content was not loaded in the current review turn.\n"
