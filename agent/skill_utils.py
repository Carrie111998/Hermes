...
def iter_skill_index_files(skills_dir: Path, filename: str):
    ...
    Excludes Hermes metadata, VCS, archive, and skill support directories.
    Support directories (references/templates/assets/scripts) can contain
    arbitrary markdown and archived package ``SKILL.md`` files, but they are
    progressive-disclosure data loaded through ``skill_view(..., file_path=...)``
    rather than active skill roots.
    """
    matches = []
