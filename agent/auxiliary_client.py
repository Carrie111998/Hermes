...
# Client cache + shutdown helpers extracted to agent/aux_client_cache.py
# (slice R4-C2).  Re-exported here so existing import paths keep working.
from agent.aux_client_cache import (
