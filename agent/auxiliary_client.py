...
from agent.aux_anthropic_compat import _is_anthropic_compat_endpoint, _convert_openai_images_to_anthropic
from agent.aux_anthropic_compat import _ANTHROPIC_COMPAT_PROVIDERS
