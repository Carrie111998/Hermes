...
# ---------------------------------------------------------------------------
# Re-export of extracted modules (wave 1, shard s4, implementer w1b).
# The moved functions live in their own modules; these bottom imports keep
# them importable from ``hermes_cli.kanban_db`` for back-compat (tests and
# the CLI reference them by name on this module). Deferred to the bottom so
# the new modules can import shared helpers from here without a cycle.
# ---------------------------------------------------------------------------
from hermes_cli.task_lifecycle import (  # noqa: E402,F401
    archive_task,
    delete_archived_task,
    delete_task,
)
from hermes_cli.workspace_resolution import (  # noqa: E402,F401
...
from hermes_cli.worker_process import (  # noqa: E402,F401
    _classify_worker_exit,
    _pid_alive,
    _record_worker_exit,
    reap_worker_zombies,
)
from hermes_cli.failure_accounting import (  # noqa: E402,F401
