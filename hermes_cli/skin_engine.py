...
[dim #6B1717]⠀⠀⠀⠀⠀⠀⠀⠀war god online⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "hades": {
        "name": "hades",
        "description": "Underworld sovereign — deep violet, obsidian, and mythic styling",
        "colors": {
            ...
            "selection_bg": "#4C1D95",
            "shell_dollar": "#C4B5FD",
            "voice_status_bg": "#2A1848",
        },
        "spinner": {
            "waiting_faces": ["(Ω)", "(☠)", "(◈)", "(⦿)", "(†)"],
            "thinking_faces": ["(Ω)", "(☠)", "(◈)", "(⦿)", "(†)"],
            "thinking_verbs": [
                "descending", "tallying shades", "crossing the Styx", "weighing the ledger",
                "sealing the gate", "consulting the fates", "counting coins", "walking the asphodel",
            ],
            "wings": [
                ["⟪Ω", "Ω⟫"],
                ["⟪☠", "☠⟫"],
        ...
        "branding": {
            ...
            "goodbye": "The gates close behind you. Ω",
