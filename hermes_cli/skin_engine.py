"""IYARI skin/theme engine — the theme SDK for every surface.

A data-driven skin system that lets users (and IYARI itself) customize the
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "IYARI"                 # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ IYARI "        # Response box header label
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "IYARI"
...
- ``default`` — Classic IYARI gold/kawaii (the current look)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic IYARI — gold and kawaii",
        # Dark-authored. Values match the TUI's DARK_THEME so the classic CLI
        # and the TUI render the same IYARI gold.
        "colors": {
        ...
        "branding": {
            "agent_name": "IYARI",
            "welcome": "Welcome to IYARI! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ IYARI ",
            "prompt_symbol": "❯",
