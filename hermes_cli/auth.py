...
from hermes_cli import auth_remote_session as _auth_remote_session
...
# =============================================================================
# The implementations live in hermes_cli.auth_remote_session. These wrappers
# retain auth.py's import and monkeypatch seams for existing callers.
def _is_remote_session() -> bool:
    return _auth_remote_session._canonical_is_remote_session()


def _can_open_graphical_browser() -> bool:
    return _auth_remote_session._canonical_can_open_graphical_browser()


def _ssh_user_at_host() -> str:
    return _auth_remote_session._canonical_ssh_user_at_host()


def _print_loopback_ssh_hint(redirect_uri: str, *, docs_url: str | None = None) -> None:
    return _auth_remote_session._call_with_auth_seam(
        _is_remote_session,
        _ssh_user_at_host,
        redirect_uri,
        docs_url=docs_url,
