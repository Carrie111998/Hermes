...
# Auth Store persistence/recovery is composed from hermes_cli.auth_store.
from hermes_cli import auth_store as _auth_store

_auth_file_path = _auth_store._public("_auth_file_path")
_global_auth_file_path = _auth_store._public("_global_auth_file_path")
_load_global_auth_store = _auth_store._public("_load_global_auth_store")
_auth_lock_path = _auth_store._public("_auth_lock_path")
_same_path = _auth_store._public("_same_path")
_auth_lock_holder_for = _auth_store._public("_auth_lock_holder_for")
_file_lock = _auth_store._public("_file_lock")
_auth_store_lock = _auth_store._public("_auth_store_lock")
_load_auth_store = _auth_store._public("_load_auth_store")
_save_auth_store = _auth_store._public("_save_auth_store")
_load_provider_state_with_source = _auth_store._public("_load_provider_state_with_source")
_provider_state_transaction = _auth_store._public("_provider_state_transaction")
_load_provider_state = _auth_store._public("_load_provider_state")
_save_provider_state = _auth_store._public("_save_provider_state")
...
AuthStoreWriteConflictError = _auth_store.AuthStoreWriteConflictError
AuthStoreRecoveryConflictError = _auth_store.AuthStoreRecoveryConflictError
...
def _load_global_auth_store() -> Dict[str, Any]:
    """Keep the historical facade cache seam around the extracted loader."""
    global _global_auth_store_cache
    _auth_store._global_auth_store_cache = _global_auth_store_cache
    store = _auth_store._public("_load_global_auth_store")()
    _global_auth_store_cache = _auth_store._global_auth_store_cache
    return store
