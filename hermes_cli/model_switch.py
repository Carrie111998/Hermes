    ...
    *,
    ...
    for pid, overlay in HERMES_OVERLAYS.items():
        ...
        if overlay.auth_type == "aws_sdk":
            ...
            # Local subprocess-backed providers (for example Prime Agent)
            # authenticate by the executable being available, not by an env key.
            try:
        ...
        if hermes_slug in {"openai-codex", "copilot", "copilot-acp", "prime-agent"}:
