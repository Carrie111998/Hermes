...
Pure logic: walks a Charterforge config dict, returns issues for any reference
...
class RetirementIssue:
    """A reference to a retired xAI model found in a Charterforge config."""
...
def find_retired_xai_refs(config: Dict[str, Any]) -> List[RetirementIssue]:
    """Walk all model slots in a Charterforge config and return retirement issues.
