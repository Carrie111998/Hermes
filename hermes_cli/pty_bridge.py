...
class PtyBridge:
    ...
    are awaited on the event-loop thread.  The master fd is non-blocking
    so PTY input backpressure can suspend only the owning WebSocket task,
    never the dashboard event loop.
    """
