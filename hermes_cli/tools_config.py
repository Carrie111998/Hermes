...
CONFIGURABLE_TOOLSETS = [
    ...
    ("kanban",          "📋 Kanban Orchestration",       "create, route, review, and track durable work"),
...
_DEFAULT_OFF_TOOLSETS = {"homeassistant", "spotify", "discord", "discord_admin", "kanban", "video", "video_gen", "x_search", "a2a"}
