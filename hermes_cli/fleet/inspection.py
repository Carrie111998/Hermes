...
def build_fleet_service(
    *,
    ...
    return FleetService(
        ...
        # Fleet dispatch is orchestrated from live qualification, capability,
        # concurrency, and health evidence.  Capacity telemetry is displayed
        # for observability only; it must not choose a provider or block a
        # qualified lane.
        lane_selector=None,
    )
