...
DEFAULT_CONFIG = {
    ...
    "skills": {
        ...
        # Maximum chars returned from a main SKILL.md via skill_view.
        # Large skills should use progressive disclosure: keep SKILL.md small
        # and move detail into references/*.md loaded on demand. Set 0/null to
        # disable the cap.
