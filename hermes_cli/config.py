...
DEFAULT_CONFIG = {
    ...
    "gateway": {
        ...
        # File upload size limits for the Gateway API Server, Dashboard,
        # and Proxy.  Each layer enforces its own limit; the effective cap
        # for a given upload is the minimum of all limits along its path.
        "file_upload": {
            ...
            # Proxy server max request body (bytes).
            # Maps to proxy/server.py MAX_REQUEST_BYTES.
            "proxy_max_request_bytes": 10_000_000,
        },
    },
