...
# xAI's public API is OpenAI-compatible for the endpoints Charterforge commonly
# uses. The Responses endpoint is included because Charterforge' native xAI runtime
...
class XAIGrokAdapter(UpstreamAdapter):
    """Proxy upstream for xAI Grok via Charterforge-managed OAuth credentials."""
