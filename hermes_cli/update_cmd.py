    ...
    *,
    ...
    def _original_process_is_alive(pid: int, create_time: float) -> bool:
        try:
            ...
            # A vanished process is clear. AccessDenied or any unknown probe
            # failure stays fail-closed because the venv may still be locked.
            return type(exc).__name__ not in {"NoSuchProcess", "ZombieProcess"}
