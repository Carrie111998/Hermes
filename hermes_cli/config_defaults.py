...
DEFAULT_CONFIG = {
    ...
    "kanban": {
        # Optional model route for profile workers that have no per-task
        # override. Both values must be set together; empty values preserve
        # the assigned profile's own model/provider configuration.
        "default_model": "",
        "default_provider": "",
