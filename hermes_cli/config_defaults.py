...
OPTIONAL_ENV_VARS = {
    ...
    "EMAIL_AUTO_REPLY_PROMOTIONS": {
        "description": "Allow promotional and marketing emails to reach the agent. Off by default.",
        "prompt": "Auto-reply to promotions",
        "category": "messaging",
        "input_type": "boolean",
        "default_value": "false",
    },
    "EMAIL_AUTO_REPLY_NEWSLETTERS": {
        "description": "Allow newsletters, subscriptions, and digests to reach the agent. Off by default.",
        "prompt": "Auto-reply to newsletters",
        "category": "messaging",
        "input_type": "boolean",
        "default_value": "false",
    },
    "EMAIL_AUTO_REPLY_TRANSACTIONS": {
        "description": "Allow order, shipping, payment, invoice, and receipt emails to reach the agent. Off by default.",
        "prompt": "Auto-reply to transaction notices",
        "category": "messaging",
        "input_type": "boolean",
        "default_value": "false",
    },
    "EMAIL_AUTO_REPLY_SECURITY": {
        "description": "Allow verification codes, password resets, and security alerts to reach the agent. Off by default.",
        "prompt": "Auto-reply to security notices",
        "category": "messaging",
        "input_type": "boolean",
        "default_value": "false",
    },
    "EMAIL_AUTO_REPLY_SOCIAL": {
        "description": "Allow social-network messages, mentions, likes, and follows to reach the agent. Off by default.",
        "prompt": "Auto-reply to social notifications",
        "category": "messaging",
        "input_type": "boolean",
        "default_value": "false",
    },
    "EMAIL_AUTO_REPLY_CALENDAR": {
        "description": "Allow calendar invitations and reminders to reach the agent. Off by default.",
        "prompt": "Auto-reply to calendar notices",
        "category": "messaging",
        "input_type": "boolean",
        "default_value": "false",
    },
    "EMAIL_AUTO_REPLY_REPORTS": {
        "description": "Allow daily, weekly, monthly, and other recurring reports to reach the agent. Off by default.",
        "prompt": "Auto-reply to recurring reports",
        "category": "messaging",
        "input_type": "boolean",
        "default_value": "false",
    },
    "EMAIL_FORCE_REPLY_KEYWORDS": {
        "description": "Always reply when a keyword group matches. Separate groups with semicolons; join required terms with + (for example: urgent;invoice+overdue).",
        "prompt": "Must-reply keyword groups",
        "category": "messaging",
        "input_type": "textarea",
        "expose_value": True,
    },
    "EMAIL_NO_REPLY_KEYWORDS": {
        "description": "Never reply when a keyword group matches. This wins over must-reply rules. Separate groups with semicolons; join required terms with +.",
        "prompt": "No-reply keyword groups",
        "category": "messaging",
        "input_type": "textarea",
        "expose_value": True,
    },
    "EMAIL_REQUIRE_STRUCTURED_RESPONSE": {
        "description": "Require a machine-readable need_response decision. Invalid or missing decisions are blocked before SMTP. On by default.",
        "prompt": "Require structured reply decisions",
        "category": "messaging",
        "input_type": "boolean",
        "default_value": "true",
    },
