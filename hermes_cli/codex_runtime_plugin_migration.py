...
module:
  ...
  2. Queries codex's `plugin/list` for the openai-curated marketplace
     ...
     upstream calls "migrate native codex plugins" — the YouTube-video-
...
def _query_codex_plugins(
    ...
    for marketplace in marketplaces:
        ...
        for plugin in plugins:
            ...
            # Cf. third-party reference #80815 — upstream learned to gate
            ...
            # true for installed plugins. This is the same shape upstream
