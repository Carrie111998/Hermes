...
JUDGE_SYSTEM_PROMPT = (
    ...
    "- The response explains the goal is genuinely unachievable (e.g. "
    "hardware/physical impossibility, out of scope).\n"
    "Do NOT treat a response as DONE merely because it is blocked on user "
    "input, waiting for confirmation, or summarizes progress so far. In "
    "those cases the goal is NOT complete; prefer CONTINUE whenever the "
    "agent still has actionable steps it could take autonomously.\n\n"
