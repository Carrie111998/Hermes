"""OpenAI-compatible custom endpoint dashboard routes (extracted verbatim from web_server.py).

Bodies are byte-identical to their previous in-web_server form; web_server-owned
helpers are reached via the late-binding seam in :mod:`hermes_cli.web_deps`, so
...
custom_endpoint_key_env = late("custom_endpoint_key_env")
load_config = late("load_config")
read_raw_config = late("read_raw_config")
redact_key = late("redact_key")
