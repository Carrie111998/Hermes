...
#   - platform: low-frequency gateway routing command; reached via
#     /hermes platform on Slack. Demoted to preserve the native /auto slot
#     while staying within Slack's hard 50-command cap.
