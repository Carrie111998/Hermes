...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("provider", "Set OpenRouter provider routing for this session", "Configuration",
               args_hint="[DeepInfra | sort price|throughput|latency | only/ignore A,B | require-parameters | data-collection allow|deny | clear] [--global]",
