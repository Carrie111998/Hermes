"""Slash command definitions and autocomplete for the Charterforge CLI.
...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("rollback", "List or restore filesystem checkpoints", "Session",
               args_hint="[number]"),
    CommandDef("snapshot", "Create or restore state snapshots of Charterforge config/state", "Session",
    ...
    CommandDef("steer", "Inject a message after the next tool call without interrupting", "Session",
               args_hint="<prompt>"),
    CommandDef("goal", "Set a standing goal Charterforge works on across turns until achieved", "Session",
    ...
    CommandDef("busy", "Control what Enter does while Charterforge is working", "Configuration",
    ...
    CommandDef("update", "Update Charterforge to the latest version", "Info"),
    CommandDef("version", "Show Charterforge version", "Info", aliases=("v",)),
...
# Telegram allows up to 100 BotCommands. Charterforge ships ~50 built-in commands;
...
Telegram only displays a small BotCommand menu in practice.  The full Charterforge
...
def slack_native_slashes() -> list[tuple[str, str, str]]:
    ...
    entries.append(("hermes", "Talk to Charterforge or run a subcommand", "[subcommand] [args]"))
    seen.add("hermes")
