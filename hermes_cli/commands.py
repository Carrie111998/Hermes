...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("lock-this-chat-into-law", "Create a StrongIQ checkpoint candidate packet for this chat", "Session",
               aliases=("lock_this_chat_into_law",), args_hint="[--dry-run|--approve-candidate-checkpoint]",
               busy_policy="dispatch", busy_handler="checkpoint"),
    CommandDef("promote-since-last-checkpoint", "Create a governed promotion candidate packet since the last checkpoint", "Session",
               aliases=("promote_since_last_checkpoint",), args_hint="[--dry-run|--approve-candidate-checkpoint]",
               busy_policy="dispatch", busy_handler="checkpoint"),
