...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("status", "Show session, model, token, and context info", "Session",
               busy_policy="dispatch", execute="status"),
    CommandDef("briefing", "Run the Hermes morning briefing now", "Session",
               gateway_only=True, busy_policy="dispatch", execute="morning_briefing"),
    CommandDef("backup", "Run a manual backup now", "Info",
               gateway_only=True, busy_policy="dispatch", execute="manual_backup"),
    CommandDef("cleanup", "Run the auto-cleanup now", "Info",
               gateway_only=True, busy_policy="dispatch", execute="manual_cleanup"),
    CommandDef("health", "Show detailed system health", "Info",
               gateway_only=True, busy_policy="dispatch", execute="health"),
    CommandDef("logs", "Show recent Hermes logs", "Info",
               gateway_only=True, busy_policy="dispatch", execute="logs"),
    CommandDef("dashboard", "Open or send the Hermes dashboard now", "Info",
               gateway_only=True, busy_policy="dispatch", execute="dashboard"),
    CommandDef("capture", "Take a visual capture now", "Info",
               gateway_only=True, busy_policy="dispatch", execute="capture"),
    ...
    CommandDef("wake", "Toggle the 'Hey Hermes' wake word listener", "Configuration",
               ...
               subcommands=("on", "off", "status")),
    CommandDef("listen", "Record from mic and transcribe via local STT", "Configuration",
               busy_policy="dispatch", execute="listen"),
    CommandDef("voicectl", "Manage voice input integration", "Configuration",
               args_hint="[status|test]", subcommands=("status", "test"),
               busy_policy="dispatch", execute="voice_control"),
    ...
    CommandDef("update", "Update Hermes Agent to the latest version", "Info",
               busy_policy="dispatch", execute="update"),
