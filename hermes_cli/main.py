...
# Update-recovery breadcrumb helpers extracted to hermes_cli/update_recovery.py
# (main.py decomposition, mechanical move). Re-exported so callers and test
# monkeypatches on hermes_cli.main.<name> keep resolving unchanged.
from hermes_cli.update_recovery import (  # noqa: F401
...
# Windows hermes.exe quarantine helpers extracted to hermes_cli/win_quarantine.py
# (main.py decomposition, mechanical move). Re-exported so callers and test
# monkeypatches on hermes_cli.main.<name> keep resolving unchanged.
from hermes_cli.win_quarantine import (  # noqa: F401
