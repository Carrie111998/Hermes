...
def cmd_gui(args: argparse.Namespace):
    ...
    launch_electron_flags = _desktop_electron_argv(config_electron_flags, env)
    ...
    if source_mode:
        ...
        launch_result = subprocess.run(
            [npm, "exec", "--", "electron", ".", *launch_electron_flags],
            cwd=desktop_dir,
            env=env,
            check=False,
        )
    ...
    launch_command.extend(launch_electron_flags)
