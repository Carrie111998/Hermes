...
# ─── Web UI build + Windows exe-integrity clusters extracted to
# hermes_cli/web_ui_build.py and hermes_cli/pe_integrity_mixin.py (main.py
# decomposition, wave 1). Every moved name is re-exported here so callers and
# existing test monkeypatches (hermes_cli.main._web_ui_build_needed,
# hermes_cli.main._ensure_desktop_exe_launchable, ...) keep resolving
# unchanged.
from hermes_cli.web_ui_build import (  # noqa: E402
    _build_web_ui,
...
from hermes_cli.pe_integrity_mixin import (  # noqa: E402
