...
# Provider picker / auxiliary-config flows extracted to
# hermes_cli/model_picker.py and hermes_cli/aux_config_cmd.py (god-file
# decomposition, wave 1 shard s2). Re-imported here so existing call sites
# and test monkeypatches (hermes_cli.main.*) keep resolving unchanged.
from hermes_cli.aux_config_cmd import (
    _AUX_TASKS,
    _all_aux_tasks,
    _aux_config_menu,
