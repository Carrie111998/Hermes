...
# ── Plugin-CLI discovery gating + agent-startup prep (extracted) ──────
# Moved to hermes_cli/cli_discovery.py and hermes_cli/agent_startup.py.
# Re-imported here so ``hermes_cli.main.<name>`` keeps resolving for
# lazy importers and test monkeypatches (update_cmd precedent).
from hermes_cli.cli_discovery import (  # noqa: F401
...
from hermes_cli.agent_startup import (  # noqa: F401
    _AGENT_COMMANDS,
    _AGENT_SUBCOMMANDS,
    _is_tui_chat_launch,
