...
from hermes_cli.cmd_facades import cmd_memory, cmd_acp, cmd_tools, cmd_insights, cmd_monitoring, cmd_skills, cmd_pairing, cmd_plugins, cmd_mcp, cmd_claw  # noqa: F401
