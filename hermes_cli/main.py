...
# Custom-provider persistence extracted to hermes_cli/custom_provider_config.py
# (main.py decomposition, mechanical move). Every moved name is re-exported
# here so model_setup_flows.py / web_server.py lazy imports and existing test
# monkeypatches (hermes_cli.main._save_custom_provider, ...) keep resolving
# unchanged.
from hermes_cli.custom_provider_config import (  # noqa: F401
