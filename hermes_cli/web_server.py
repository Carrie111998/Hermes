...
from hermes_cli.web_routers import custom_endpoints as _custom_endpoints_routes  # noqa: E402
app.include_router(_custom_endpoints_routes.router)
from hermes_cli.web_routers.custom_endpoints import (  # noqa: E402,F401 — legacy re-exports; tests call these
    _parse_model_ids,
    _custom_endpoint_id,
