...
from hermes_cli.ws_auth_gate_mixin import (  # noqa: E402,F401 — legacy re-exports; tests call these via web_server.<name>
    _LOOPBACK_HOSTS,
    _ws_auth_mode,
    _ws_auth_ok,
    _ws_auth_reason,
...
from hermes_cli.spa_mount_mixin import (  # noqa: E402,F401 — legacy re-exports; tests call these via web_server.<name>
    _IMMUTABLE_ASSET_CACHE_CONTROL,
    _normalise_prefix,
    _render_active_theme_bootstrap_css,
    mount_spa,
)

from hermes_cli.console_ws_mixin import (  # noqa: E402
...
# /api/console moved to console_ws_mixin; register the route here so it
# stays ahead of the SPA catch-all mounted below.
app.websocket("/api/console")(console_ws)
