...
# Body lives in hermes_cli/hermes_one_model_library.py (D-004 extraction).
# Keep this mount call — Hermes One clients hard-code /api/model/library
# (plugin prefix /api/plugins/... would break them).
from hermes_cli.hermes_one_model_library import mount_hermes_one_model_library  # noqa: E402
