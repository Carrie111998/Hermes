...
from hermes_cli.web_routers import pairing as _pairing_routes  # noqa: E402

app.include_router(_pairing_routes.router)
from hermes_cli.web_routers.pairing import (  # noqa: E402,F401 — legacy re-exports; tests call these via web_server.<name>
    list_pairing,
    approve_pairing,
    revoke_pairing,
...
from hermes_cli.web_routers import hooks as _hooks_routes  # noqa: E402

app.include_router(_hooks_routes.router)
from hermes_cli.web_routers.hooks import (  # noqa: E402,F401 — legacy re-exports; tests call these via web_server.<name>
    list_hooks,
    create_hook,
    delete_hook,
)
