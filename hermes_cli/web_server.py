...
def _get_models_analytics(days: int = 30, profile: Optional[str] = None):
    ...
    try:
        ...
        # appear on the Models page instead of being invisible.
        ...
        # finishes. Fold unaccounted session-only rows into the single accounted
        # provider row when ownership is unambiguous.
