    ...
    try:
        ...
        def _preset_dict(preset: MoaPresetPayload) -> dict:
            return {
                ...
                "advisory_context": preset.advisory_context,
                "advisory_max_chars": preset.advisory_max_chars,
            ...
            if body.presets:
                ...
                raw = _preset_dict(
                    MoaPresetPayload(
                        ...
                        advisory_context=body.advisory_context,
                        advisory_max_chars=body.advisory_max_chars,
