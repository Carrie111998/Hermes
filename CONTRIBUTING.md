...
See the [extensions and configuration guide](docs/agents/extensions-and-configuration.md#adding-new-tools)
for profile-aware paths and plugin vs core guidance.
