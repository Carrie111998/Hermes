 ...
 *
 * Values mirror orion_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Orion default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Orion' default when unset). */
