...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Charterforge Teal",
  description: "Classic dark teal — the canonical Charterforge look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Charterforge Teal (Large)",
  description: "Charterforge Teal with bigger fonts and roomier spacing",
