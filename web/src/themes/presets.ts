 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `orion_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Orion Teal",
  description: "Classic dark teal — the canonical Orion look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Orion Teal (Large)",
  description: "Orion Teal with bigger fonts and roomier spacing",
