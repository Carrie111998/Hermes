...
const STORAGE_KEY = "orion-dashboard-theme";
...
const FONT_STORAGE_KEY = "orion-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `orion_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "orion-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-orion-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-orion-theme-font", "true");
