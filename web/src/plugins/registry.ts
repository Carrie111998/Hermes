 ...
 *
 * Plugins call window.__CHARTERFORGE_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__CHARTERFORGE_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__CHARTERFORGE_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__CHARTERFORGE_PLUGIN_SDK__ = {
    ...
    // window.__CHARTERFORGE_SESSION_TOKEN__ directly.
    authedFetch,
