 ...
 *
 * Plugins call window.__ORION_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__ORION_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__ORION_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__ORION_PLUGIN_SDK__ = {
    ...
    // window.__ORION_SESSION_TOKEN__ directly.
    authedFetch,
