 ...
 * `window.__CHARTERFORGE_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Charterforge brand in the top bar
 ...
 *  `window.__CHARTERFORGE_PLUGINS__.registerSlot(...)`.
 *
