 ...
 * `window.__ORION_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Orion brand in the top bar
 ...
 *  `window.__ORION_PLUGINS__.registerSlot(...)`.
 *
