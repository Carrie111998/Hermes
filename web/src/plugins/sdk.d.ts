/**
 * Charterforge Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__CHARTERFORGE_PLUGIN_SDK__`` and
 * ``window.__CHARTERFORGE_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__CHARTERFORGE_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``CharterforgePluginSDK["sdkVersion"]`` (and the
 ...
 * of calling ``fetch`` with a hand-read ``window.__CHARTERFORGE_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__CHARTERFORGE_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__CHARTERFORGE_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface CharterforgePluginSDK {
...
declare global {
  interface Window {
    __CHARTERFORGE_PLUGIN_SDK__?: CharterforgePluginSDK;
    __CHARTERFORGE_PLUGINS__?: PluginRegistry;
  }
}
