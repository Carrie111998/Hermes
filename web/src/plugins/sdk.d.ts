/**
 * Orion Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__ORION_PLUGIN_SDK__`` and
 * ``window.__ORION_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__ORION_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``OrionPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@orion/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__ORION_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__ORION_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__ORION_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface OrionPluginSDK {
...
declare global {
  interface Window {
    __ORION_PLUGIN_SDK__?: OrionPluginSDK;
    __ORION_PLUGINS__?: PluginRegistry;
  }
}
