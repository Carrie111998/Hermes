...
export const hu: Translations = {
  ...
  skills: {
    wisdom: {
      ...
      potential: "Megosztható készségek",
      potentialHelp: "Helyi készségek, amelyek jelenlegi formájukban még nem lettek beküldve.",
      ownerReview: "Saját hozzájárulási piszkozatok",
      ownerReviewHelp: "Privát piszkozatok és hozzájárulások, amelyek még figyelmet igényelnek.",
      noDrafts: "Nincs figyelmet igénylő hozzájárulási piszkozat.",
      ...
      reviewExact: "Piszkozat megnyitása",
      draftState: (state) => {
