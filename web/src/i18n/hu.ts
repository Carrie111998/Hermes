...
export const hu: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Eltávolítja ezt a bővítményt a ~/.nastech/plugins/ mappából?",
    removeHint: "Csak a felhasználó által a ~/.nastech/plugins alá telepített bővítmények távolíthatók el.",
  ...
  skills: {
    ...
    filters: "Szűrők",
    noSkills: "Nem található készség. A készségek a ~/.nastech/skills/ mappából töltődnek be",
