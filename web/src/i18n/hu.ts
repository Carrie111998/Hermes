...
export const hu: Translations = {
  ...
  emailPolicy: {
    connectionTitle: "Postafiók-kapcsolat",
    connectionDescription: "A levelek fogadásához és küldéséhez szükséges alapadatok.",
    advancedConnection: "Speciális postafiók-beállítások",
    advancedConnectionDescription: "Portok, lekérdezés, hozzáférési szabályok és alapértelmezett kézbesítés.",
    title: "Automatikus válasz szabályzata",
    description: "Döntsd el, mi szűrődjön azonnal, és mit vizsgálhat meg az Agent.",
    categoriesTitle: "Levélkategóriák",
    categoriesDescription: "A szűrő közelítő heurisztikus regexet használ. Egy kategória kikapcsolása nem garantálja, hogy a tartalom soha nem jut el az Agenthez; csak a helyi egyezések blokkolódnak előre.",
    promotions: "Promóciók és marketing",
    newsletters: "Hírlevelek és összefoglalók",
    transactions: "Rendelések és tranzakciók",
    security: "Biztonsági értesítések",
    social: "Közösségi értesítések",
    calendar: "Naptárértesítések",
    reports: "Rendszeres jelentések",
    allowCategory: "Agent-válasz engedélyezése",
    keywordsTitle: "Kulcsszószabályok",
    keywordsDescription: "A kézi kulcsszócsoportok csak helyben, szó szerint illeszkednek, és nem kerülnek az Agent promptjába.",
    neverReply: "Soha ne válaszoljon",
    neverReplyDescription: "Az Agent előtt leáll, és ütközéskor elsőbbséget élvez.",
    mustReply: "Kötelező válasz",
    mustReplyDescription: "Továbbítja az Agentnek, és választ követel.",
    keywordPlaceholder: "Soronként egy kulcsszócsoport",
    keywordSyntax: "Példa: sürgős vagy számla+lejárt",
    decisionTitle: "Agent-döntés",
    strictDecision: "Strukturált döntés megkövetelése",
    strictDecisionDescription: "Az SMTP előtt blokkolja a hibás, negatív vagy üres választ.",
    priorityLabel: "Szabálysorrend",
    priorityText: "Soha ne válaszoljon → Kötelező válasz → Kategória → Agent-döntés",
  },
