...
export const hu: Translations = {
  ...
  emailPolicy: {
    ...
    categoriesDescription: "A gyakori automatikus értesítések alapból válasz nélkül maradnak.",
    ...
    keywordsDescription: "Soronként egy szabály. A kötelező szavakat + jellel kapcsold össze.",
