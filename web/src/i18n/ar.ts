...
export const ar = defineLocale({
  ...
  status: {
    ...
    updateHermesConfirmMessage: "ينفذ هذا hermes update ويعيد تشغيل البوابة عند انتهائه. تحتفظ الجلسات النشطة بذاكرة الموجّه المؤقتة حتى ذلك الحين.",
  ...
  profiles: {
    ...
    noSkillsOption: "لا تزرع المهارات المضمّنة",
  ...
  kanban: {
    ...
    create: "إنشاء",
    parentLabelHint: "(تبقى المهمة الفرعية محجوبة حتى تكتمل الأصل)",
