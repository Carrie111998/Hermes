...
export const ar = defineLocale({
  common: {
    ...
    gateway: "البوابة",
    gatewayHint:
      "تُضبط منصات المراسلة وخادم الواجهة البرمجية والويب هوك في صفحة القنوات. هذه إعدادات عامة للبوابة، وتشمل وضع الوسيط أو الترحيل وقائمة السماح العامة.",
    pluginLoadFailed:
  ...
  status: {
    ...
    restartGatewayConfirmMessage:
      "يعيد هذا تشغيل عملية بوابة Hermes. ستُعاد بعده وصلة القنوات المتصلة والجلسات النشطة.",
  ...
  cron: {
    ...
    scheduleModes: {
      ...
      customHint:
        "تعبير cron من خمسة حقول: الدقيقة والساعة واليوم والشهر ويوم الأسبوع.",
  ...
  env: {
    ...
    customHint:
      "متغيرات بيئة اعتباطية محفوظة في ملف .env الخاص بك لا يتعرّف عليها Hermes. استعملها لحقن متغيرات بيئة للمهارات أو خوادم MCP أو أدواتك الخاصّة.",
  ...
  oauth: {
    ...
    description:
      "{connected} من {total} مزوِّدي OAuth متصلون. استخدم «تسجيل الدخول» للتدفقات المدعومة في اللوحة؛ وتبقى أوامر CLI متاحة للإعداد الخارجي أو الاحتياطي.",
    connected: "متصل",
  ...
  kanban: {
    ...
    saving: "جاري الحفظ…",
    commentHint:
      "تصل التعليقات إلى العامل في تشغيله التالي أو عند استدعاء kanban_show()؛ لا حاجة إلى حظر المهمة أولًا.",
    commentHintTitle:
      "التعليقات هي قناة التواصل مع عامل المهمة. تصل إلى سلسلة المحادثة فورًا دون حاجة إلى حظر المهمة أولًا. يلتقطها العامل عند استدعائه التالي لـ kanban_show() أو عند إعادة تشغيله؛ والحظر مخصص للحالات التي تريد فيها إيقاف العامل وانتظار إدخالك.",
  },
});
