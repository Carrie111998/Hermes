...
export const ar = defineLocale({
  common: {
    ...
    general: "عام",
    messaging: "مراسلة",
    gatewayHint: "تُضبط منصات المراسلة وخادم API وWebhooks في صفحة القنوات. أما هذه فإعدادات على مستوى البوابة (وضع الوسيط/الترحيل وقائمة السماح العامة).",
    gateway: "البوابة",
    pluginLoadFailed:
  ...
  app: {
    ...
    webUi: "واجهة الويب",
    dismiss: "تجاهل",
    diskElevatedBanner: "قرص وكيلك يمتلئ. فكّر في مسح الجلسات القديمة أو توسيع مساحة التخزين.",
    diskCriticalBanner: "أوشك قرص وكيلك على الامتلاء. قد يفشل حفظ الرسائل والذكريات والإعدادات الجديدة.",
    memoryElevatedBanner: "ذاكرة وكيلك على وشك النفاد.",
    memoryCriticalBanner: "أوشكت ذاكرة وكيلك على النفاد وقد يُعاد تشغيله. أغلق الجلسات الخاملة أو وسّع ذاكرته.",
    memoryOomRestartBanner: "أُعيد تشغيل وكيلك بشكل غير متوقع، والأرجح أنه نفدت ذاكرته. الجلسات الطويلة وكثرة المهام المتزامنة ترفعان استهلاك الذاكرة.",
    managingProfileBanner: "إدارة الملف الشخصي '{name}' — تسري الإعدادات والمفاتيح والمهارات وMCP والنموذج والمحادثات الجديدة على ذلك الملف.",
    currentProfileOption: "هذه اللوحة ({name})",
  ...
  status: {
    ...
    restartGatewayConfirmMessage: "يعيد هذا تشغيل عملية بوابة Hermes. ستعيد القنوات المتصلة والجلسات النشطة الاتصال بعدها.",
    restartingGateway: "إعادة تشغيل البوابة…",
    running: "يعمل",
    runningRemote: "يعمل (عن بعد)",
    startFailed: "فشل البدء",
    starting: "قيد البدء",
    startedInBackground: "بدأ في الخلفية — تحقق من السجلات للتقدم",
    stopped: "متوقف",
    updateHermes: "تحديث Hermes",
    updateHermesConfirmTitle: "تحديث Hermes؟",
    updateHermesConfirmNow: "حدّث الآن",
    updateHermesConfirmMessage: "يشغّل هذا الأمر hermes update ويعيد تشغيل البوابة بعد اكتماله. تحتفظ الجلسات النشطة بذاكرة التخزين المؤقت للموجه حتى ذلك الحين.",
  ...
  sessions: {
    ...
    selectedSessionsDeleted: "حُذفت {count} جلسة",
    deleteSelectedConfirmMessage: "يزيل هذا نهائيًا {count} جلسة محددة وكل رسائلها. لا يمكن التراجع عن هذا.",
    deleteSelectedConfirmTitle: "حذف {count} جلسة؟",
    ...
    emptySessionsDeleted: "حُذفت {count} جلسة فارغة",
    deleteEmptyConfirmMessage: "يزيل هذا نهائيًا {count} جلسة لا تحتوي رسائل. تُتخطى الجلسات النشطة والمؤرشفة. لا يمكن التراجع عن هذا.",
  ...
  cron: {
    ...
    scheduleDescribe: {
      ...
      weeklyAt: "أسبوعيًا في {days} الساعة {time}",
      monthlyAt: "شهريًا في اليوم {day} الساعة {time}",
      onceAt: "مرة واحدة في {time}",
    },
    scheduleModes: {
      interval: "كل فترة",
      daily: "يوميًا",
      ...
      onceAt: "التشغيل في",
      customLabel: "تعبير cron",
      customPlaceholder: "0 9 * * *",
      customHint: "تعبير cron من خمسة حقول (الدقيقة، الساعة، اليوم، الشهر، يوم الأسبوع).",
      preview: "يُرسل بصيغة",
      previewEmpty: "(غير مكتمل)",
    },
    scheduleMode: "الجدولة",
    ...
    delivery: {
      ...
      noneConfigured: "لا توجد منصات مراسلة مُعدّة. أعدّ واحدة في القنوات لتوصيل التقارير.",
      needsHomeChannel: "حدد قناة رئيسية أولاً",
    },
  },
  ...
  profiles: {
    ...
    cloneFromNone: "بدون (فارغ)",
    cloneFrom: "استنساخ الإعدادات من",
    ...
    actions: "الإجراءات",
    modelSelect: "اختر نموذجًا",
    modelSaved: "تم تحديث النموذج",
    editModel: "تغيير النموذج",
    modelNone: "لا يوجد مزوّدون موثّقون — أضف مفتاحًا أولاً",
    modelLoading: "جارٍ تحميل النماذج…",
    modelInherit: "وراثة من المستنسَخ / الافتراضي",
    modelOptional: "النموذج (اختياري)",
    descriptionOptional: "الوصف (اختياري)",
    noSkillsOption: "لا تضف المهارات المضمّنة تلقائيًا",
    cloneAll: "استنساخ كل شيء (الذكريات، الجلسات، المهارات، الحالة)",
    advancedOptions: "خيارات متقدمة",
    distribution: "التوزيع",
    describeFailed: "تعذّر توليد الوصف",
    ...
    descriptionPlaceholder: "فيمَ يبرع هذا الملف الشخصي؟ يُستخدم لتوجيه مهام الكانبان حسب الدور.",
    description: "الوصف",
    ...
    activeSet: "تم تعيين الملف الشخصي النشط",
  ...
  skills: {
    ...
    more: "+{count} المزيد",
    managingProfile: "إدارة الملف الشخصي '{name}' — تسري المفاتيح على ذلك الملف، لا على هذه اللوحة.",
  ...
  env: {
    ...
    invalidKeyName: "استخدم الحروف والأرقام والشرطة السفلية فقط (ويجب أن يبدأ بحرف أو شرطة سفلية).",
    add: "إضافة",
    customKeyNamePlaceholder: "مثال: MY_SERVICE_API_KEY",
    customKeyName: "اسم المتغير",
    addCustomKey: "إضافة مفتاح مخصص",
    customConfigured: "{count} مفتاح مخصص مضبوط",
    customHint: "متغيرات بيئة اعتيادية محفوظة في ملف .env لديك ولا يتعرف عليها Hermes. استخدمها لتمرير متغيرات بيئة إلى المهارات أو خوادم MCP أو أدواتك الخاصة.",
  ...
  oauth: {
    ...
    copied: "تم النسخ ✓",
    copyFailed: "تعذّر النسخ تلقائيًا. حدد الرمز وانسخه يدويًا.",
    copyCode: "نسخ الرمز",
    cli: "CLI",
  ...
  theme: {
    ...
    fontSerif: "بزوائد",
    fontSans: "بلا زوائد",
    fontDefaultHint: "استخدم خط السمة النشطة",
    fontDefault: "خط السمة",
    fontTitle: "الخط",
  },
  ...
  achievements: {
    ...
    share: {
      ...
      x_title: "يفتح X مع منشور معد مسبقًا",
      ...
      hint:
        "المشاركة على X تفتح منشورًا معدَّلاً مسبقًا في تبويب جديد. انقر نسخ الصورة أولاً إذا أردت شارة الإنجاز 1200×630 مرفقة — يسمح X باللصق مباشرة في مؤلف التغريد. تنزيل PNG يحفظ الملف للاستخدام في أي مكان.",
  ...
  kanban: {
    ...
    confirmDoneMany:
      "تحديد {n} مهمة كمكتملة؟ سيتم تحرير مطالبات العمال وتصبح المهام الفرعية المعتمدة جاهزة.",
    confirmArchiveMany:
      "أرشفة {n} مهمة؟ ستختفي من عرض اللوحة الافتراضي.",
    confirmBlockedMany:
      "تحديد {n} مهمة كمحظورة؟ سيتم تحرير مطالبات العمال.",
    ...
    columnHelp: {
      ...
      scheduled: "في انتظار تأخير زمني معلوم أو متابعة مجدولة",
    ...
    confirmScheduled: "نقل هذه المهمة إلى مجدولة؟ استخدم هذا للتأخيرات الزمنية المعلومة لا للانتظار البشري.",
    completionSummary:
      "ملخص الإنجاز لـ {label}. يُخزَّن كنتيجة للمهمة.",
    completionSummaryRequired:
      "ملخص الإنجاز مطلوب قبل تحديد المهمة كمكتملة.",
    triagePlaceholder: "فكرة أولية — سيقوم الذكاء الاصطناعي بصياغة المواصفات…",
    ...
    trash: {
      ...
      confirmManyTitle: "حذف {n} مهمة؟",
    },
    commentHintTitle: "التعليقات هي قناة التخاطب مع العامل المكلّف بالمهمة. تصل إلى المسار فورًا — دون الحاجة إلى حجب المهمة أولاً. ويلتقطها العامل في تشغيله التالي عبر kanban_show() أو عند إعادة تشغيله؛ أما الحجب فهو فقط حين تريد أن يتوقف العامل وينتظر ردك.",
    commentHint: "تصل التعليقات إلى العامل في تشغيله التالي أو عند kanban_show() — دون الحاجة إلى حجب المهمة أولاً.",
    saving: "جارٍ الحفظ…",
    projectDirectoryOverrideHint: "ترث المهام الجديدة هذا كمساحة عمل افتراضية؛ ويظل بإمكان كل مهمة تجاوزه في نافذة الإنشاء.",
    boardSettingsTitleFor: "إعدادات اللوحة — {name}",
    boardSettingsTitle: "إعدادات اللوحة — الاسم والوصف ومجلد المشروع الافتراضي الذي ترثه المهام الجديدة",
    boardSettings: "الإعدادات",
    create: "إنشاء",
    parentLabelHint: "(تبقى المهمة الفرعية محجوبة حتى تكتمل المهمة الأصلية)",
    parentLabel: "المهمة الأصلية",
    skillsLabelHint: "(اختياري، مفصولة بفواصل)",
    skillsLabel: "المهارات",
    assigneeLabelHint: "(فارغ = يختار الموزّع)",
