...
export interface Translations {
  ...
  status: {
    ...
    stopped: string;
    updateOrion: string;
    updateOrionConfirmMessage?: string;
    updateOrionConfirmNow?: string;
    updateOrionConfirmTitle?: string;
    updatingOrion: string;
  ...
  // ── Achievements plugin (plugins/orion-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;
