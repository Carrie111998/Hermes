...
export const de: Translations = {
  ...
  emailPolicy: {
    ...
    categoriesDescription: "Übliche automatische Mails bleiben standardmäßig stumm. Aktiviere nur benötigte Kategorien.",
    ...
    keywordsDescription: "Eine Regel pro Zeile. Mit + verbundene Wörter müssen gemeinsam vorkommen.",
