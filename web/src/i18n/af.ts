...
export const af: Translations = {
  ...
  skills: {
    wisdom: {
      ...
      potential: "Vaardighede wat jy kan deel",
      potentialHelp: "Plaaslike vaardighede wat nog nie in hul huidige vorm ingedien is nie.",
      ownerReview: "Jou bydraekonsepte",
      ownerReviewHelp: "Privaat konsepte en bydraes wat nog jou aandag verg.",
      noDrafts: "Geen bydraekonsepte verg jou aandag nie.",
