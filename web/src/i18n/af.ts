...
export const af: Translations = {
  ...
  emailPolicy: {
    connectionTitle: "Posbusverbinding",
    connectionDescription: "Die basiese besonderhede wat Hermes nodig het om e-pos te ontvang en te stuur.",
    advancedConnection: "Gevorderde posbusinstellings",
    advancedConnectionDescription: "Poorte, peiling, toegangsreëls en verstekaflewering.",
    title: "Outomatiese antwoordbeleid",
    description: "Besluit wat onmiddellik gefiltreer word en wat die Agent mag beoordeel.",
    categoriesTitle: "E-poskategorieë",
    categoriesDescription: "Die filter gebruik benaderde heuristiese regex. Om ’n kategorie af te skakel waarborg nie dat inhoud nooit die Agent bereik nie; net plaaslike treffers word vooraf geblokkeer.",
    promotions: "Promosies en bemarking",
    newsletters: "Nuusbriewe en opsommings",
    transactions: "Bestellings en transaksies",
    security: "Sekuriteitskennisgewings",
    social: "Sosiale kennisgewings",
    calendar: "Kalenderkennisgewings",
    reports: "Gereelde verslae",
    allowCategory: "Laat Agent-antwoorde toe",
    keywordsTitle: "Sleutelwoordreëls",
    keywordsDescription: "Handmatige sleutelwoordgroepe word net plaaslik letterlik gepas en nie by die Agent-prompt gevoeg nie.",
    neverReply: "Moet nooit antwoord nie",
    neverReplyDescription: "Stop voor die Agent en kry voorkeur by konflik.",
    mustReply: "Antwoord vereis",
    mustReplyDescription: "Stuur die boodskap na die Agent en vereis ’n antwoord.",
    keywordPlaceholder: "Een sleutelwoordgroep per lyn",
    keywordSyntax: "Voorbeeld: dringend of faktuur+agterstallig",
    decisionTitle: "Agent-besluit",
    strictDecision: "Vereis ’n gestruktureerde besluit",
    strictDecisionDescription: "Blokkeer ongeldige, negatiewe of leë antwoorde voor SMTP.",
    priorityLabel: "Reëlvolgorde",
    priorityText: "Nooit antwoord → Antwoord vereis → Kategorie → Agent-besluit",
  },
