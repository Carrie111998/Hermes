...
export const it: Translations = {
  ...
  emailPolicy: {
    ...
    categoriesDescription: "Le notifiche automatiche restano silenziose per impostazione predefinita.",
    ...
    keywordsDescription: "Una regola per riga. Usa + quando tutte le parole devono essere presenti.",
