...
export const it: Translations = {
  ...
  skills: {
    wisdom: {
      ...
      potential: "Competenze che puoi condividere",
      potentialHelp: "Competenze locali non ancora inviate nella forma attuale.",
      ownerReview: "Le tue bozze di contributo",
      ownerReviewHelp: "Bozze private e contributi che richiedono ancora la tua attenzione.",
      noDrafts: "Nessuna bozza di contributo richiede la tua attenzione.",
