...
export const ga: Translations = {
  ...
  emailPolicy: {
    ...
    categoriesDescription: "Fanann gnáthfhógraí uathoibríocha ciúin de réir réamhshocraithe.",
    ...
    keywordsDescription: "Riail amháin in aghaidh na líne. Ceangail focail riachtanacha le +.",
