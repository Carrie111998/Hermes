...
export const fr: Translations = {
  ...
  emailPolicy: {
    ...
    categoriesDescription: "Les notifications automatiques restent silencieuses par défaut. Activez seulement les catégories utiles.",
    ...
    keywordsDescription: "Une règle par ligne. Reliez avec + les mots qui doivent tous être présents.",
