...
export const fr: Translations = {
  ...
  skills: {
    wisdom: {
      ...
      potential: "Compétences que vous pouvez partager",
      potentialHelp: "Compétences locales qui n’ont pas encore été soumises dans leur forme actuelle.",
      ownerReview: "Vos brouillons de contribution",
      ownerReviewHelp: "Brouillons privés et contributions qui nécessitent encore votre attention.",
      noDrafts: "Aucun brouillon de contribution ne nécessite votre attention.",
      ...
      reviewExact: "Ouvrir le brouillon",
      draftState: (state) => {
