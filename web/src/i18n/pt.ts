...
export const pt: Translations = {
  ...
  emailPolicy: {
    ...
    categoriesDescription: "Mensagens automáticas comuns ficam em silêncio por predefinição.",
    ...
    keywordsDescription: "Uma regra por linha. Use + quando todas as palavras forem necessárias.",
