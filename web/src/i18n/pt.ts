...
export const pt: Translations = {
  ...
  skills: {
    wisdom: {
      ...
      potential: "Competências que podes partilhar",
      potentialHelp: "Competências locais que ainda não foram submetidas na forma atual.",
      ownerReview: "Os teus rascunhos de contribuição",
      ownerReviewHelp: "Rascunhos privados e contribuições que ainda precisam da tua atenção.",
      noDrafts: "Não há rascunhos de contribuição que precisem da tua atenção.",
      ...
      cancel: "Cancelar",
      submit: "Submeter para revisão privada do servidor",
