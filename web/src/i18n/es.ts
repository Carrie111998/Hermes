...
export const es: Translations = {
  ...
  emailPolicy: {
    connectionTitle: "Conexión del buzón",
    connectionDescription: "Los datos básicos que Hermes necesita para recibir y enviar correo.",
    advancedConnection: "Ajustes avanzados del buzón",
    advancedConnectionDescription: "Puertos, sondeo, reglas de acceso y entrega predeterminada.",
    title: "Política de respuesta automática",
    description: "Decide qué se filtra de inmediato y qué puede revisar el Agent.",
    categoriesTitle: "Categorías de correo",
    categoriesDescription: "El filtro usa regex heurísticas aproximadas. Desactivar una categoría no garantiza que su contenido nunca llegue al Agent; solo las coincidencias locales se bloquean antes.",
    promotions: "Promociones y marketing",
    newsletters: "Boletines y resúmenes",
    transactions: "Pedidos y transacciones",
    security: "Avisos de seguridad",
    social: "Notificaciones sociales",
    calendar: "Avisos de calendario",
    reports: "Informes periódicos",
    allowCategory: "Permitir respuestas del Agent",
    keywordsTitle: "Reglas de palabras clave",
    keywordsDescription: "Los grupos de palabras clave manuales solo se comparan localmente y no se añaden al prompt del Agent.",
    neverReply: "Nunca responder",
    neverReplyDescription: "Se detiene antes de llamar al Agent y gana cualquier conflicto.",
    mustReply: "Respuesta obligatoria",
    mustReplyDescription: "Envía el correo al Agent y exige una respuesta.",
    keywordPlaceholder: "Un grupo de palabras clave por línea",
    keywordSyntax: "Ejemplo: urgente o factura+vencida",
    decisionTitle: "Decisión del Agent",
    strictDecision: "Exigir una decisión estructurada",
    strictDecisionDescription: "Bloquea formatos erróneos, decisiones negativas y respuestas vacías antes de SMTP.",
    priorityLabel: "Orden de reglas",
    priorityText: "Nunca responder → Respuesta obligatoria → Categoría → Decisión del Agent",
  },
