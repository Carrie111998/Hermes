...
export const es: Translations = {
  ...
  emailPolicy: {
    ...
    categoriesDescription: "El correo automático común no recibe respuesta. Activa solo las categorías necesarias.",
    ...
    keywordsDescription: "Una regla por línea. Une con + las palabras que deban aparecer juntas.",
