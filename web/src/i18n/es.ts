...
export const es: Translations = {
  ...
  analytics: {
    ...
    output: "Salida",
    total: "Total",
    nastechageData: "No hay datos de uso para este período",
  ...
  pluginsPage: {
    ...
    removeConfirm: "¿Eliminar este complemento de ~/.nastech/plugins/?",
    removeHint: "Solo se pueden eliminar complementos instalados por el usuario en ~/.nastech/plugins.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "No se encontraron habilidades. Las habilidades se cargan desde ~/.nastech/skills/",
