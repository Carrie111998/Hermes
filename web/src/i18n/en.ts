...
export const en: Translations = {
  ...
  status: {
    ...
    restartGatewayConfirmMessage:
      "This restarts the Orion gateway process. Connected channels and active sessions will reconnect afterward.",
    ...
    stopped: "Stopped",
    updateOrion: "Update Orion",
    updateOrionConfirmMessage:
      "This runs orion update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateOrionConfirmNow: "Update now",
    updateOrionConfirmTitle: "Update Orion?",
    updatingOrion: "Updating Orion…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Orion plugins (`orion plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.orion/plugins/?",
    removeHint: "Only user-installed plugins under ~/.orion/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.orion/skills/",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Orion doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      title: "Orion Achievements",
      subtitle:
        "Collectible Orion badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Orion session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Orion more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Orion sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Orion is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Orion Agent ☤",
    },
  },
