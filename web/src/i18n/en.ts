...
export const en: Translations = {
  ...
  skills: {
    wisdom: {
      ...
      potential: "Skills you can share",
      potentialHelp: "Local skills that have not been submitted in their current form.",
      ownerReview: "Your contribution drafts",
      ownerReviewHelp: "Private drafts and contributions that still need your attention.",
      noDrafts: "No contribution drafts need your attention.",
