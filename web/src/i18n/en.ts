...
export const en: Translations = {
  ...
  status: {
    ...
    stopped: "Stopped",
    updateCharterforge: "Update Charterforge",
    updateCharterforgeConfirmMessage:
      "This runs hermes update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateCharterforgeConfirmNow: "Update now",
    updateCharterforgeConfirmTitle: "Update Charterforge?",
    updatingCharterforge: "Updating Charterforge…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Charterforge plugins (`hermes plugins` parity).",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Charterforge doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible Charterforge badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Charterforge session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Charterforge more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Charterforge sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Charterforge is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
