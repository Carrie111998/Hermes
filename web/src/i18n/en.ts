...
export const en: Translations = {
  ...
  emailPolicy: {
    ...
    categoriesDescription: "Common automated mail stays quiet by default. Enable only categories that should reach the Agent.",
    ...
    keywordsDescription: "One rule per line. Join words with + when every word must be present.",
