...
export const ru: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Удалить этот плагин из ~/.nastech/plugins/?",
    removeHint: "Удалять можно только плагины, установленные пользователем в ~/.nastech/plugins.",
  ...
  skills: {
    ...
    filters: "Фильтры",
    noSkills: "Навыки не найдены. Навыки загружаются из ~/.nastech/skills/",
