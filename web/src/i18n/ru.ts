...
export const ru: Translations = {
  ...
  skills: {
    wisdom: {
      ...
      potential: "Навыки, которыми можно поделиться",
      potentialHelp: "Локальные навыки, ещё не отправленные в текущем виде.",
      ownerReview: "Ваши черновики вкладов",
      ownerReviewHelp: "Приватные черновики и вклады, которые ещё требуют вашего внимания.",
      noDrafts: "Нет черновиков вкладов, требующих вашего внимания.",
