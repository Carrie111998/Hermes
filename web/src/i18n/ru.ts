...
export const ru: Translations = {
  ...
  emailPolicy: {
    ...
    categoriesDescription: "Обычные автоматические уведомления по умолчанию остаются без ответа.",
    ...
    keywordsDescription: "Одно правило на строку. Соединяйте обязательные слова знаком +.",
