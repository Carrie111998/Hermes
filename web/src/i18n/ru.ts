...
export const ru: Translations = {
  ...
  emailPolicy: {
    connectionTitle: "Подключение почтового ящика",
    connectionDescription: "Основные данные для получения и отправки писем.",
    advancedConnection: "Расширенные настройки",
    advancedConnectionDescription: "Порты, опрос, правила доступа и доставка по умолчанию.",
    title: "Политика автоответов",
    description: "Решите, что фильтровать сразу, а что передавать Agent.",
    categoriesTitle: "Категории писем",
    categoriesDescription: "Фильтр использует приблизительные эвристические регулярные выражения. Отключение категории не гарантирует, что содержимое никогда не попадёт в Agent; заранее блокируются только локальные совпадения.",
    promotions: "Реклама и маркетинг",
    newsletters: "Рассылки и дайджесты",
    transactions: "Заказы и транзакции",
    security: "Уведомления безопасности",
    social: "Социальные уведомления",
    calendar: "Календарные уведомления",
    reports: "Регулярные отчёты",
    allowCategory: "Разрешить ответы Agent",
    keywordsTitle: "Правила ключевых слов",
    keywordsDescription: "Ручные группы ключевых слов сопоставляются только локально и не добавляются в промпт Agent.",
    neverReply: "Никогда не отвечать",
    neverReplyDescription: "Останавливает обработку до Agent и имеет высший приоритет.",
    mustReply: "Ответ обязателен",
    mustReplyDescription: "Передаёт письмо Agent и требует ответа.",
    keywordPlaceholder: "Одна группа ключевых слов на строку",
    keywordSyntax: "Пример: срочно или счёт+просрочен",
    decisionTitle: "Решение Agent",
    strictDecision: "Требовать структурированное решение",
    strictDecisionDescription: "Блокирует неверный формат, отказ и пустой ответ до SMTP.",
    priorityLabel: "Порядок правил",
    priorityText: "Не отвечать → Ответ обязателен → Категория → Решение Agent",
  },
