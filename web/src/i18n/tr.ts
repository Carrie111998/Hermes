...
export const tr: Translations = {
  ...
  emailPolicy: {
    ...
    categoriesDescription: "Yaygın otomatik bildirimler varsayılan olarak sessiz kalır.",
    ...
    keywordsDescription: "Her satıra bir kural. Birlikte bulunması gereken sözcükleri + ile bağlayın.",
