...
export const tr: Translations = {
  ...
  skills: {
    wisdom: {
      ...
      potential: "Paylaşabileceğiniz beceriler",
      potentialHelp: "Mevcut hâliyle henüz gönderilmemiş yerel beceriler.",
      ownerReview: "Katkı taslaklarınız",
      ownerReviewHelp: "Hâlâ ilgilenmeniz gereken özel taslaklar ve katkılar.",
      noDrafts: "İlginizi gerektiren katkı taslağı yok.",
