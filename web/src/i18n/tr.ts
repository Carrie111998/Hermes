...
export const tr: Translations = {
  ...
  emailPolicy: {
    connectionTitle: "Posta kutusu bağlantısı",
    connectionDescription: "Hermes'in e-posta alıp göndermesi için gereken temel bilgiler.",
    advancedConnection: "Gelişmiş posta ayarları",
    advancedConnectionDescription: "Bağlantı noktaları, yoklama, erişim kuralları ve varsayılan teslimat.",
    title: "Otomatik yanıt ilkesi",
    description: "Neyin hemen filtreleneceğini ve neyi Agent'ın değerlendireceğini belirleyin.",
    categoriesTitle: "E-posta kategorileri",
    categoriesDescription: "Kategori filtresi yaklaşık sezgisel regex kullanır. Bir kategoriyi kapatmak içeriğin Agent’a hiç ulaşmayacağını garanti etmez; yalnızca yerel eşleşmeler önceden engellenir.",
    promotions: "Promosyon ve pazarlama",
    newsletters: "Bültenler ve özetler",
    transactions: "Siparişler ve işlemler",
    security: "Güvenlik bildirimleri",
    social: "Sosyal bildirimler",
    calendar: "Takvim bildirimleri",
    reports: "Düzenli raporlar",
    allowCategory: "Agent yanıtlarına izin ver",
    keywordsTitle: "Anahtar kelime kuralları",
    keywordsDescription: "Elle girilen anahtar sözcük grupları yalnızca yerelde eşleşir ve Agent istemine eklenmez.",
    neverReply: "Asla yanıtlama",
    neverReplyDescription: "Agent çağrılmadan durur ve çakışmalarda önceliklidir.",
    mustReply: "Yanıt zorunlu",
    mustReplyDescription: "İletiyi Agent'a gönderir ve yanıt ister.",
    keywordPlaceholder: "Her satıra bir anahtar kelime grubu",
    keywordSyntax: "Örnek: acil veya fatura+gecikmiş",
    decisionTitle: "Agent kararı",
    strictDecision: "Yapılandırılmış karar iste",
    strictDecisionDescription: "Geçersiz biçimi, olumsuz kararı ve boş yanıtı SMTP'den önce engeller.",
    priorityLabel: "Kural sırası",
    priorityText: "Asla yanıtlama → Yanıt zorunlu → Kategori → Agent kararı",
  },
