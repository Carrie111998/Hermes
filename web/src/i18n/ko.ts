...
export const ko: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "~/.nastech/plugins/에서 이 플러그인을 제거하시겠습니까?",
    removeHint: "~/.nastech/plugins 아래에 사용자가 설치한 플러그인만 제거할 수 있습니다.",
  ...
  skills: {
    ...
    categories: "카테고리",
    filters: "필터",
    noSkills: "스킬을 찾을 수 없습니다. 스킬은 ~/.nastech/skills/ 에서 로드됩니다",
