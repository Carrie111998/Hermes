...
export const zhHant: Translations = {
  ...
  emailPolicy: {
    connectionTitle: "信箱連線",
    connectionDescription: "Hermes 收發郵件所需的基本資訊。",
    advancedConnection: "進階信箱設定",
    advancedConnectionDescription: "連接埠、輪詢、存取規則與預設投遞地址。",
    title: "自動回覆策略",
    description: "先決定哪些郵件保持安靜，哪些郵件可以交給 Agent 判斷是否回覆。",
    categoriesTitle: "信件分類",
    categoriesDescription: "常見自動通知預設不回覆；只開啟確實需要 Agent 處理的分類。",
    promotions: "推廣與行銷",
    newsletters: "訂閱與簡報",
    transactions: "訂單與交易通知",
    security: "安全通知",
    social: "社交通知",
    calendar: "行事曆與會議通知",
    reports: "週期性報告",
    allowCategory: "允許 Agent 回覆",
    keywordsTitle: "關鍵字規則",
    keywordsDescription: "每行一組規則；用 + 連接必須同時出現的關鍵字。",
    neverReply: "絕不回覆",
    neverReplyDescription: "命中後不會呼叫 Agent；與其他規則衝突時優先。",
    mustReply: "必須回覆",
    mustReplyDescription: "命中後一定交給 Agent，並要求產生回覆。",
    keywordPlaceholder: "每行輸入一個關鍵字群組",
    keywordSyntax: "範例：緊急，或 發票+逾期",
    decisionTitle: "Agent 判定",
    strictDecision: "要求結構化回覆判定",
    strictDecisionDescription: "在 SMTP 前攔截格式錯誤、無需回覆與空白回覆。",
    priorityLabel: "規則優先順序",
    priorityText: "絕不回覆 → 必須回覆 → 分類過濾 → Agent 判定",
  },
