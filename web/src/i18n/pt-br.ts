...
export const ptBr: Translations = {
  common: {
    ...
    messaging: "Mensagens",
    pluginLoadFailed:
      "Não foi possível carregar o script deste plugin. Verifique o aba Network (dashboard-plugins/…) e o caminho do plugin no servidor.",
    pluginNotRegistered:
      "O script do plugin não chamou register(), ou o script falhou. Abra a consola do navegador para mais detalhes.",
  },
  ...
  app: {
    ...
    openDocumentation: "Abrir documentação em um novo aba",
  ...
  sessions: {
    ...
    selectAllOnPage: "Selecionar todas desta página",
  ...
  logs: {
    ...
    lines: "Linhas",
    noLogLines: "Não foram encontradas linhas de log",
  },
  ...
  profiles: {
    ...
    confirmDeleteMessage:
      "Esta ação elimina permanentemente o perfil '{name}' — configuração, chaves, memórias, sessões, habilidades, tarefas cron. Não é possível desfazer.",
    created: "Criado",
    deleted: "Eliminado",
    renamed: "Renomeado",
  },
  ...
  pluginsPage: {
    ...
    rescanHeading: "Log de plugins SPA",
  ...
  config: {
    ...
    confirmResetScope: "Restaurar todas as definições de {scope} para os valores padrão? Isto apenas atualiza o formulário — as alterações só são escritas em config.yaml quando clicar em Salvar.",
    resetScopeToast: "{scope} restaurado para padrões — reveja e Guarde para persistir",
  ...
  env: {
    ...
    confirmClearMessage:
      "O valor armazenado para esta variável será removido do seu arquivo .env. Esta ação não pode ser anulada a partir da UI.",
  ...
  oauth: {
    ...
    description:
      "{connected} de {total} provedores OAuth conectados. Use Iniciar sessão para fluxos suportados pelo painel; os comandos CLI continuam disponíveis para configuração externa ou de recurso.",
    connected: "Conectado",
    expired: "Expirado",
    notConnected: "Não conectado. Use Iniciar sessão quando disponível, ou execute {command} em um terminal.",
    ...
    enterCodePrompt: "Foi aberto um novo aba. Introduza este código se for solicitado:",
    pkceStep1: "Foi aberto um novo aba para claude.ai. Inicie sessão e clique em Authorize.",
  ...
  achievements: {
    ...
    guide: {
      ...
      secret_body:
        "As secretas escondem o seu acionador exato. Assim que o Hermes detectar um sinal relacionado, o cartão passa a Descoberta e mostra o requisito.",
    ...
    share: {
      ...
      hint:
        "Partilhar no X abre uma publicação pré-preenchida em um novo aba. Clique primeiro em Copiar imagem se quiser anexar o distintivo 1200×630 — o X permite colá-lo diretamente no compositor da publicação. Baixar PNG guarda o arquivo para uso em qualquer lugar.",
      clipboard_unsupported:
        "A cópia de imagens para a área de transferência não é suportada neste navegador — utilize Baixar.",
  ...
  kanban: {
    ...
    columnHelp: {
      ...
      scheduled: "Aguardando um atraso conhecido ou de um seguimento agendado",
    ...
    noParent: "— sem pai —",
    workspacePathDir: "caminho do espaço de trabalho (obrigatório, ex.: ~/projects/my-app)",
    workspacePathOptional:
      "caminho do espaço de trabalho (opcional, derivado do responsável se vazio)",
    logTruncated: "(a mostrar os últimos 100 KB — log completo em ",
    logAt: ")",
  },
};
