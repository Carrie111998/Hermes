...
export const uk: Translations = {
  ...
  emailPolicy: {
    ...
    categoriesDescription: "Типові автоматичні сповіщення за замовчуванням залишаються без відповіді.",
    ...
    keywordsDescription: "Одне правило на рядок. Обов’язкові слова з’єднуйте знаком +.",
