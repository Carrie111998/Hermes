...
export const uk: Translations = {
  ...
  skills: {
    wisdom: {
      ...
      potential: "Навички, якими можна поділитися",
      potentialHelp: "Локальні навички, які ще не надіслано в поточному вигляді.",
      ownerReview: "Ваші чернетки внесків",
      ownerReviewHelp: "Приватні чернетки та внески, які ще потребують вашої уваги.",
      noDrafts: "Немає чернеток внесків, які потребують вашої уваги.",
