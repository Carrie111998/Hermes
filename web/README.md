...
Browser-based dashboard for managing Charterforge configuration, API keys, and monitoring active sessions.
...
| Wordmark | `Typography` + size/tracking only | Sidebar/mobile “Charterforge” — mixed case, no Mondwest, no `text-display` |
