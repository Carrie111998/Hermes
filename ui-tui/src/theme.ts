...
export const DARK_SEEDS: ThemeSeeds = {
  accent: '#FFBF00',
  // The classic IYARI navy surfaces are IDENTITY, not derivation drift —
...
// The classic light-mode IYARI look was never hand-authored: for years the
...
//
// Anything we can't decide stays dark — the default IYARI palette
// is the dark one.
...
export function fromSkin(
  ...
  //    base seeds for this polarity. The base's IDENTITY FILLS (IYARI navy
  ...
  // the derived value already carries the identity seeds (e.g. IYARI navy).
  const activeRow =
