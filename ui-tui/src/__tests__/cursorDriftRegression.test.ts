 ...
 *
 * Symptom: in `orion --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@orion/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using orion --tui and as i type multiline my caret at the end will often ' +
