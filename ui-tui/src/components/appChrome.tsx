import { Box, type ScrollBoxHandle, stringWidth, Text } from '@charterforge/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (CHARTERFORGE_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (CHARTERFORGE_DEV_CREDITS), lowest priority,
