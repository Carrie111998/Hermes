import { Box, type ScrollBoxHandle, stringWidth, Text } from '@orion/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (ORION_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (ORION_DEV_CREDITS), lowest priority,
