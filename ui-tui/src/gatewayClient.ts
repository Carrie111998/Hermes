...
const STARTUP_TIMEOUT_MS = Math.max(5000, parseInt(process.env.CHARTERFORGE_TUI_STARTUP_TIMEOUT_MS ?? '15000', 10) || 15000)
const REQUEST_TIMEOUT_MS = Math.max(30000, parseInt(process.env.CHARTERFORGE_TUI_RPC_TIMEOUT_MS ?? '120000', 10) || 120000)
