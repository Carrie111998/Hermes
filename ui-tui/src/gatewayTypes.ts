import type { BillingBlock, UsageModelData } from '@orion/shared/billing'
import type { OrionSkin } from '@orion/shared/skin'

import type { SessionInfo, SlashCategory, SubagentStatus, Usage } from './types.js'

/** The cross-surface skin contract (canonical shape in `@orion/shared`).
 *  Includes the paired light_colors/dark_colors overlays from #20379. */
export type GatewaySkin = OrionSkin
...
// Wire shapes now live in @orion/shared for reuse by TypeScript clients.
export type {
  BillingAutoReload,
  BillingBlock,
  BillingCardInfo,
