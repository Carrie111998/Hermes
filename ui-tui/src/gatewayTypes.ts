import type { BillingBlock, UsageModelData } from '@charterforge/shared/billing'
import type { CharterforgeSkin } from '@charterforge/shared/skin'

import type { SessionInfo, SlashCategory, SubagentStatus, Usage } from './types.js'

/** The cross-surface skin contract (canonical shape in `@charterforge/shared`).
 *  Includes the paired light_colors/dark_colors overlays from #20379. */
export type GatewaySkin = CharterforgeSkin
...
// Wire shapes now live in @charterforge/shared for reuse by TypeScript clients.
export type {
  BillingAutoReload,
  BillingBlock,
  BillingCardInfo,
  ...
  UsageBarData,
  UsageModelData
} from '@charterforge/shared/billing'
