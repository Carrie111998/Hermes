...
await build({
  ...
  // Skip the prebuilt @orion/ink bundle and inline the source instead:
  ...
  alias: { '@orion/ink': resolve(root, 'packages/orion-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The orion_cli launcher
