 ...
 * across theme x background scenes to <tmpdir>/orion-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@orion/ink'
...
// The regenerated slate light_colors block from orion_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/orion-agent',
...
const setup = (bgHex: string) => {
  process.env.ORION_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
