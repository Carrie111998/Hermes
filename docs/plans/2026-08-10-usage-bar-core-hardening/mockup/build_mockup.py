...
.alert { display: flex; align-items: center; gap: 0.5rem; color: var(--color-destructive); }
...
.palette-item { display: flex; align-items: center; gap: 0.625rem; padding: 0.5rem 1rem; font-size: 0.75rem; cursor: pointer; }
...
<div class="app" data-scene="index" style="justify-content:flex-start; padding:2rem; gap:1rem; overflow-y:auto">
  ...
  <div class="stack small" style="border-top:1px solid var(--ui-stroke-tertiary); padding-top:0.75rem; max-width:40rem">
    <p><b>键盘焦点</b>：状态栏触发器为真实 <code>&lt;button&gt;</code>，<code>:focus-visible</code> 2px 主题色环；popover 打开后焦点进入面板，Esc 关闭并返还触发器；面板内每行 account 为可聚焦行，方向键在窗口行间移动（roving tabindex）。</p>
    <p><b>reduced-motion</b>：全部过渡包在 <code>@media (prefers-reduced-motion: no-preference)</code>；reduced 下进度条宽度变化即时生效、popover 无滑入位移，仅透明度交叉淡入。本页底部的媒体查询已强制演示。</p>
    <p><b>live region</b>：quota 的 stale/error 状态变化经 <code>role="status"</code>（polite）播报；provider-specific error 用 <code>role="alert"</code>。</p>
    <p><b>真相来源分离</b>：provider quota（官方接口）/ credential health（本地凭证池状态）/ local analytics（本地计量）三区独立渲染、独立 loading/error，不混算、不跨窗口平均。</p>
    <p><b>stale 语义</b>：仅传输类故障（timeout/5xx）回退 stale 缓存并标注 "Cached · 时间"；401/403 直接显示认证失效，绝不用 stale 掩盖。</p>
  </div>
</div>
...
<div class="app" data-scene="popover">
  ...
  <div class="popover" role="dialog" aria-label="Context and account usage">
    ...
    <div class="section" aria-label="Account limits">
      <div class="row"><p class="title">Account limits</p><span class="small muted">source: provider_reported</span></div>
      ...
      <div class="stack-lg">
        ...
        <div class="stack">
          ...
          <div class="stack">
            ...
            <p class="small muted">Cached · 11:42:03 — request timed out, showing last good read</p>
          </div>
        </div>
      </div>
      ...
      <div class="stack-lg">
        ...
        <div class="stack">
          ...
          <div class="stack">
            ...
            <div class="progress"><i style="width:27%"></i></div>
      ...
      <div class="stack-lg">
        ...
        <div class="stack">
          ...
          <p class="alert small" role="alert">⚠ Credential token expired — re-authenticate. <span class="muted">(401; never masked by stale cache)</span></p>
        </div>
      </div>

      <div class="row"><span class="small muted">Local analytics · this session</span><a class="link small">Open in Command Center</a></div>
    </div>
  </div>
  <div class="statusbar">
    <span class="sb-item"><span class="dot"></span>Gateway</span>
    <span class="sb-item truncate">aichat_group · main</span>
    <span class="sb-spacer"></span>
    <button class="sb-btn" style="outline:2px solid var(--theme-primary); outline-offset:1px" aria-expanded="true">
      <span class="meter-mini"><span class="track"><span class="fill" style="width:38%"></span></span></span>
...
<div class="app" data-scene="command-center">
  <div class="overlay-backdrop">
    <div class="overlay" role="dialog" aria-label="Command Center — Usage">
      ...
      <div class="stack-lg">
        <div class="row"><p class="title">Account limits</p><span class="small muted">source: provider_reported · refreshed 12s ago · <a class="link">Refresh</a></span></div>
        <div class="cc-grid">
          <div class="stack">
          ...
          <div class="stack">
            ...
            <div class="progress"><i style="width:23%"></i></div>
            <p class="small muted">Cached · 11:42:03 — transient upstream timeout</p>
          </div>
          <div class="stack">
          ...
          <div class="stack">
            ...
            <p class="alert small" role="alert">⚠ Credential token expired — re-authenticate</p>
          </div>
        </div>
      </div>
      <div class="section">
        ...
        <div class="cc-grid">
          ...
          <div class="stack">
            ...
            <div class="progress"><i style="width:48%"></i></div>
...
<div class="app" data-scene="palette">
  ...
  <div class="stage" style="align-items:flex-start; padding-top:12vh">
    <div class="palette" role="dialog" aria-label="Command palette">
      ...
      <div class="palette-item active">▸ Open Usage — Command Center<span class="kbd">Enter</span></div>
      <div class="palette-item">▸ Refresh account limits<span class="kbd">usage.accounts</span></div>
      <div class="palette-item muted">▸ Toggle statusbar visibility<span class="kbd">Settings</span></div>
    </div>
  </div>
