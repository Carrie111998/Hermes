...
| --- | --- |
| Gateway implementation | PR #213 at `4c14e448187a70e814ed76e2e74396277120d2c8` |
...
| CLI/product specification | Setup/status/scan/suggest/review/decision/discovery/install/check/update/uninstall commands plus natural-language plan/apply install | `hermes_cli/subcommands/wisdom.py`, built-in Collective Wisdom skill | `tests/hermes_cli/test_wisdom_parser.py`, `tests/skills/test_collective_wisdom_install_skill.py`, `tests/agent/test_wisdom_skill_namespace.py` | Agent #94266 | implemented |
