文档路径：docs/ultra-studio-zh/infra-design/01-reference-research.md

# 基建参考调研

状态：基建设计中文详细版  
来源：`docs/ultra-studio-infra-design/01-reference-research.md` 与中文阅读层 `docs/ultra-studio-docs-zh/infra-01-reference-research.html`  
日期：2026-06-11

## 定位

整理 Manus、E2B、Browserbase、OpenAI/Anthropic computer use、Temporal、LangGraph、媒体队列 API 和 Hermes 现状。

本页把源文档转换成中文实施视角：先说明它解决的问题，再拆出当前结论、执行影响、验证方式和开放问题。它用于中文阅读和排期，英文源保留为核对材料。

## 核心结论

- P0 借用 async media job contract、技能 progressive disclosure、狭窄 sandbox/browser 概念。
...
- 用外部产品找能力边界，但不照抄。参考产品的重基建只在有产品压力时引入。
### P0 相关结论
...
| Agent Infrastructure Lessons | Agent 基建经验 |
| Official Source Links | 官方来源链接 |
| Internal Source Links | 内部来源链接 |
