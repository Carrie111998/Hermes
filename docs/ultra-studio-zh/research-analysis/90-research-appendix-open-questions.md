文档路径：docs/ultra-studio-zh/research-analysis/90-research-appendix-open-questions.md

# 研究附录与开放问题

状态：调研分析中文详细版  
来源：`docs/ultra-studio-research-analysis/90-research-appendix-open-questions.md` 与中文阅读层 `docs/ultra-studio-docs-zh/research-90-open-questions.html`  
日期：2026-06-11

## 定位

记录线程调研、外部参考、代码证据、drift 修正和还没决定的问题。
...
- 这是证据页。以后争论“为什么这么设计”时先看这里，避免凭感觉改架构。
### P0 相关结论

- 待定问题包括默认 Atlas video family、job/asset 存在哪个 DB、上传是否立刻成 asset、canonical UI route。
- 实现前要逐个关闭这些决策。
### 阅读位置
...
| 英文章节 | 中文章节 |
|---|---|
| Threads Summary | Threads 调研总结 |
| External Research | 外部调研 |
| Local Evidence | 本地证据 |
| Drift Found | 发现的漂移 |
| Open Questions | 开放问题 |
| Recommended Next Implementation Slice | 建议的下一段实现 |
