...
or change arbitrary Orion configuration.
...
small host fact requested by the RFC. Settings writes use Orion'
...
`ORION_HOME`, so one globally loaded plugin context follows multiplexed
...
```text
<ORION_HOME>/plugin-data/<plugin-data-namespace>/state.json
```
...
The implementation is covered with real temporary-Orion-home tests for:
...
- [Issue #64227](https://github.com/zacharyjleach-stack/Aries/issues/64227)
- [RFC PR #58542](https://github.com/zacharyjleach-stack/Aries/pull/58542) by Topher Ross
