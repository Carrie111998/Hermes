...
| Public writer refusal | `ObserverStore` constructor and `open_observer_store` fail in clean subprocesses with and without legacy env; no observer DB sidecars are created | `test_public_sqlite_writer_entrypoints_fail_closed_in_subprocess` |
