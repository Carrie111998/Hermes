# Hermes Architecture and Runtime Guide

This document is a normative extension of the root [`AGENTS.md`](../../AGENTS.md).
Read it before changing or reviewing Hermes runtime architecture, surfaces,
plugins, skills, durable systems, or profile behavior. The sections below were
moved from the root guide so project context stays below its injection budget;
