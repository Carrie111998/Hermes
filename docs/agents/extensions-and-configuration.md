# Hermes Extensions and Configuration Guide

This document is a normative extension of the root [`AGENTS.md`](../../AGENTS.md).
Read it before adding or changing tools, dependencies, configuration, setup
flows, environment variables, or extension surfaces. The sections below were
