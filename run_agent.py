...
class AIAgent:
    ...
    def _dispatch_delegate_task(self, function_args: dict) -> str:
        ...
        # Keep the live model path and the registry fallback on one policy.
        # Most top-level surfaces detach; ACP and orchestrator children wait
        # for the tool result so they cannot finalize an answer that still
        # depends on outstanding child work.
