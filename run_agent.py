...
class AIAgent:
    ...
    def _dispatch_delegate_task(self, function_args: dict) -> str:
        ...
        return _delegate_task(
            ...
            difficulty_reason=function_args.get("difficulty_reason"),
            required_capabilities=function_args.get("required_capabilities"),
            minimum_model_class=function_args.get("minimum_model_class"),
